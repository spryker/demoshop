...
class Generated_Zed_Checkout_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
     ...
     */
    public function getModelWorkflowDefinitionSaveOrder(ProjectA_Shared_Sales_Transfer_Order $transferOrder)
    {
     ...
     */
    public function getModelWorkflowDefinitionSaveOrderManualCheckout(ProjectA_Shared_Sales_Transfer_Order $transferOrder)
    {
