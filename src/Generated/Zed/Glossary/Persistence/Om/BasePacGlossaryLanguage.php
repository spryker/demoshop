...
/**
 * Base class that represents a row from the 'pac_glossary_language' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/glossary-package/ProjectA/Zed/Glossary/Persistence.om
 */
abstract class Generated_Zed_Glossary_Persistence_Om_BasePacGlossaryLanguage extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer
     */
    ...
    /**
     * The value for the id_glossary_language field.
     * @var        int
     */
    protected $id_glossary_language;
    ...
    /**
     * Get the [id_glossary_language] column value.
     *
     * @return int
     */
    public function getIdGlossaryLanguage()
    {
        return $this->id_glossary_language;
    }
    ...
    /**
     * Set the value of [id_glossary_language] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage The current object (for fluent API support)
     */
    public function setIdGlossaryLanguage($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_glossary_language !== $v) {
            $this->id_glossary_language = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE;
        }


        return $this;
    } // setIdGlossaryLanguage()
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::LOCALE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_glossary_language = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE;
        if (null !== $this->id_glossary_language) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE)) {
            $modifiedColumns[':p' . $index++]  = '`id_glossary_language`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = '`locale`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_glossary_language` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_glossary_language`':
                        $stmt->bindValue($identifier, $this->id_glossary_language, PDO::PARAM_INT);
                        break;
                    case '`locale`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdGlossaryLanguage();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdGlossaryLanguage(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdGlossaryLanguage($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdGlossaryLanguage($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE)) $criteria->add(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE, $this->id_glossary_language);
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::LOCALE)) $criteria->add(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::LOCALE, $this->locale);
        if ($this->isColumnModified(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::NAME)) $criteria->add(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::ID_GLOSSARY_LANGUAGE, $this->id_glossary_language);
    ...
    /**
     * Generic method to set the primary key (id_glossary_language column).
     *
    ...
    {
        $this->setIdGlossaryLanguage($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdGlossaryLanguage();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdGlossaryLanguage(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer();
        }
     ...
     * If this ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguage is new, it will return
    ...
    public function setGlossaryExplanations(PropelCollection $glossaryExplanations, PropelPDO $con = null)
    {
        ...
        foreach ($glossaryExplanationsToDelete as $glossaryExplanationRemoved) {
            $glossaryExplanationRemoved->setGlossaryLanguage(null);
        }
    ...
    protected function doAddGlossaryExplanation($glossaryExplanation)
    {
        ...
        $glossaryExplanation->setGlossaryLanguage($this);
    }
    ...
    public function removeGlossaryExplanation($glossaryExplanation)
    {
        if ($this->getGlossaryExplanations()->contains($glossaryExplanation)) {
            ...
            $glossaryExplanation->setGlossaryLanguage(null);
        }
     ...
     * Otherwise if this PacGlossaryLanguage is new, it will return
     * an empty collection; or if this PacGlossaryLanguage has previously
     * been saved, it will retrieve related GlossaryExplanations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacGlossaryLanguage.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanation[] List of ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanation objects
     */
    public function getGlossaryExplanationsJoinGlossaryKey($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanationQuery::create(null, $criteria);
    ...
    {
        $this->id_glossary_language = null;
        $this->locale = null;
        $this->name = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Glossary_Persistence_PacGlossaryLanguagePeer::DEFAULT_STRING_FORMAT);
    }
