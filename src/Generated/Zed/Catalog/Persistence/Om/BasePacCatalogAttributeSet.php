 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogAttributeSet extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet The current object (for fluent API support)
     */
    public function setIdCatalogAttributeSet($v)
    {
        ...
        if ($this->id_catalog_attribute_set !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::ID_CATALOG_ATTRIBUTE_SET;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->productsScheduledForDeletion !== null) {
                if (!$this->productsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Catalog_Persistence_PacCatalogProductQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::ID_CATALOG_ATTRIBUTE_SET)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_attribute_set`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::ID_CATALOG_ATTRIBUTE_SET)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::ID_CATALOG_ATTRIBUTE_SET, $this->id_catalog_attribute_set);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::NAME)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::ID_CATALOG_ATTRIBUTE_SET, $this->id_catalog_attribute_set);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer();
        }
    ...
    /**
     * Gets an array of ProjectA_Zed_Catalog_Persistence_PacCatalogProduct objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet is new, it will return
    ...
    public function setProducts(PropelCollection $products, PropelPDO $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setAttributeSet(null);
        }
    ...
    /**
     * Returns the number of related ProjectA_Zed_Catalog_Persistence_PacCatalogProduct objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Catalog_Persistence_PacCatalogProduct objects.
     * @throws PropelException
     */
    ...
    /**
     * Method called to associate a ProjectA_Zed_Catalog_Persistence_PacCatalogProduct object to this object
     * through the ProjectA_Zed_Catalog_Persistence_PacCatalogProduct foreign key attribute.
     *
     * @param    ProjectA_Zed_Catalog_Persistence_PacCatalogProduct $l ProjectA_Zed_Catalog_Persistence_PacCatalogProduct
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSet The current object (for fluent API support)
     */
    public function addProduct(ProjectA_Zed_Catalog_Persistence_PacCatalogProduct $l)
    {
        if ($this->collProducts === null) {
            $this->initProducts();
            $this->collProductsPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetPeer::DEFAULT_STRING_FORMAT);
    }
