 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogValueBoolean extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean The current object (for fluent API support)
     */
    public function setIdCatalogValueBoolean($v)
    {
        ...
        if ($this->id_catalog_value_boolean !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::ID_CATALOG_VALUE_BOOLEAN;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::VALUE;
        }
    ...
    public function setFkCatalogAttribute($v)
    {
        ...
        if ($this->fk_catalog_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_ATTRIBUTE;
        }
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->value = ($row[$startcol + 1] !== null) ? (boolean) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::ID_CATALOG_VALUE_BOOLEAN)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_value_boolean`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_PRODUCT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::ID_CATALOG_VALUE_BOOLEAN)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::ID_CATALOG_VALUE_BOOLEAN, $this->id_catalog_value_boolean);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::VALUE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::VALUE, $this->value);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_ATTRIBUTE, $this->fk_catalog_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::ID_CATALOG_VALUE_BOOLEAN, $this->id_catalog_value_boolean);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer();
        }
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && ($this->fk_catalog_product !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addBooleans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_PacCatalogValueBooleanPeer::DEFAULT_STRING_FORMAT);
    }
