 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogGroup extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute[] Collection to store aggregation of ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects.
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup The current object (for fluent API support)
     */
    public function setIdCatalogGroup($v)
    {
        ...
        if ($this->id_catalog_group !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::ID_CATALOG_GROUP;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_PacCatalogGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::ID_CATALOG_GROUP)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_group`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogGroup'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_PacCatalogGroup'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::ID_CATALOG_GROUP)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::ID_CATALOG_GROUP, $this->id_catalog_group);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::NAME)) $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::ID_CATALOG_GROUP, $this->id_catalog_group);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_PacCatalogGroup (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer();
        }
     ...
     * If this ProjectA_Zed_Catalog_Persistence_PacCatalogGroup is new, it will return
    ...
    public function initAttributes()
    {
        ...
        $this->collAttributes->setModel('ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute');
    }

    /**
     * Gets a collection of ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects related by a many-to-many relationship
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute[] List of ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects
     */
    public function getAttributes($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collAttributes || null !== $criteria) {
            if ($this->isNew() && null === $this->collAttributes) {
                ...
                $collAttributes = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery::create(null, $criteria)
                    ->filterByGroup($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Sets a collection of ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_group cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    /**
     * Gets the number of ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_group cross-reference table.
     *
     * @param Criteria $criteria Optional query object to filter the query
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return int the number of related ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects
     */
    public function countAttributes($criteria = null, $distinct = false, PropelPDO $con = null)
    {
        if (null === $this->collAttributes || null !== $criteria) {
            if ($this->isNew() && null === $this->collAttributes) {
                ...
                $query = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
    ...
    /**
     * Associate a ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute object to this object
     * through the pac_catalog_attribute_group cross reference table.
     *
     * @param  ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute $pacCatalogAttribute The ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup The current object (for fluent API support)
     */
    public function addAttribute(ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute $pacCatalogAttribute)
    {
    ...
    /**
     * Remove a ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute object to this object
     * through the pac_catalog_attribute_group cross reference table.
     *
     * @param ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute $pacCatalogAttribute The ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup The current object (for fluent API support)
     */
    public function removeAttribute(ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute $pacCatalogAttribute)
    {
    ...
    /**
     * Gets a collection of ProjectA_Zed_Catalog_Persistence_PacCatalogValueType objects related by a many-to-many relationship
    ...
    /**
     * Sets a collection of ProjectA_Zed_Catalog_Persistence_PacCatalogValueType objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_set_group cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    public function setValueTypes(PropelCollection $valueTypes, PropelPDO $con = null)
    {
        ...
        $currentValueTypes = $this->getValueTypes();
    ...
    /**
     * Gets the number of ProjectA_Zed_Catalog_Persistence_PacCatalogValueType objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_set_group cross-reference table.
     *
     * @param Criteria $criteria Optional query object to filter the query
     * @param boolean $distinct Set to true to force count distinct
     * @param PropelPDO $con Optional connection object
     *
     * @return int the number of related ProjectA_Zed_Catalog_Persistence_PacCatalogValueType objects
     */
    ...
    /**
     * Associate a ProjectA_Zed_Catalog_Persistence_PacCatalogValueType object to this object
     * through the pac_catalog_attribute_set_group cross reference table.
     *
     * @param  ProjectA_Zed_Catalog_Persistence_PacCatalogValueType $pacCatalogValueType The ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup The current object (for fluent API support)
     */
    public function addValueType(ProjectA_Zed_Catalog_Persistence_PacCatalogValueType $pacCatalogValueType)
    {
    ...
    /**
     * Remove a ProjectA_Zed_Catalog_Persistence_PacCatalogValueType object to this object
     * through the pac_catalog_attribute_set_group cross reference table.
     *
     * @param ProjectA_Zed_Catalog_Persistence_PacCatalogValueType $pacCatalogValueType The ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeSetGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogGroup The current object (for fluent API support)
     */
    public function removeValueType(ProjectA_Zed_Catalog_Persistence_PacCatalogValueType $pacCatalogValueType)
    {
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_PacCatalogGroupPeer::DEFAULT_STRING_FORMAT);
    }
