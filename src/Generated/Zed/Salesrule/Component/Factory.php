...
class Generated_Zed_Salesrule_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
     ...
     */
    public function getModelActionsFixed(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsMaxShipping(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsPercent(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsPercentShipping(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelConditionStack(ProjectA_Shared_Sales_Transfer_Order $order)
    {
     ...
     */
    public function getModelActionsFixedOriginals(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsFixedPrints(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsPercentOriginals(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
     ...
     */
    public function getModelActionsPercentPrints(ProjectA_Shared_Sales_Transfer_Order $order, ProjectA_Zed_Salesrule_Persistence_PacSalesrule $salesrule)
    {
