 ...
 */
abstract class Generated_Zed_Invoice_Persistence_Om_BasePacInvoice extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Invoice_Persistence_PacInvoicePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Invoice_Persistence_PacInvoicePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument[] Collection to store aggregation of ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument objects.
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Invoice_Persistence_Om_BasePacInvoice object.
     * @see        applyDefaults()
     */
    ...
    public function getType()
    {
        ...
        $valueSet = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::getValueSet(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::TYPE);
     ...
     * @return ProjectA_Zed_Invoice_Persistence_PacInvoice The current object (for fluent API support)
     */
    public function setIdInvoice($v)
    {
        ...
        if ($this->id_invoice !== $v) {
            $this->id_invoice = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::ID_INVOICE;
        }
    ...
    public function setInvoiceNumber($v)
    {
        ...
        if ($this->invoice_number !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::INVOICE_NUMBER;
        }
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if ($this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::FK_SALES_ORDER;
        }
    ...
    public function setNote($v)
    {
        ...
        if ($this->note !== $v) {
            $this->note = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::NOTE;
        }
    ...
    public function setCurrencyCode($v)
    {
        ...
        if ($this->currency_code !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CURRENCY_CODE;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::TYPE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->invoice_number = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 8; // 8 = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Invoice_Persistence_PacInvoice object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Invoice_Persistence_PacInvoiceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->invoiceDocumentsScheduledForDeletion !== null) {
                if (!$this->invoiceDocumentsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Invoice_Persistence_PacInvoiceDocumentQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::ID_INVOICE)) {
            $modifiedColumns[':p' . $index++]  = '`id_invoice`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::INVOICE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`invoice_number`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::FK_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::NOTE)) {
            $modifiedColumns[':p' . $index++]  = '`note`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CURRENCY_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`currency_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::TYPE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Invoice_Persistence_PacInvoice'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Invoice_Persistence_PacInvoice'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setInvoiceNumber($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::ID_INVOICE)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::ID_INVOICE, $this->id_invoice);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::INVOICE_NUMBER)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::INVOICE_NUMBER, $this->invoice_number);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::FK_SALES_ORDER)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::FK_SALES_ORDER, $this->fk_sales_order);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::NOTE)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::NOTE, $this->note);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CURRENCY_CODE)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CURRENCY_CODE, $this->currency_code);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::TYPE)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::TYPE, $this->type);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::ID_INVOICE, $this->id_invoice);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Invoice_Persistence_PacInvoice (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Invoice_Persistence_PacInvoice Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Invoice_Persistence_PacInvoicePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Invoice_Persistence_PacInvoicePeer();
        }
     ...
     * If this ProjectA_Zed_Invoice_Persistence_PacInvoice is new, it will return
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Invoice_Persistence_PacInvoiceItem[] List of ProjectA_Zed_Invoice_Persistence_PacInvoiceItem objects
     */
    public function getInvoiceItemsJoinItem($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Invoice_Persistence_PacInvoiceItemQuery::create(null, $criteria);
    ...
    public function initInvoiceDocuments($overrideExisting = true)
    {
        ...
        $this->collInvoiceDocuments->setModel('ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument');
    }

    /**
     * Gets an array of ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument[] List of ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument objects
     * @throws PropelException
     */
    public function getInvoiceDocuments($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collInvoiceDocuments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collInvoiceDocuments) {
                ...
                $collInvoiceDocuments = ProjectA_Zed_Invoice_Persistence_PacInvoiceDocumentQuery::create(null, $criteria)
                    ->filterByInvoice($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setInvoiceDocuments(PropelCollection $invoiceDocuments, PropelPDO $con = null)
    {
        ...
        $this->invoiceDocumentsScheduledForDeletion = unserialize(serialize($invoiceDocumentsToDelete));
    ...
    /**
     * Returns the number of related ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument objects.
     * @throws PropelException
     */
    public function countInvoiceDocuments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collInvoiceDocuments || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Invoice_Persistence_PacInvoiceDocumentQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument object to this object
     * through the ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument foreign key attribute.
     *
     * @param    ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument $l ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument
     * @return ProjectA_Zed_Invoice_Persistence_PacInvoice The current object (for fluent API support)
     */
    public function addInvoiceDocument(ProjectA_Zed_Invoice_Persistence_PacInvoiceDocument $l)
    {
        if ($this->collInvoiceDocuments === null) {
            $this->initInvoiceDocuments();
            $this->collInvoiceDocumentsPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Invoice_Persistence_PacInvoicePeer::DEFAULT_STRING_FORMAT);
    }
