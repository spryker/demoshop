...
/**
 * Base class that represents a row from the 'pac_stock_attribute' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/catalog-package/ProjectA/Zed/Stock/Persistence.om
 */
abstract class Generated_Zed_Stock_Persistence_Om_BasePacStockAttribute extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Stock_Persistence_PacStockAttributePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Stock_Persistence_PacStockAttributePeer
     */
    ...
    /**
     * The value for the id_stock_attribute field.
     * @var        int
     */
    protected $id_stock_attribute;
    ...
    /**
     * Get the [id_stock_attribute] column value.
     *
     * @return int
     */
    public function getIdStockAttribute()
    {
        return $this->id_stock_attribute;
    }
    ...
    /**
     * Set the value of [id_stock_attribute] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Stock_Persistence_PacStockAttribute The current object (for fluent API support)
     */
    public function setIdStockAttribute($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_stock_attribute !== $v) {
            $this->id_stock_attribute = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_stock_attribute = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Stock_Persistence_PacStockAttribute object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Stock_Persistence_PacStockAttributeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE;
        if (null !== $this->id_stock_attribute) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`id_stock_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_stock_attribute` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_stock_attribute`':
                        $stmt->bindValue($identifier, $this->id_stock_attribute, PDO::PARAM_INT);
                        break;
                    case '`name`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdStockAttribute();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Stock_Persistence_PacStockAttribute'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Stock_Persistence_PacStockAttribute'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdStockAttribute(),
            $keys[1] => $this->getName(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdStockAttribute($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdStockAttribute($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE, $this->id_stock_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::NAME)) $criteria->add(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::ID_STOCK_ATTRIBUTE, $this->id_stock_attribute);
    ...
    /**
     * Generic method to set the primary key (id_stock_attribute column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdStockAttribute();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Stock_Persistence_PacStockAttribute (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdStockAttribute(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Stock_Persistence_PacStockAttribute Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Stock_Persistence_PacStockAttributePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Stock_Persistence_PacStockAttributePeer();
        }
     ...
     * If this ProjectA_Zed_Stock_Persistence_PacStockAttribute is new, it will return
     ...
     * Otherwise if this PacStockAttribute is new, it will return
     * an empty collection; or if this PacStockAttribute has previously
     * been saved, it will retrieve related AttributeValues from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacStockAttribute.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Stock_Persistence_PacStockAttributeValue[] List of ProjectA_Zed_Stock_Persistence_PacStockAttributeValue objects
     */
    public function getAttributeValuesJoinStock($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Stock_Persistence_PacStockAttributeValueQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Stock_Persistence_PacStockAttributePeer::DEFAULT_STRING_FORMAT);
    }
