...
class Generated_Zed_Misc_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
    ...
    /**
     * @return ProjectA_Zed_Misc_Component_Exporter_Memcache_Country
     */
    public function getExporterMemcacheCountry()
    {
        $class = $this->transformClassName('ProjectA_Zed_Misc_Component_Exporter_Memcache_Country');
        $model = new $class();
