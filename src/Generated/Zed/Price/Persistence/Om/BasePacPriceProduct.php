 ...
 */
abstract class Generated_Zed_Price_Persistence_Om_BasePacPriceProduct extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Price_Persistence_PacPriceProductPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Price_Persistence_PacPriceProductPeer
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Price_Persistence_Om_BasePacPriceProduct object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Price_Persistence_PacPriceProduct The current object (for fluent API support)
     */
    public function setIdPriceProduct($v)
    {
        ...
        if ($this->id_price_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::ID_PRICE_PRODUCT;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::PRICE;
        }
    ...
    public function setValidFrom($v)
    {
        ...
        if ($this->valid_from !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_FROM;
            }
    ...
    public function setValidTo($v)
    {
        ...
        if ($this->valid_to !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_TO;
            }
        } // if either are not null
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function setFkPriceType($v)
    {
        ...
        if ($this->fk_price_type !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_PRICE_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Price_Persistence_PacPriceProduct object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Price_Persistence_PacPriceProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Price_Persistence_PacPriceProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::ID_PRICE_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`id_price_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::PRICE)) {
            $modifiedColumns[':p' . $index++]  = '`price`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_FROM)) {
            $modifiedColumns[':p' . $index++]  = '`valid_from`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_TO)) {
            $modifiedColumns[':p' . $index++]  = '`valid_to`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_CATALOG_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_PRICE_TYPE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_PacPriceProduct'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_PacPriceProduct'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Price_Persistence_PacPriceProductPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::ID_PRICE_PRODUCT)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::ID_PRICE_PRODUCT, $this->id_price_product);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::PRICE)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::PRICE, $this->price);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_FROM)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_FROM, $this->valid_from);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_TO)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::VALID_TO, $this->valid_to);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_PRICE_TYPE)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::FK_PRICE_TYPE, $this->fk_price_type);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::ID_PRICE_PRODUCT, $this->id_price_product);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Price_Persistence_PacPriceProduct (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Price_Persistence_PacPriceProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Price_Persistence_PacPriceProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Price_Persistence_PacPriceProductPeer();
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Price_Persistence_PacPriceProductPeer::DEFAULT_STRING_FORMAT);
    }
