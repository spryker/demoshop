 ...
 */
abstract class Generated_Zed_Price_Persistence_Om_BasePacPriceAttribute extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Price_Persistence_PacPriceAttributePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Price_Persistence_PacPriceAttributePeer
     */
     ...
     * @return ProjectA_Zed_Price_Persistence_PacPriceAttribute The current object (for fluent API support)
     */
    public function setIdPriceAttribute($v)
    {
        ...
        if ($this->id_price_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::ID_PRICE_ATTRIBUTE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Price_Persistence_PacPriceAttribute object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Price_Persistence_PacPriceAttributeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::ID_PRICE_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`id_price_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_PacPriceAttribute'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_PacPriceAttribute'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::ID_PRICE_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::ID_PRICE_ATTRIBUTE, $this->id_price_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::NAME)) $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::ID_PRICE_ATTRIBUTE, $this->id_price_attribute);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Price_Persistence_PacPriceAttribute (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Price_Persistence_PacPriceAttribute Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Price_Persistence_PacPriceAttributePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Price_Persistence_PacPriceAttributePeer();
        }
     ...
     * If this ProjectA_Zed_Price_Persistence_PacPriceAttribute is new, it will return
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Price_Persistence_PacPriceAttributePeer::DEFAULT_STRING_FORMAT);
    }
