 ...
 */
abstract class Generated_Zed_Customer_Persistence_Om_BasePacCustomerStatus extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer
     */
     ...
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerStatus The current object (for fluent API support)
     */
    public function setIdCustomerStatus($v)
    {
        ...
        if ($this->id_customer_status !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::ID_CUSTOMER_STATUS;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Customer_Persistence_PacCustomerStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Customer_Persistence_PacCustomerStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->customersScheduledForDeletion !== null) {
                if (!$this->customersScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Customer_Persistence_PacCustomerQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::ID_CUSTOMER_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`id_customer_status`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Customer_Persistence_PacCustomerStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Customer_Persistence_PacCustomerStatus'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::ID_CUSTOMER_STATUS)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::ID_CUSTOMER_STATUS, $this->id_customer_status);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::NAME)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::ID_CUSTOMER_STATUS, $this->id_customer_status);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Customer_Persistence_PacCustomerStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer();
        }
    ...
    public function initCustomers($overrideExisting = true)
    {
        ...
        $this->collCustomers->setModel('ProjectA_Zed_Customer_Persistence_PacCustomer');
    }
     ...
     * If this ProjectA_Zed_Customer_Persistence_PacCustomerStatus is new, it will return
    ...
    public function getCustomers($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCustomers || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCustomers) {
                ...
                $collCustomers = ProjectA_Zed_Customer_Persistence_PacCustomerQuery::create(null, $criteria)
                    ->filterByStatus($this)
                    ->find($con);
                if (null !== $criteria) {
     ...
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerStatus The current object (for fluent API support)
     */
    public function addCustomer(ProjectA_Zed_Customer_Persistence_PacCustomer $l)
    {
        if ($this->collCustomers === null) {
            $this->initCustomers();
            $this->collCustomersPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Customer_Persistence_PacCustomerStatusPeer::DEFAULT_STRING_FORMAT);
    }
