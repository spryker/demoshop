 ...
 */
abstract class Generated_Zed_Customer_Persistence_Om_BasePacCustomerAddress extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Customer_Persistence_PacCustomer[] Collection to store aggregation of ProjectA_Zed_Customer_Persistence_PacCustomer objects.
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Customer_Persistence_Om_BasePacCustomerAddress object.
     * @see        applyDefaults()
     */
    ...
    public function getSalutation()
    {
        ...
        $valueSet = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::getValueSet(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::SALUTATION);
     ...
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerAddress The current object (for fluent API support)
     */
    public function setIdCustomerAddress($v)
    {
        ...
        if ($this->id_customer_address !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ID_CUSTOMER_ADDRESS;
        }
    ...
    public function setFkCustomer($v)
    {
        ...
        if ($this->fk_customer !== $v) {
            $this->fk_customer = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_CUSTOMER;
        }
    ...
    public function setFkMiscCountry($v)
    {
        ...
        if ($this->fk_misc_country !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_MISC_COUNTRY;
        }
    ...
    public function setSalutation($v)
    {
        ...
        if ($this->salutation !== $v) {
            $this->salutation = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::SALUTATION;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FIRST_NAME;
        }
    ...
    public function setMiddleName($v)
    {
        ...
        if ($this->middle_name !== $v) {
            $this->middle_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::MIDDLE_NAME;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::LAST_NAME;
        }
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS1;
        }
    ...
    public function setAddress2($v)
    {
        ...
        if ($this->address2 !== $v) {
            $this->address2 = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS2;
        }
    ...
    public function setCompany($v)
    {
        ...
        if ($this->company !== $v) {
            $this->company = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMPANY;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CITY;
        }
    ...
    public function setZipCode($v)
    {
        ...
        if ($this->zip_code !== $v) {
            $this->zip_code = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ZIP_CODE;
        }
    ...
    public function setPoBox($v)
    {
        ...
        if ($this->po_box !== $v) {
            $this->po_box = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PO_BOX;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PHONE;
        }
    ...
    public function setCellPhone($v)
    {
        ...
        if ($this->cell_phone !== $v) {
            $this->cell_phone = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CELL_PHONE;
        }
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::IS_DELETED;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMMENT;
        }
    ...
    public function setDeletedAt($v)
    {
        ...
        if ($this->deleted_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DELETED_AT;
            }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->is_deleted = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
            ...
            return $startcol + 20; // 20 = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Customer_Persistence_PacCustomerAddress object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Customer_Persistence_PacCustomerAddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ID_CUSTOMER_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_customer_address`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_CUSTOMER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_customer`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_MISC_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`fk_misc_country`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::SALUTATION)) {
            $modifiedColumns[':p' . $index++]  = '`salutation`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`first_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::MIDDLE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`middle_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`last_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS1)) {
            $modifiedColumns[':p' . $index++]  = '`address1`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = '`address2`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMPANY)) {
            $modifiedColumns[':p' . $index++]  = '`company`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ZIP_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`zip_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PO_BOX)) {
            $modifiedColumns[':p' . $index++]  = '`po_box`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CELL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`cell_phone`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::IS_DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`is_deleted`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`comment`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DELETED_AT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Customer_Persistence_PacCustomerAddress'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Customer_Persistence_PacCustomerAddress'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ID_CUSTOMER_ADDRESS)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ID_CUSTOMER_ADDRESS, $this->id_customer_address);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_CUSTOMER)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_CUSTOMER, $this->fk_customer);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_MISC_COUNTRY)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FK_MISC_COUNTRY, $this->fk_misc_country);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::SALUTATION)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::SALUTATION, $this->salutation);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FIRST_NAME)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::FIRST_NAME, $this->first_name);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::MIDDLE_NAME)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::MIDDLE_NAME, $this->middle_name);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::LAST_NAME)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::LAST_NAME, $this->last_name);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS1)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS1, $this->address1);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS2)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ADDRESS2, $this->address2);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMPANY)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMPANY, $this->company);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CITY)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CITY, $this->city);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ZIP_CODE)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ZIP_CODE, $this->zip_code);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PO_BOX)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PO_BOX, $this->po_box);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PHONE)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::PHONE, $this->phone);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CELL_PHONE)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CELL_PHONE, $this->cell_phone);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::IS_DELETED)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMMENT)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DELETED_AT)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DELETED_AT, $this->deleted_at);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::ID_CUSTOMER_ADDRESS, $this->id_customer_address);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Customer_Persistence_PacCustomerAddress (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerAddress Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer();
        }
    ...
    public function initCustomerBillingAddresses($overrideExisting = true)
    {
        ...
        $this->collCustomerBillingAddresses->setModel('ProjectA_Zed_Customer_Persistence_PacCustomer');
    }

    /**
     * Gets an array of ProjectA_Zed_Customer_Persistence_PacCustomer objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Customer_Persistence_PacCustomerAddress is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Customer_Persistence_PacCustomer[] List of ProjectA_Zed_Customer_Persistence_PacCustomer objects
     * @throws PropelException
     */
    public function getCustomerBillingAddresses($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCustomerBillingAddresses || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCustomerBillingAddresses) {
                ...
                $collCustomerBillingAddresses = ProjectA_Zed_Customer_Persistence_PacCustomerQuery::create(null, $criteria)
    ...
    public function setCustomerBillingAddresses(PropelCollection $customerBillingAddresses, PropelPDO $con = null)
    {
        ...
        $this->customerBillingAddressesScheduledForDeletion = unserialize(serialize($customerBillingAddressesToDelete));
    ...
    /**
     * Returns the number of related ProjectA_Zed_Customer_Persistence_PacCustomer objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Customer_Persistence_PacCustomer objects.
     * @throws PropelException
     */
    public function countCustomerBillingAddresses(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCustomerBillingAddresses || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Customer_Persistence_PacCustomerQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Customer_Persistence_PacCustomer object to this object
     * through the ProjectA_Zed_Customer_Persistence_PacCustomer foreign key attribute.
     *
     * @param    ProjectA_Zed_Customer_Persistence_PacCustomer $l ProjectA_Zed_Customer_Persistence_PacCustomer
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerAddress The current object (for fluent API support)
     */
    public function addCustomerBillingAddress(ProjectA_Zed_Customer_Persistence_PacCustomer $l)
    {
        if ($this->collCustomerBillingAddresses === null) {
            $this->initCustomerBillingAddresses();
            $this->collCustomerBillingAddressesPartial = true;
    ...
    public function initCustomerShippingAddresses($overrideExisting = true)
    {
        ...
        $this->collCustomerShippingAddresses->setModel('ProjectA_Zed_Customer_Persistence_PacCustomer');
    }
    ...
    public function getCustomerShippingAddresses($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCustomerShippingAddresses || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCustomerShippingAddresses) {
                ...
                $collCustomerShippingAddresses = ProjectA_Zed_Customer_Persistence_PacCustomerQuery::create(null, $criteria)
    ...
    public function setCustomerShippingAddresses(PropelCollection $customerShippingAddresses, PropelPDO $con = null)
    {
        ...
        $this->customerShippingAddressesScheduledForDeletion = unserialize(serialize($customerShippingAddressesToDelete));
     ...
     * @return ProjectA_Zed_Customer_Persistence_PacCustomerAddress The current object (for fluent API support)
     */
    public function addCustomerShippingAddress(ProjectA_Zed_Customer_Persistence_PacCustomer $l)
    {
        if ($this->collCustomerShippingAddresses === null) {
            $this->initCustomerShippingAddresses();
            $this->collCustomerShippingAddressesPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Customer_Persistence_PacCustomerAddressPeer::DEFAULT_STRING_FORMAT);
    }
