 ...
 */
abstract class Generated_Zed_Category_Persistence_Om_BasePacCategoryName extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Category_Persistence_PacCategoryNamePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Category_Persistence_PacCategoryNamePeer
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Category_Persistence_Om_BasePacCategoryName object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Category_Persistence_PacCategoryName The current object (for fluent API support)
     */
    public function setIdCategoryName($v)
    {
        ...
        if ($this->id_category_name !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::ID_CATEGORY_NAME;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::NAME;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Category_Persistence_PacCategoryName object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Category_Persistence_PacCategoryNameQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::ID_CATEGORY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`id_category_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::STATUS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_PacCategoryName'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_PacCategoryName'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::ID_CATEGORY_NAME)) $criteria->add(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::ID_CATEGORY_NAME, $this->id_category_name);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::NAME)) $criteria->add(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::STATUS)) $criteria->add(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::ID_CATEGORY_NAME, $this->id_category_name);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Category_Persistence_PacCategoryName (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Category_Persistence_PacCategoryName Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Category_Persistence_PacCategoryNamePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Category_Persistence_PacCategoryNamePeer();
        }
     ...
     * If this ProjectA_Zed_Category_Persistence_PacCategoryName is new, it will return
    ...
    public function setProductCategories(PropelCollection $productCategories, PropelPDO $con = null)
    {
        ...
        foreach ($productCategoriesToDelete as $productCategoryRemoved) {
            $productCategoryRemoved->setCategoryName(null);
        }
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategory[] List of ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategory objects
     */
    public function getProductCategoriesJoinProduct($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategoryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Category_Persistence_PacCategoryNamePeer::DEFAULT_STRING_FORMAT);
    }
