...
/**
 * Base class that represents a row from the 'pac_mci_cost_type' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/marketing-package/ProjectA/Zed/Mci/Persistence.om
 */
abstract class Generated_Zed_Mci_Persistence_Om_BasePacMciCostType extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer
     */
    ...
    /**
     * The value for the id_mci_cost_type field.
     * @var        int
     */
    protected $id_mci_cost_type;
    ...
    /**
     * Get the [id_mci_cost_type] column value.
     *
     * @return int
     */
    public function getIdMciCostType()
    {
        return $this->id_mci_cost_type;
    }
    ...
    /**
     * Set the value of [id_mci_cost_type] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Mci_Persistence_PacMciCostType The current object (for fluent API support)
     */
    public function setIdMciCostType($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_mci_cost_type !== $v) {
            $this->id_mci_cost_type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::ID_MCI_COST_TYPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_mci_cost_type = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Mci_Persistence_PacMciCostType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Mci_Persistence_PacMciCostTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::ID_MCI_COST_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_mci_cost_type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_mci_cost_type` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_mci_cost_type`':
                        $stmt->bindValue($identifier, $this->id_mci_cost_type, PDO::PARAM_INT);
                        break;
                    case '`name`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Mci_Persistence_PacMciCostType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Mci_Persistence_PacMciCostType'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdMciCostType(),
            $keys[1] => $this->getName(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdMciCostType($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::ID_MCI_COST_TYPE)) $criteria->add(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::ID_MCI_COST_TYPE, $this->id_mci_cost_type);
        if ($this->isColumnModified(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::NAME)) $criteria->add(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::ID_MCI_COST_TYPE, $this->id_mci_cost_type);
    ...
    /**
     * Generic method to set the primary key (id_mci_cost_type column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdMciCostType();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Mci_Persistence_PacMciCostType (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdMciCostType(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Mci_Persistence_PacMciCostType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer();
        }
     ...
     * If this ProjectA_Zed_Mci_Persistence_PacMciCostType is new, it will return
    ...
    public function setPacMciCostEntries(PropelCollection $pacMciCostEntries, PropelPDO $con = null)
    {
        ...
        foreach ($pacMciCostEntriesToDelete as $pacMciCostEntryRemoved) {
            $pacMciCostEntryRemoved->setMciCostType(null);
        }
    ...
    protected function doAddPacMciCostEntry($pacMciCostEntry)
    {
        ...
        $pacMciCostEntry->setMciCostType($this);
    }
    ...
    public function removePacMciCostEntry($pacMciCostEntry)
    {
        if ($this->getPacMciCostEntries()->contains($pacMciCostEntry)) {
            ...
            $pacMciCostEntry->setMciCostType(null);
        }
     ...
     * Otherwise if this PacMciCostType is new, it will return
     * an empty collection; or if this PacMciCostType has previously
     * been saved, it will retrieve related PacMciCostEntries from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacMciCostType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Mci_Persistence_PacMciCostTypePeer::DEFAULT_STRING_FORMAT);
    }
