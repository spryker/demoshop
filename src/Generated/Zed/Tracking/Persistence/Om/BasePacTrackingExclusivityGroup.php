...
/**
 * Base class that represents a row from the 'pac_tracking_exclusivity_group' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/marketing-package/ProjectA/Zed/Tracking/Persistence.om
 */
abstract class Generated_Zed_Tracking_Persistence_Om_BasePacTrackingExclusivityGroup extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer
     */
    ...
    /**
     * The value for the id_tracking_exclusivity_group field.
     * @var        int
     */
    protected $id_tracking_exclusivity_group;
    ...
    /**
     * Get the [id_tracking_exclusivity_group] column value.
     *
     * @return int
     */
    public function getIdTrackingExclusivityGroup()
    {
        return $this->id_tracking_exclusivity_group;
    }
    ...
    /**
     * Set the value of [id_tracking_exclusivity_group] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup The current object (for fluent API support)
     */
    public function setIdTrackingExclusivityGroup($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_tracking_exclusivity_group !== $v) {
            $this->id_tracking_exclusivity_group = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP;
        }


        return $this;
    } // setIdTrackingExclusivityGroup()
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_tracking_exclusivity_group = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP;
        if (null !== $this->id_tracking_exclusivity_group) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP)) {
            $modifiedColumns[':p' . $index++]  = '`id_tracking_exclusivity_group`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_tracking_exclusivity_group` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_tracking_exclusivity_group`':
                        $stmt->bindValue($identifier, $this->id_tracking_exclusivity_group, PDO::PARAM_INT);
                        break;
                    case '`name`':
        ...
        $this->setIdTrackingExclusivityGroup($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdTrackingExclusivityGroup();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdTrackingExclusivityGroup(),
            $keys[1] => $this->getName(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdTrackingExclusivityGroup($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdTrackingExclusivityGroup($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP)) $criteria->add(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP, $this->id_tracking_exclusivity_group);
        if ($this->isColumnModified(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::NAME)) $criteria->add(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::ID_TRACKING_EXCLUSIVITY_GROUP, $this->id_tracking_exclusivity_group);
    ...
    /**
     * Generic method to set the primary key (id_tracking_exclusivity_group column).
     *
    ...
    {
        $this->setIdTrackingExclusivityGroup($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdTrackingExclusivityGroup();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdTrackingExclusivityGroup(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer();
        }
     ...
     * If this ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroup is new, it will return
        ...
        if (null === $this->collTrackingPageExclusivities || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTrackingPageExclusivities) {
                ...
                $collTrackingPageExclusivities = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityQuery::create(null, $criteria)
                    ->filterByTrackingPageExclusivityGroup($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setTrackingPageExclusivities(PropelCollection $trackingPageExclusivities, PropelPDO $con = null)
    {
        ...
        foreach ($trackingPageExclusivitiesToDelete as $trackingPageExclusivityRemoved) {
            $trackingPageExclusivityRemoved->setTrackingPageExclusivityGroup(null);
        }
    ...
    protected function doAddTrackingPageExclusivity($trackingPageExclusivity)
    {
        ...
        $trackingPageExclusivity->setTrackingPageExclusivityGroup($this);
    }
    ...
    public function removeTrackingPageExclusivity($trackingPageExclusivity)
    {
        if ($this->getTrackingPageExclusivities()->contains($trackingPageExclusivity)) {
            ...
            $trackingPageExclusivity->setTrackingPageExclusivityGroup(null);
        }
     ...
     * Otherwise if this PacTrackingExclusivityGroup is new, it will return
     * an empty collection; or if this PacTrackingExclusivityGroup has previously
     * been saved, it will retrieve related TrackingPageExclusivities from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacTrackingExclusivityGroup.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivity[] List of ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivity objects
     */
    public function getTrackingPageExclusivitiesJoinTrackingInstance($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityQuery::create(null, $criteria);
        $query->joinWith('TrackingInstance', $join_behavior);
    ...
    {
        $this->id_tracking_exclusivity_group = null;
        $this->name = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Tracking_Persistence_PacTrackingExclusivityGroupPeer::DEFAULT_STRING_FORMAT);
    }
