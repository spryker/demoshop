 ...
 */
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesExpense extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer
     */
     ...
     * @return ProjectA_Zed_Sales_Persistence_PacSalesExpense The current object (for fluent API support)
     */
    public function setIdSalesExpense($v)
    {
        ...
        if ($this->id_sales_expense !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::ID_SALES_EXPENSE;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if ($this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TYPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::NAME;
        }
    ...
    public function setGrossPrice($v)
    {
        ...
        if ($this->gross_price !== $v) {
            $this->gross_price = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::GROSS_PRICE;
        }
    ...
    public function setPriceToPay($v)
    {
        ...
        if ($this->price_to_pay !== $v) {
            $this->price_to_pay = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::PRICE_TO_PAY;
        }
    ...
    public function setTaxPercentage($v)
    {
        ...
        if ($this->tax_percentage !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TAX_PERCENTAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_PacSalesExpense object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_PacSalesExpenseQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::ID_SALES_EXPENSE)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_expense`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::GROSS_PRICE)) {
            $modifiedColumns[':p' . $index++]  = '`gross_price`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::PRICE_TO_PAY)) {
            $modifiedColumns[':p' . $index++]  = '`price_to_pay`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TAX_PERCENTAGE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesExpense'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesExpense'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::ID_SALES_EXPENSE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::ID_SALES_EXPENSE, $this->id_sales_expense);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::FK_SALES_ORDER, $this->fk_sales_order);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TYPE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TYPE, $this->type);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::GROSS_PRICE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::GROSS_PRICE, $this->gross_price);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::PRICE_TO_PAY)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::PRICE_TO_PAY, $this->price_to_pay);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TAX_PERCENTAGE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::TAX_PERCENTAGE, $this->tax_percentage);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::ID_SALES_EXPENSE, $this->id_sales_expense);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_PacSalesExpense (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_PacSalesExpense Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer();
        }
     ...
     * If this ProjectA_Zed_Sales_Persistence_PacSalesExpense is new, it will return
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_PacSalesExpensePeer::DEFAULT_STRING_FORMAT);
    }
