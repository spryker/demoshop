...
/**
 * Base class that represents a row from the 'pac_sales_order_item_transition_log' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/sales-package/ProjectA/Zed/Sales/Persistence.om
 */
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderItemTransitionLog extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer
     */
    ...
    /**
     * The value for the id_sales_order_item_transition_log field.
     * @var        int
     */
    protected $id_sales_order_item_transition_log;
    ...
    /**
     * Get the [id_sales_order_item_transition_log] column value.
     *
     * @return int
     */
    public function getIdSalesOrderItemTransitionLog()
    {
        return $this->id_sales_order_item_transition_log;
    }
    ...
    /**
     * Set the value of [id_sales_order_item_transition_log] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog The current object (for fluent API support)
     */
    public function setIdSalesOrderItemTransitionLog($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_sales_order_item_transition_log !== $v) {
            $this->id_sales_order_item_transition_log = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG;
        }


        return $this;
    } // setIdSalesOrderItemTransitionLog()
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if ($this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER;
        }
    ...
    public function setFkAclUser($v)
    {
        ...
        if ($this->fk_acl_user !== $v) {
            $this->fk_acl_user = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_ACL_USER;
        }
    ...
    public function setLocked($v)
    {
        ...
        if ($this->locked !== $v) {
            $this->locked = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::LOCKED;
        }
    ...
    public function setFkSalesOrderProcess($v)
    {
        ...
        if ($this->fk_sales_order_process !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_PROCESS;
        }
    ...
    public function setEvent($v)
    {
        ...
        if ($this->event !== $v) {
            $this->event = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::EVENT;
        }
    ...
    public function setHostname($v)
    {
        ...
        if ($this->hostname !== $v) {
            $this->hostname = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::HOSTNAME;
        }
    ...
    public function setModule($v)
    {
        ...
        if ($this->module !== $v) {
            $this->module = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::MODULE;
        }
    ...
    public function setController($v)
    {
        ...
        if ($this->controller !== $v) {
            $this->controller = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONTROLLER;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ACTION;
        }
    ...
    public function setParams($v)
    {
        if ($this->params_unserialized !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::PARAMS;
        }
    ...
    public function setSourceState($v)
    {
        ...
        if ($this->source_state !== $v) {
            $this->source_state = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::SOURCE_STATE;
        }
    ...
    public function setTargetState($v)
    {
        ...
        if ($this->target_state !== $v) {
            $this->target_state = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::TARGET_STATE;
        }
    ...
    public function setCommands($v)
    {
        if ($this->commands_unserialized !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::COMMANDS;
        }
    ...
    public function setConditions($v)
    {
        if ($this->conditions_unserialized !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONDITIONS;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR_MESSAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_sales_order_item_transition_log = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->fk_sales_order_process = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            return $startcol + 20; // 20 = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG;
        if (null !== $this->id_sales_order_item_transition_log) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_item_transition_log`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_ACL_USER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_acl_user`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::LOCKED)) {
            $modifiedColumns[':p' . $index++]  = '`locked`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_PROCESS)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_process`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::EVENT)) {
            $modifiedColumns[':p' . $index++]  = '`event`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::HOSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`hostname`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::MODULE)) {
            $modifiedColumns[':p' . $index++]  = '`module`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONTROLLER)) {
            $modifiedColumns[':p' . $index++]  = '`controller`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ACTION)) {
            $modifiedColumns[':p' . $index++]  = '`action`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::PARAMS)) {
            $modifiedColumns[':p' . $index++]  = '`params`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::SOURCE_STATE)) {
            $modifiedColumns[':p' . $index++]  = '`source_state`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::TARGET_STATE)) {
            $modifiedColumns[':p' . $index++]  = '`target_state`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::COMMANDS)) {
            $modifiedColumns[':p' . $index++]  = '`commands`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONDITIONS)) {
            $modifiedColumns[':p' . $index++]  = '`conditions`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR)) {
            $modifiedColumns[':p' . $index++]  = '`error`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR_MESSAGE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_sales_order_item_transition_log` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_sales_order_item_transition_log`':
                        $stmt->bindValue($identifier, $this->id_sales_order_item_transition_log, PDO::PARAM_INT);
                        break;
        ...
        $this->setIdSalesOrderItemTransitionLog($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdSalesOrderItemTransitionLog();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSalesOrderItemTransitionLog(),
            $keys[1] => $this->getFkSalesOrderItem(),
            $keys[2] => $this->getFkSalesOrder(),
            $keys[3] => $this->getFkAclUser(),
            $keys[4] => $this->getLocked(),
            $keys[5] => $this->getFkSalesOrderProcess(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdSalesOrderItemTransitionLog($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSalesOrderItemTransitionLog($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[5], $arr)) $this->setFkSalesOrderProcess($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG, $this->id_sales_order_item_transition_log);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER, $this->fk_sales_order);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_ACL_USER)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_ACL_USER, $this->fk_acl_user);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::LOCKED)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::LOCKED, $this->locked);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_PROCESS)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::FK_SALES_ORDER_PROCESS, $this->fk_sales_order_process);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::EVENT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::EVENT, $this->event);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::HOSTNAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::HOSTNAME, $this->hostname);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::MODULE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::MODULE, $this->module);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONTROLLER)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONTROLLER, $this->controller);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ACTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ACTION, $this->action);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::PARAMS)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::PARAMS, $this->params);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::SOURCE_STATE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::SOURCE_STATE, $this->source_state);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::TARGET_STATE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::TARGET_STATE, $this->target_state);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::COMMANDS)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::COMMANDS, $this->commands);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONDITIONS)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CONDITIONS, $this->conditions);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR, $this->error);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR_MESSAGE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::ID_SALES_ORDER_ITEM_TRANSITION_LOG, $this->id_sales_order_item_transition_log);
    ...
    /**
     * Generic method to set the primary key (id_sales_order_item_transition_log column).
     *
    ...
    {
        $this->setIdSalesOrderItemTransitionLog($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdSalesOrderItemTransitionLog();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSalesOrderItemTransitionLog(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer();
        }
     ...
     * @throws PropelException
     */
    public function setAclUser(ProjectA_Zed_Acl_Persistence_PacAclUser $v = null)
    {
        if ($v === null) {
    ...
    public function getAclUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAclUser === null && ($this->fk_acl_user !== null) && $doQuery) {
            $this->aAclUser = ProjectA_Zed_Acl_Persistence_PacAclUserQuery::create()->findPk($this->fk_acl_user, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    {
        $this->id_sales_order_item_transition_log = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::DEFAULT_STRING_FORMAT);
    }
