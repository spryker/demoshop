...
/**
 * Base class that represents a row from the 'pac_sales_order_process' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/sales-package/ProjectA/Zed/Sales/Persistence.om
 */
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderProcess extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer
     */
    ...
    /**
     * The value for the id_sales_order_process field.
     * @var        int
     */
    protected $id_sales_order_process;
    ...
    /**
     * Get the [id_sales_order_process] column value.
     *
     * @return int
     */
    public function getIdSalesOrderProcess()
    {
        return $this->id_sales_order_process;
    }
    ...
    /**
     * Set the value of [id_sales_order_process] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess The current object (for fluent API support)
     */
    public function setIdSalesOrderProcess($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_sales_order_process !== $v) {
            $this->id_sales_order_process = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS;
        }


        return $this;
    } // setIdSalesOrderProcess()
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_sales_order_process = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS;
        if (null !== $this->id_sales_order_process) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_process`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_sales_order_process` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_sales_order_process`':
                        $stmt->bindValue($identifier, $this->id_sales_order_process, PDO::PARAM_INT);
                        break;
                    case '`name`':
        ...
        $this->setIdSalesOrderProcess($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdSalesOrderProcess();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSalesOrderProcess(),
            $keys[1] => $this->getName(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdSalesOrderProcess($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSalesOrderProcess($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS, $this->id_sales_order_process);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::ID_SALES_ORDER_PROCESS, $this->id_sales_order_process);
    ...
    /**
     * Generic method to set the primary key (id_sales_order_process column).
     *
    ...
    {
        $this->setIdSalesOrderProcess($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdSalesOrderProcess();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSalesOrderProcess(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer();
        }
     ...
     * If this ProjectA_Zed_Sales_Persistence_PacSalesOrderProcess is new, it will return
     ...
     * Otherwise if this PacSalesOrderProcess is new, it will return
     * an empty collection; or if this PacSalesOrderProcess has previously
     * been saved, it will retrieve related TransitionLogs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacSalesOrderProcess.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Sales_Persistence_PacSalesOrderItem[] List of ProjectA_Zed_Sales_Persistence_PacSalesOrderItem objects
     */
    public function getItemsJoinOrder($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemQuery::create(null, $criteria);
        $query->joinWith('Order', $join_behavior);
    ...
    {
        $this->id_sales_order_process = null;
        $this->name = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_PacSalesOrderProcessPeer::DEFAULT_STRING_FORMAT);
    }
