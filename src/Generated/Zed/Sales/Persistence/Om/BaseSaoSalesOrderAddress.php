...
/**
 * Base class that represents a row from the 'sao_sales_order_address' table.
 *
 *
 *
 * @package    propel.generator.project/Sao/Zed/Sales/Persistence.om
 */
abstract class Generated_Zed_Sales_Persistence_Om_BaseSaoSalesOrderAddress extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer
     */
     ...
     * @return Sao_Zed_Sales_Persistence_SaoSalesOrderAddress The current object (for fluent API support)
     */
    public function setIdSalesOrderAddress($v)
    {
        ...
        if ($this->id_sales_order_address !== $v) {
            ...
            $this->modifiedColumns[] = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS;
        }

        if ($this->aAddress !== null && $this->aAddress->getIdSalesOrderAddress() !== $v) {
            $this->aAddress = null;
        }
    ...
    public function setFkMiscRegion($v)
    {
        ...
        if ($this->fk_misc_region !== $v) {
            ...
            $this->modifiedColumns[] = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::FK_MISC_REGION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fk_misc_region = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Sao_Zed_Sales_Persistence_SaoSalesOrderAddress object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAddress !== null && $this->id_sales_order_address !== $this->aAddress->getIdSalesOrderAddress()) {
            $this->aAddress = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_address`';
        }
        if ($this->isColumnModified(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::FK_MISC_REGION)) {
            $modifiedColumns[':p' . $index++]  = '`fk_misc_region`';
        }

        $sql = sprintf(
            'INSERT INTO `sao_sales_order_address` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Sao_Zed_Sales_Persistence_SaoSalesOrderAddress'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sao_Zed_Sales_Persistence_SaoSalesOrderAddress'][$this->getPrimaryKey()] = true;
        $keys = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSalesOrderAddress(),
            $keys[1] => $this->getFkMiscRegion(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setFkMiscRegion($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS)) $criteria->add(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS, $this->id_sales_order_address);
        if ($this->isColumnModified(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::FK_MISC_REGION)) $criteria->add(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::FK_MISC_REGION, $this->fk_misc_region);
    ...
    {
        $criteria = new Criteria(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::DATABASE_NAME);
        $criteria->add(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS, $this->id_sales_order_address);
     ...
     * objects.
     *
     * @param object $copyObj An object of Sao_Zed_Sales_Persistence_SaoSalesOrderAddress (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Sao_Zed_Sales_Persistence_SaoSalesOrderAddress Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer();
        }
     ...
     * @throws PropelException
     */
    public function setAddress(ProjectA_Zed_Sales_Persistence_PacSalesOrderAddress $v = null)
    {
        if ($v === null) {
            $this->setIdSalesOrderAddress(NULL);
        } else {
            $this->setIdSalesOrderAddress($v->getIdSalesOrderAddress());
        }
    ...
    {
        if ($this->aAddress === null && ($this->id_sales_order_address !== null) && $doQuery) {
            $this->aAddress = ProjectA_Zed_Sales_Persistence_PacSalesOrderAddressQuery::create()->findPk($this->id_sales_order_address, $con);
            // Because this foreign key represents a one-to-one relationship, we will create a bi-directional association.
            $this->aAddress->setSaoAddress($this);
        }
    ...
    public function getRegion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegion === null && ($this->fk_misc_region !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRegion->addSaoAddresses($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::DEFAULT_STRING_FORMAT);
    }
