 ...
 */
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderItemOption extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderItemOption object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption The current object (for fluent API support)
     */
    public function setIdSalesOrderItemOption($v)
    {
        ...
        if ($this->id_sales_order_item_option !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setIdentifier($v)
    {
        ...
        if ($this->identifier !== $v) {
            $this->identifier = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::IDENTIFIER;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DESCRIPTION;
        }
    ...
    public function setGrossPrice($v)
    {
        ...
        if ($this->gross_price !== $v) {
            $this->gross_price = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::GROSS_PRICE;
        }
    ...
    public function setPriceToPay($v)
    {
        ...
        if ($this->price_to_pay !== $v) {
            $this->price_to_pay = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::PRICE_TO_PAY;
        }
    ...
    public function setTaxPercentage($v)
    {
        ...
        if ($this->tax_percentage !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_item_option`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::IDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = '`identifier`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::GROSS_PRICE)) {
            $modifiedColumns[':p' . $index++]  = '`gross_price`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::PRICE_TO_PAY)) {
            $modifiedColumns[':p' . $index++]  = '`price_to_pay`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION, $this->id_sales_order_item_option);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::IDENTIFIER)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::IDENTIFIER, $this->identifier);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::GROSS_PRICE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::GROSS_PRICE, $this->gross_price);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::PRICE_TO_PAY)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::PRICE_TO_PAY, $this->price_to_pay);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE, $this->tax_percentage);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION, $this->id_sales_order_item_option);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer();
        }
     ...
     * If this ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOption is new, it will return
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_PacSalesOrderItemOptionPeer::DEFAULT_STRING_FORMAT);
    }
