...
/**
 * Base class that represents a row from the 'pac_mcm_partner' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/marketing-package/ProjectA/Zed/Mcm/Persistence.om
 */
abstract class Generated_Zed_Mcm_Persistence_Om_BasePacMcmPartner extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer
     */
    ...
    /**
     * The value for the id_mcm_partner field.
     * @var        int
     */
    protected $id_mcm_partner;
    ...
    /**
     * Get the [id_mcm_partner] column value.
     *
     * @return int
     */
    public function getIdMcmPartner()
    {
        return $this->id_mcm_partner;
    }
    ...
    /**
     * Set the value of [id_mcm_partner] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmPartner The current object (for fluent API support)
     */
    public function setIdMcmPartner($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_mcm_partner !== $v) {
            $this->id_mcm_partner = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::ID_MCM_PARTNER;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::NAME;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::URL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_mcm_partner = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Mcm_Persistence_PacMcmPartner object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::ID_MCM_PARTNER)) {
            $modifiedColumns[':p' . $index++]  = '`id_mcm_partner`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`url`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_mcm_partner` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_mcm_partner`':
                        $stmt->bindValue($identifier, $this->id_mcm_partner, PDO::PARAM_INT);
                        break;
                    case '`name`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Mcm_Persistence_PacMcmPartner'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Mcm_Persistence_PacMcmPartner'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdMcmPartner(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getUrl(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdMcmPartner($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::ID_MCM_PARTNER)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::ID_MCM_PARTNER, $this->id_mcm_partner);
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::NAME)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::URL)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::URL, $this->url);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::ID_MCM_PARTNER, $this->id_mcm_partner);
    ...
    /**
     * Generic method to set the primary key (id_mcm_partner column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdMcmPartner();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Mcm_Persistence_PacMcmPartner (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdMcmPartner(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmPartner Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer();
        }
     ...
     * If this ProjectA_Zed_Mcm_Persistence_PacMcmPartner is new, it will return
    ...
    public function setPacMcmPartnerInChannels(PropelCollection $pacMcmPartnerInChannels, PropelPDO $con = null)
    {
        ...
        foreach ($pacMcmPartnerInChannelsToDelete as $pacMcmPartnerInChannelRemoved) {
            $pacMcmPartnerInChannelRemoved->setMcmPartner(null);
        }
    ...
    protected function doAddPacMcmPartnerInChannel($pacMcmPartnerInChannel)
    {
        ...
        $pacMcmPartnerInChannel->setMcmPartner($this);
    }
    ...
    public function removePacMcmPartnerInChannel($pacMcmPartnerInChannel)
    {
        if ($this->getPacMcmPartnerInChannels()->contains($pacMcmPartnerInChannel)) {
            ...
            $pacMcmPartnerInChannel->setMcmPartner(null);
        }
     ...
     * Otherwise if this PacMcmPartner is new, it will return
     * an empty collection; or if this PacMcmPartner has previously
     * been saved, it will retrieve related PacMcmPartnerInChannels from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacMcmPartner.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Mcm_Persistence_PacMcmPartnerInChannel[] List of ProjectA_Zed_Mcm_Persistence_PacMcmPartnerInChannel objects
     */
    public function getPacMcmPartnerInChannelsJoinMcmChannel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Mcm_Persistence_PacMcmPartnerInChannelQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Mcm_Persistence_PacMcmPartnerPeer::DEFAULT_STRING_FORMAT);
    }
