...
/**
 * Base class that represents a row from the 'pac_mcm_campaign' table.
 *
 *
 *
 * @package    propel.generator.vendor/project-a/marketing-package/ProjectA/Zed/Mcm/Persistence.om
 */
abstract class Generated_Zed_Mcm_Persistence_Om_BasePacMcmCampaign extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer
     */
    ...
    /**
     * The value for the id_mcm_campaign field.
     * @var        int
     */
    protected $id_mcm_campaign;

    /**
     * The value for the wmc field.
     * @var        int
     */
    protected $wmc;
    ...
    /**
     * Initializes internal state of Generated_Zed_Mcm_Persistence_Om_BasePacMcmCampaign object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [id_mcm_campaign] column value.
     *
     * @return int
     */
    public function getIdMcmCampaign()
    {
        return $this->id_mcm_campaign;
    }

    /**
     * Get the [wmc] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_mcm_campaign] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmCampaign The current object (for fluent API support)
     */
    public function setIdMcmCampaign($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_mcm_campaign !== $v) {
            $this->id_mcm_campaign = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::ID_MCM_CAMPAIGN;
        }
    ...
    /**
     * Set the value of [wmc] column.
     *
     * @param int $v new value
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmCampaign The current object (for fluent API support)
     */
    public function setWmc($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->wmc !== $v) {
            $this->wmc = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::WMC;
        }
    ...
    public function setFkMcmPublication($v)
    {
        ...
        if ($this->fk_mcm_publication !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::FK_MCM_PUBLICATION;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::IS_ACTIVE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_mcm_campaign = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->wmc = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->fk_mcm_publication = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Mcm_Persistence_PacMcmCampaign object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::ID_MCM_CAMPAIGN)) {
            $modifiedColumns[':p' . $index++]  = '`id_mcm_campaign`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::WMC)) {
            $modifiedColumns[':p' . $index++]  = '`wmc`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::FK_MCM_PUBLICATION)) {
            $modifiedColumns[':p' . $index++]  = '`fk_mcm_publication`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`is_active`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_mcm_campaign` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_mcm_campaign`':
                        $stmt->bindValue($identifier, $this->id_mcm_campaign, PDO::PARAM_INT);
                        break;
                    case '`wmc`':
                        $stmt->bindValue($identifier, $this->wmc, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Mcm_Persistence_PacMcmCampaign'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Mcm_Persistence_PacMcmCampaign'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdMcmCampaign(),
            $keys[1] => $this->getWmc(),
            $keys[2] => $this->getFkMcmPublication(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdMcmCampaign($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setWmc($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setFkMcmPublication($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::ID_MCM_CAMPAIGN)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::ID_MCM_CAMPAIGN, $this->id_mcm_campaign);
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::WMC)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::WMC, $this->wmc);
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::FK_MCM_PUBLICATION)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::FK_MCM_PUBLICATION, $this->fk_mcm_publication);
        if ($this->isColumnModified(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::IS_ACTIVE)) $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::IS_ACTIVE, $this->is_active);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::ID_MCM_CAMPAIGN, $this->id_mcm_campaign);
    ...
    /**
     * Generic method to set the primary key (id_mcm_campaign column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdMcmCampaign();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Mcm_Persistence_PacMcmCampaign (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdMcmCampaign(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmCampaign Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer();
        }
    ...
    public function getMcmPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMcmPublication === null && ($this->fk_mcm_publication !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMcmPublication->addPacMcmCampaigns($this);
             */
        }
     ...
     * If this ProjectA_Zed_Mcm_Persistence_PacMcmCampaign is new, it will return
    ...
    public function setPacMciCostEntries(PropelCollection $pacMciCostEntries, PropelPDO $con = null)
    {
        ...
        foreach ($pacMciCostEntriesToDelete as $pacMciCostEntryRemoved) {
            $pacMciCostEntryRemoved->setMcmCampaign(null);
        }
    ...
    protected function doAddPacMciCostEntry($pacMciCostEntry)
    {
        ...
        $pacMciCostEntry->setMcmCampaign($this);
    }
    ...
    public function removePacMciCostEntry($pacMciCostEntry)
    {
        if ($this->getPacMciCostEntries()->contains($pacMciCostEntry)) {
            ...
            $pacMciCostEntry->setMcmCampaign(null);
        }
     ...
     * Otherwise if this PacMcmCampaign is new, it will return
     * an empty collection; or if this PacMcmCampaign has previously
     * been saved, it will retrieve related PacMciCostEntries from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacMcmCampaign.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Mcm_Persistence_PacMcmCampaignPeer::DEFAULT_STRING_FORMAT);
    }
