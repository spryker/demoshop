<?php
/**
 * Class Sao_Shared_Sales_Transfer_OriginalNotification
 */
class Sao_Shared_Sales_Transfer_OriginalNotification extends ProjectA_Shared_Library_Abstract_Object
{
