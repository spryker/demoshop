 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_OpsClarifyArtworkAvailability
        ...
        implements ProjectA_Zed_Sales_Component_Interface_OrderItemCommand
{
    ...
    {
        return Sao_Zed_Mail_Component_Model_Constants::CLARIFY_ARTWORK_AVAILABILTY;
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getOpsClarifyArtworkAvailabilityMailTransfer($orderItemEntity);
