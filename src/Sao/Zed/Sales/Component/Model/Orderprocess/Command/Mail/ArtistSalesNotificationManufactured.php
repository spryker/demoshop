 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_ArtistSalesNotificationManufactured extends ProjectA_Zed_Sales_Component_Model_Orderprocess_Command_Mail_Abstract
    implements
        ...
        ProjectA_Zed_Mail_Component_Dependency_Facade_Interface
{
    ...
    {
        return Sao_Zed_Mail_Component_Model_Constants::ARTIST_SALES_NOTIFICATION_MANUFACTURED;
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getArtistSalesNotificationManufacturedMailTransfer($orderItemEntity);
