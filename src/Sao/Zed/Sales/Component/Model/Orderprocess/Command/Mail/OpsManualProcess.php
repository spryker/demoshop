 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_OpsManualProcess
        ...
        implements ProjectA_Zed_Sales_Component_Interface_OrderItemCommand
{
    ...
    {
        return Sao_Zed_Mail_Component_Model_Constants::MANUAL_PROCESS;
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getOpsManualProcessMailTransfer($orderItemEntity);
