 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_PreShippingInfoOriginal extends ProjectA_Zed_Sales_Component_Model_Orderprocess_Command_Mail_Abstract implements
    ...
    ProjectA_Zed_Mail_Component_Dependency_Facade_Interface
{
    ...
    {
        return 'pre shipping info original';
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getPreShippingInfoOriginalMailTransfer($orderItemEntity);
