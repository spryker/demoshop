 ...
 */
class Sao_Zed_Mail_Component_Model_Collector_ArtistSalesNotification extends Sao_Zed_Mail_Component_Model_Collector
    implements ProjectA_Zed_Catalog_Component_Dependency_Facade_Interface
{
    ...
    /**
     * @var Sao_Shared_Mail_Transfer_ArtistSalesNotification
     */
    ...
    {
        return self::ARTIST_SALES_NOTIFICATION_MARKETPLACE;
    }
    ...
    {
        return Generated_Shared_Library_TransferLoader::getMailArtistSalesNotification();
    }

    /**
     * @param BaseObject $orderItemEntity - ProjectA_Zed_Sales_Persistence_PacSalesOrderItem
     * @param null $context
     * @return mixed|Sao_Shared_Mail_Transfer_ArtistSalesNotification
     */
