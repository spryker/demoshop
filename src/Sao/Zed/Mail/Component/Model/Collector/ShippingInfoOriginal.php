 ...
 */
class Sao_Zed_Mail_Component_Model_Collector_ShippingInfoOriginal extends Sao_Zed_Mail_Component_Model_Collector implements
    Sao_Zed_Fulfillment_Component_Dependency_Facade_Interface
{
    use Sao_Zed_Fulfillment_Component_Dependency_Facade_Trait;

    /**
     * @var Sao_Shared_Mail_Transfer_ShippingInfoOriginal
     */
    ...
    {
        return self::SHIPPING_INFO_ORIGINAL;
    }
    ...
    {
        return Generated_Shared_Library_TransferLoader::getMailShippingInfoOriginal();
    }
