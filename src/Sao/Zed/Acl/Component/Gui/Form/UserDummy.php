...
class Sao_Zed_Acl_Component_Gui_Form_UserDummy extends ProjectA_Zed_Acl_Component_Gui_Form_User
{
    ...
    public function initAfterDependencyInjection()
    {
        ...
        $firstName->setLabel('Firstname DUMMY')
            ->setRequired(true);
        $this->addElement($firstName);

        $lastName = new ProjectA_Zed_Library_Form_Element_Text('lastname');
        $lastName->setLabel('Lastname DUMMY')
            ->setRequired(true);
