...
*/
abstract class SpyDistributorItem extends SpyDistributorItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyDistributorItemTableMap';
    ...
    /**
     * @var        ChildSpyGlossaryTranslation
     */
    ...
    /**
     * Initializes internal state of Propel\Base\SpyDistributorItem object.
     */
     ...
     * @return $this|\Propel\SpyDistributorItem The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyDistributorItem'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyDistributorItem
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyDistributorItem The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyDistributorItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyDistributorItem Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildSpyGlossaryTranslation object.
     *
     * @param  ChildSpyGlossaryTranslation $v
     * @return $this|\Propel\SpyDistributorItem The current object (for fluent API support)
     * @throws PropelException
     */
    public function setSpyGlossaryTranslation(ChildSpyGlossaryTranslation $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildSpyGlossaryTranslation object, it will not be re-added.
        if ($v !== null) {
            $v->addSpyDistributorItem($this);
        }
    ...
    /**
     * Get the associated ChildSpyGlossaryTranslation object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildSpyGlossaryTranslation The associated ChildSpyGlossaryTranslation object.
     * @throws PropelException
     */
    public function getSpyGlossaryTranslation(ConnectionInterface $con = null)
    {
        if ($this->aSpyGlossaryTranslation === null && ($this->fk_glossary_translation !== null)) {
            $this->aSpyGlossaryTranslation = ChildSpyGlossaryTranslationQuery::create()->findPk($this->fk_glossary_translation, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
