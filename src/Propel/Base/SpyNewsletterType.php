...
*/
abstract class SpyNewsletterType extends SpyNewsletterType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyNewsletterTypeTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyNewsletterType object.
     */
     ...
     *
     * @return $this|SpyNewsletterType The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyNewsletterType The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyNewsletterType'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyNewsletterType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyNewsletterType The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyNewsletterType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyNewsletterType Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->getSpyNewsletterSubscribers()->contains($spyNewsletterSubscriber)) { $spyNewsletterSubscription = new ChildSpyNewsletterSubscription();
