 ...
 *
 * @method     \Propel\SpyProductOptionConfigurationPresetQuery|\Propel\SpyProductOptionValueUsageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionConfigurationPresetValueQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpyProductOptionConfigurationPresetValueQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpyProductOptionConfigurationPresetValue', $modelAlias = null)
    {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildSpyProductOptionConfigurationPresetValue();
            $obj->hydrate($row);
     ...
     *
     * @param \Propel\SpyProductOptionConfigurationPreset|ObjectCollection $spyProductOptionConfigurationPreset The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function doSelect(ConnectionInterface $con = null)
    {
        ...
        $db = Propel::getServiceContainer()->getAdapter(SpyProductOptionConfigurationPresetValueTableMap::DATABASE_NAME);
