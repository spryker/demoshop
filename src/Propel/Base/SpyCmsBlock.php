...
*/
abstract class SpyCmsBlock extends SpyCmsBlock implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyCmsBlockTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyCmsBlock object.
     */
     ...
     *
     * @return $this|SpyCmsBlock The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyCmsBlock The current object (for fluent API support)
     */
    ...
    public function setFkPage($v)
    {
        ...
        if ($this->fk_page !== $v) {
            $this->fk_page = $v;
            $this->modifiedColumns[SpyCmsBlockTableMap::COL_FK_PAGE] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[SpyCmsBlockTableMap::COL_TYPE] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[SpyCmsBlockTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyCmsBlockTableMap::translateFieldName('FkPage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_page = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyCmsBlockTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyCmsBlockTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyCmsBlockTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = SpyCmsBlockTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyCmsBlock'), 0, $e);
        }
    }
    ...
    {
        if ($this->aSpyCmsPage !== null && $this->fk_page !== $this->aSpyCmsPage->getIdCmsPage()) {
            $this->aSpyCmsPage = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_FK_PAGE)) {
            $modifiedColumns[':p' . $index++]  = 'fk_page';
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_VALUE)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyCmsBlock
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyCmsBlock The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_FK_PAGE)) {
            $criteria->add(SpyCmsBlockTableMap::COL_FK_PAGE, $this->fk_page);
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_NAME)) {
            $criteria->add(SpyCmsBlockTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_TYPE)) {
            $criteria->add(SpyCmsBlockTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(SpyCmsBlockTableMap::COL_VALUE)) {
            $criteria->add(SpyCmsBlockTableMap::COL_VALUE, $this->value);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyCmsBlock (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyCmsBlock Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aSpyCmsPage === null && ($this->fk_page !== null)) {
            $this->aSpyCmsPage = ChildSpyCmsPageQuery::create()->findPk($this->fk_page, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpyCmsPage->addSpyCmsBlocks($this);
             */
        }
    ...
    {
        if (null !== $this->aSpyCmsPage) {
            $this->aSpyCmsPage->removeSpyCmsBlock($this);
        }
