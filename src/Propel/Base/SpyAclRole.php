...
*/
abstract class SpyAclRole extends SpyAclRole implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyAclRoleTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyAclRole object.
     */
     ...
     *
     * @return $this|SpyAclRole The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyAclRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyAclRole'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyAclRole The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyAclRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyAclRole Clone of current object.
     * @throws PropelException
     */
    ...
    public function initAclRules($overrideExisting = true)
    {
        ...
        $this->collAclRules = new ObjectCollection();
        $this->collAclRules->setModel('\Propel\SpyAclRule');
    }
    ...
    {
        if ($this->getSpyAclGroups()->contains($spyAclGroup)) { $spyAclGroupsHasRoles = new ChildSpyAclGroupsHasRoles();
