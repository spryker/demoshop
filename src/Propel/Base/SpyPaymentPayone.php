...
*/
abstract class SpyPaymentPayone extends SpyPaymentPayone implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyPaymentPayoneTableMap';
    ...
    /**
     * @var        ChildSpyPaymentPayoneDetail one-to-one related ChildSpyPaymentPayoneDetail object
     */
    protected $singleSpyPaymentPayoneDetail;
    ...
    /**
     * Initializes internal state of Propel\Base\SpyPaymentPayone object.
     */
     ...
     * @return $this|\Propel\SpyPaymentPayone The current object (for fluent API support)
     */
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if ($this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[SpyPaymentPayoneTableMap::COL_FK_SALES_ORDER] = true;
        }
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[SpyPaymentPayoneTableMap::COL_REFERENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('FkSalesOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_sales_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('PaymentMethod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_method = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('Reference', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reference = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('TransactionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transaction_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyPaymentPayoneTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = SpyPaymentPayoneTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyPaymentPayone'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->aSpySalesOrder = null;
            $this->singleSpyPaymentPayoneDetail = null;
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->singleSpyPaymentPayoneDetail !== null) {
                if (!$this->singleSpyPaymentPayoneDetail->isDeleted() && ($this->singleSpyPaymentPayoneDetail->isNew() || $this->singleSpyPaymentPayoneDetail->isModified())) {
                    $affectedRows += $this->singleSpyPaymentPayoneDetail->save($con);
                }
            }

            if ($this->spyPaymentPayoneApiLogsScheduledForDeletion !== null) {
                if (!$this->spyPaymentPayoneApiLogsScheduledForDeletion->isEmpty()) {
                    \Propel\SpyPaymentPayoneApiLogQuery::create()
            ...
            if ($this->spyPaymentPayoneTransactionStatusLogsScheduledForDeletion !== null) {
                if (!$this->spyPaymentPayoneTransactionStatusLogsScheduledForDeletion->isEmpty()) {
                    \Propel\SpyPaymentPayoneTransactionStatusLogQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_FK_SALES_ORDER)) {
        ...
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_REFERENCE)) {
        ...
        try {
            $pk = $con->lastInsertId('spy_payment_payone_pk_seq');
        } catch (Exception $e) {
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->singleSpyPaymentPayoneDetail) {

                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'spyPaymentPayoneDetail';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'spy_payment_payone_detail';
                        break;
                    default:
                        $key = 'SpyPaymentPayoneDetail';
                }

                $result[$key] = $this->singleSpyPaymentPayoneDetail->toArray($keyType, $includeLazyLoadColumns, $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyPaymentPayone
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setPaymentMethod($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyPaymentPayone The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_FK_SALES_ORDER)) {
            $criteria->add(SpyPaymentPayoneTableMap::COL_FK_SALES_ORDER, $this->fk_sales_order);
        }
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_PAYMENT_METHOD)) {
            $criteria->add(SpyPaymentPayoneTableMap::COL_PAYMENT_METHOD, $this->payment_method);
        }
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_REFERENCE)) {
            $criteria->add(SpyPaymentPayoneTableMap::COL_REFERENCE, $this->reference);
        }
        if ($this->isColumnModified(SpyPaymentPayoneTableMap::COL_TRANSACTION_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyPaymentPayone (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy) {
            ...
            $relObj = $this->getSpyPaymentPayoneDetail();
            if ($relObj) {
                $copyObj->setSpyPaymentPayoneDetail($relObj->copy($deepCopy));
            }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyPaymentPayone Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSpySalesOrder(ConnectionInterface $con = null)
    {
        if ($this->aSpySalesOrder === null && ($this->fk_sales_order !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpySalesOrder->addSpyPaymentPayones($this);
             */
        }
    ...
    /**
     * Gets a single ChildSpyPaymentPayoneDetail object, which is related to this object by a one-to-one relationship.
     *
     * @param  ConnectionInterface $con optional connection object
     * @return ChildSpyPaymentPayoneDetail
     * @throws PropelException
     */
    public function getSpyPaymentPayoneDetail(ConnectionInterface $con = null)
    {

        if ($this->singleSpyPaymentPayoneDetail === null && !$this->isNew()) {
            $this->singleSpyPaymentPayoneDetail = ChildSpyPaymentPayoneDetailQuery::create()->findPk($this->getPrimaryKey(), $con);
        }

        return $this->singleSpyPaymentPayoneDetail;
    }

    /**
     * Sets a single ChildSpyPaymentPayoneDetail object as related to this object by a one-to-one relationship.
     *
     * @param  ChildSpyPaymentPayoneDetail $v ChildSpyPaymentPayoneDetail
     * @return $this|\Propel\SpyPaymentPayone The current object (for fluent API support)
     * @throws PropelException
     */
    public function setSpyPaymentPayoneDetail(ChildSpyPaymentPayoneDetail $v = null)
    {
        $this->singleSpyPaymentPayoneDetail = $v;

        // Make sure that that the passed-in ChildSpyPaymentPayoneDetail isn't already associated with this object
        if ($v !== null && $v->getSpyPaymentPayone(null, false) === null) {
            $v->setSpyPaymentPayone($this);
        }
    ...
    public function initSpyPaymentPayoneApiLogs($overrideExisting = true)
    {
        ...
        $this->collSpyPaymentPayoneApiLogs->setModel('\Propel\SpyPaymentPayoneApiLog');
    }
    ...
    public function initSpyPaymentPayoneTransactionStatusLogs($overrideExisting = true)
    {
        ...
        $this->collSpyPaymentPayoneTransactionStatusLogs->setModel('\Propel\SpyPaymentPayoneTransactionStatusLog');
    }
    ...
    {
        if (null !== $this->aSpySalesOrder) {
            $this->aSpySalesOrder->removeSpyPaymentPayone($this);
        }
    ...
    {
        if ($deep) {
            if ($this->singleSpyPaymentPayoneDetail) {
                $this->singleSpyPaymentPayoneDetail->clearAllReferences($deep);
            }
