...
*/
abstract class SpyShipmentCarrier extends SpyShipmentCarrier implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyShipmentCarrierTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyShipmentCarrier object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|SpyShipmentCarrier The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyShipmentCarrier The current object (for fluent API support)
     */
    ...
    public function setGlossaryKeyName($v)
    {
        ...
        if ($this->glossary_key_name !== $v) {
            ...
            $this->modifiedColumns[SpyShipmentCarrierTableMap::COL_GLOSSARY_KEY_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyShipmentCarrierTableMap::translateFieldName('GlossaryKeyName', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyShipmentCarrierTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SpyShipmentCarrierTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyShipmentCarrier'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->shipmentMethodssScheduledForDeletion !== null) {
                if (!$this->shipmentMethodssScheduledForDeletion->isEmpty()) {
                    \Propel\SpyShipmentMethodQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyShipmentCarrierTableMap::COL_GLOSSARY_KEY_NAME)) {
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getGlossaryKeyName(),
            $keys[2] => $this->getName(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyShipmentCarrier
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setGlossaryKeyName($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyShipmentCarrier The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyShipmentCarrierTableMap::COL_GLOSSARY_KEY_NAME)) {
            $criteria->add(SpyShipmentCarrierTableMap::COL_GLOSSARY_KEY_NAME, $this->glossary_key_name);
        }
        if ($this->isColumnModified(SpyShipmentCarrierTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyShipmentCarrier (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyShipmentCarrier Clone of current object.
     * @throws PropelException
     */
