...
*/
abstract class SpyTouchStorage extends SpyTouchStorage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyTouchStorageTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyTouchStorage object.
     */
     ...
     *
     * @return $this|SpyTouchStorage The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyTouchStorage The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyTouchStorageTableMap::translateFieldName('FkTouch', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_touch = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyTouchStorageTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = SpyTouchStorageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyTouchStorage'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyTouchStorage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyTouchStorage The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyTouchStorage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyTouchStorage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aTouch === null && ($this->fk_touch !== null)) {
