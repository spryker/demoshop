...
/**
 * Base class that represents a row from the 'spy_payment_payolution_order_item' table.
 *
 *
 *
* @package    propel.generator.src.Propel.Base
*/
abstract class SpyPaymentPayolutionOrderItem extends SpyPaymentPayolutionOrderItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyPaymentPayolutionOrderItemTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyPaymentPayolutionOrderItem object.
     */
    ...
    /**
     * Compares this with another <code>SpyPaymentPayolutionOrderItem</code> instance.  If
     * <code>obj</code> is an instance of <code>SpyPaymentPayolutionOrderItem</code>, delegates to
     * <code>equals(SpyPaymentPayolutionOrderItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SpyPaymentPayolutionOrderItem The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyPaymentPayolutionOrderItem The current object (for fluent API support)
     */
    public function setFkPaymentPayolution($v)
    {
        ...
        if ($this->fk_payment_payolution !== $v) {
            ...
            $this->modifiedColumns[SpyPaymentPayolutionOrderItemTableMap::COL_FK_PAYMENT_PAYOLUTION] = true;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[SpyPaymentPayolutionOrderItemTableMap::COL_FK_SALES_ORDER_ITEM] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[SpyPaymentPayolutionOrderItemTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SpyPaymentPayolutionOrderItemTableMap::translateFieldName('FkPaymentPayolution', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_payment_payolution = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyPaymentPayolutionOrderItemTableMap::translateFieldName('FkSalesOrderItem', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_sales_order_item = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyPaymentPayolutionOrderItemTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SpyPaymentPayolutionOrderItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyPaymentPayolutionOrderItem'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSpyPaymentPayolutionOrderItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SpyPaymentPayolutionOrderItem::setDeleted()
     * @see SpyPaymentPayolutionOrderItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSpyPaymentPayolutionOrderItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_CREATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpyPaymentPayolutionOrderItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_FK_PAYMENT_PAYOLUTION)) {
            $modifiedColumns[':p' . $index++]  = 'fk_payment_payolution';
        }
        if ($this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_FK_SALES_ORDER_ITEM)) {
        ...
        $sql = sprintf(
            'INSERT INTO spy_payment_payolution_order_item (%s) VALUES (%s)',
    ...
    {
        $pos = SpyPaymentPayolutionOrderItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['SpyPaymentPayolutionOrderItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SpyPaymentPayolutionOrderItem'][$this->hashCode()] = true;
        $keys = SpyPaymentPayolutionOrderItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFkPaymentPayolution(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyPaymentPayolutionOrderItem
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setFkPaymentPayolution($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyPaymentPayolutionOrderItem The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_FK_PAYMENT_PAYOLUTION)) {
            $criteria->add(SpyPaymentPayolutionOrderItemTableMap::COL_FK_PAYMENT_PAYOLUTION, $this->fk_payment_payolution);
        }
        if ($this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_FK_SALES_ORDER_ITEM)) {
            $criteria->add(SpyPaymentPayolutionOrderItemTableMap::COL_FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        }
        if ($this->isColumnModified(SpyPaymentPayolutionOrderItemTableMap::COL_CREATED_AT)) {
            $criteria->add(SpyPaymentPayolutionOrderItemTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildSpyPaymentPayolutionOrderItemQuery::create();
        $criteria->add(SpyPaymentPayolutionOrderItemTableMap::COL_FK_PAYMENT_PAYOLUTION, $this->fk_payment_payolution);
        $criteria->add(SpyPaymentPayolutionOrderItemTableMap::COL_FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
    ...
    {
        $validPk = null !== $this->getFkPaymentPayolution() &&
            null !== $this->getFkSalesOrderItem();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation spy_payment_payolution_order_item_fk_fd183f to table spy_payment_payolution
        if ($this->aSpyPaymentPayolution && $hash = spl_object_hash($this->aSpyPaymentPayolution)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation spy_payment_payolution_order_item_fk_d4f62a to table spy_sales_order_item
    ...
    {
        $pks = array();
        $pks[0] = $this->getFkPaymentPayolution();
    ...
    {
        $this->setFkPaymentPayolution($keys[0]);
    ...
    {
        return (null === $this->getFkPaymentPayolution()) && (null === $this->getFkSalesOrderItem());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyPaymentPayolutionOrderItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyPaymentPayolutionOrderItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSpyPaymentPayolution(ChildSpyPaymentPayolution $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSpyPaymentPayolutionOrderItem($this);
        }
    ...
    public function getSpyPaymentPayolution(ConnectionInterface $con = null)
    {
        if ($this->aSpyPaymentPayolution === null && ($this->fk_payment_payolution !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSpyPaymentPayolution->addSpyPaymentPayolutionOrderItems($this);
             */
        }
    ...
    {
        if ($this->aSpySalesOrderItem === null && ($this->fk_sales_order_item !== null)) {
            $this->aSpySalesOrderItem = ChildSpySalesOrderItemQuery::create()->findPk($this->fk_sales_order_item, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpySalesOrderItem->addSpyPaymentPayolutionOrderItems($this);
             */
        }
    ...
    {
        if (null !== $this->aSpyPaymentPayolution) {
            $this->aSpyPaymentPayolution->removeSpyPaymentPayolutionOrderItem($this);
        }
        if (null !== $this->aSpySalesOrderItem) {
            $this->aSpySalesOrderItem->removeSpyPaymentPayolutionOrderItem($this);
        }
    ...
    {
        return (string) $this->exportTo(SpyPaymentPayolutionOrderItemTableMap::DEFAULT_STRING_FORMAT);
    }
