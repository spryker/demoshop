 ...
 *
 * @method     ChildSpyDiscountVoucher findOne(ConnectionInterface $con = null) Return the first ChildSpyDiscountVoucher matching the query
 ...
 *
 * @method     ChildSpyDiscountVoucher findOneByIdDiscountVoucher(int $id_discount_voucher) Return the first ChildSpyDiscountVoucher filtered by the id_discount_voucher column
 * @method     ChildSpyDiscountVoucher findOneByFkDiscountVoucherPool(int $fk_discount_voucher_pool) Return the first ChildSpyDiscountVoucher filtered by the fk_discount_voucher_pool column
 * @method     ChildSpyDiscountVoucher findOneByCode(string $code) Return the first ChildSpyDiscountVoucher filtered by the code column
 * @method     ChildSpyDiscountVoucher findOneByNumberOfUses(int $number_of_uses) Return the first ChildSpyDiscountVoucher filtered by the number_of_uses column
 * @method     ChildSpyDiscountVoucher findOneByMaxNumberOfUses(int $max_number_of_uses) Return the first ChildSpyDiscountVoucher filtered by the max_number_of_uses column
 * @method     ChildSpyDiscountVoucher findOneByIsActive(boolean $is_active) Return the first ChildSpyDiscountVoucher filtered by the is_active column
 * @method     ChildSpyDiscountVoucher findOneByVoucherBatch(int $voucher_batch) Return the first ChildSpyDiscountVoucher filtered by the voucher_batch column
 * @method     ChildSpyDiscountVoucher findOneByCreatedAt(string $created_at) Return the first ChildSpyDiscountVoucher filtered by the created_at column
 * @method     ChildSpyDiscountVoucher findOneByUpdatedAt(string $updated_at) Return the first ChildSpyDiscountVoucher filtered by the updated_at column *
...
abstract class SpyDiscountVoucherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpyDiscountVoucherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpyDiscountVoucher', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyDiscountVoucherTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id_discount_voucher, fk_discount_voucher_pool, code, number_of_uses, max_number_of_uses, is_active, voucher_batch, created_at, updated_at FROM spy_discount_voucher WHERE id_discount_voucher = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyDiscountVoucherTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * $query->filterByIdDiscountVoucher(array(12, 34)); // WHERE id_discount_voucher IN (12, 34)
     * $query->filterByIdDiscountVoucher(array('min' => 12)); // WHERE id_discount_voucher > 12
     * </code>
     *
     ...
     * @return $this|ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    public function filterByIdDiscountVoucher($idDiscountVoucher = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_ID_DISCOUNT_VOUCHER, $idDiscountVoucher, $comparison);
    }
    ...
    public function filterByFkDiscountVoucherPool($fkDiscountVoucherPool = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_FK_DISCOUNT_VOUCHER_POOL, $fkDiscountVoucherPool, $comparison);
    }
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_CODE, $code, $comparison);
    }
     ...
     * $query->filterByNumberOfUses(array(12, 34)); // WHERE number_of_uses IN (12, 34)
     * $query->filterByNumberOfUses(array('min' => 12)); // WHERE number_of_uses > 12
     * </code>
     *
     ...
     * @return $this|ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    public function filterByNumberOfUses($numberOfUses = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_NUMBER_OF_USES, $numberOfUses, $comparison);
    }
     ...
     * $query->filterByMaxNumberOfUses(array(12, 34)); // WHERE max_number_of_uses IN (12, 34)
     * $query->filterByMaxNumberOfUses(array('min' => 12)); // WHERE max_number_of_uses > 12
     * </code>
     *
     ...
     * @return $this|ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    public function filterByMaxNumberOfUses($maxNumberOfUses = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_MAX_NUMBER_OF_USES, $maxNumberOfUses, $comparison);
    }
    ...
    public function filterByIsActive($isActive = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_IS_ACTIVE, $isActive, $comparison);
    }
     ...
     * $query->filterByVoucherBatch(array(12, 34)); // WHERE voucher_batch IN (12, 34)
     * $query->filterByVoucherBatch(array('min' => 12)); // WHERE voucher_batch > 12
     * </code>
     *
     ...
     * @return $this|ChildSpyDiscountVoucherQuery The current query, for fluid interface
     */
    public function filterByVoucherBatch($voucherBatch = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_VOUCHER_BATCH, $voucherBatch, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyDiscountVoucherTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
