...
*/
abstract class SpyCmsGlossaryKeyMapping extends SpyCmsGlossaryKeyMapping implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyCmsGlossaryKeyMappingTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyCmsGlossaryKeyMapping object.
     */
     ...
     *
     * @return $this|SpyCmsGlossaryKeyMapping The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyCmsGlossaryKeyMapping The current object (for fluent API support)
     */
    public function setIdCmsGlossaryKeyMapping($v)
    {
        ...
        if ($this->id_cms_glossary_key_mapping !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyCmsGlossaryKeyMappingTableMap::translateFieldName('FkPage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_page = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyCmsGlossaryKeyMappingTableMap::translateFieldName('FkGlossaryKey', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyCmsGlossaryKeyMapping'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyCmsGlossaryKeyMapping
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyCmsGlossaryKeyMapping The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyCmsGlossaryKeyMapping (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyCmsGlossaryKeyMapping Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aCmsPage === null && ($this->fk_page !== null)) {
