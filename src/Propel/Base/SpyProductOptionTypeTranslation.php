...
*/
abstract class SpyProductOptionTypeTranslation extends SpyProductOptionTypeTranslation implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyProductOptionTypeTranslationTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyProductOptionTypeTranslation object.
     */
     ...
     * @return $this|\Propel\SpyProductOptionTypeTranslation The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyProductOptionTypeTranslation'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyProductOptionTypeTranslation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyProductOptionTypeTranslation The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyProductOptionTypeTranslation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyProductOptionTypeTranslation Clone of current object.
     * @throws PropelException
     */
