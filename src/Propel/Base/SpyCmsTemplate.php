...
*/
abstract class SpyCmsTemplate extends SpyCmsTemplate implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyCmsTemplateTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyCmsTemplate object.
     */
     ...
     *
     * @return $this|SpyCmsTemplate The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyCmsTemplate The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyCmsTemplate'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyCmsTemplate
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyCmsTemplate The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyCmsTemplate (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyCmsTemplate Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSpyCmsPages($overrideExisting = true)
    {
        ...
        $this->collSpyCmsPages = new ObjectCollection();
        $this->collSpyCmsPages->setModel('\Propel\SpyCmsPage');
    }
