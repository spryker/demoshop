 ...
 *
 * @method     \Propel\SpyProductOptionValueQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SpyProductOptionValuePriceQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpyProductOptionValuePriceQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpyProductOptionValuePrice', $modelAlias = null)
    {
