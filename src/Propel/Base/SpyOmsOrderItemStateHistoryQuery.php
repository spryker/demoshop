...
use Propel\Map\SpyOmsOrderItemStateHistoryTableMap;
 ...
 * @method     ChildSpyOmsOrderItemStateHistoryQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method     ChildSpyOmsOrderItemStateHistoryQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     \Propel\SpySalesOrderItemQuery|\Propel\SpyOmsOrderItemStateQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildSpyOmsOrderItemStateHistory findOne(ConnectionInterface $con = null) Return the first ChildSpyOmsOrderItemStateHistory matching the query
 ...
 *
 * @method     ChildSpyOmsOrderItemStateHistory findOneByIdOmsOrderItemStateHistory(int $id_oms_order_item_state_history) Return the first ChildSpyOmsOrderItemStateHistory filtered by the id_oms_order_item_state_history column
 * @method     ChildSpyOmsOrderItemStateHistory findOneByFkSalesOrderItem(int $fk_sales_order_item) Return the first ChildSpyOmsOrderItemStateHistory filtered by the fk_sales_order_item column
 * @method     ChildSpyOmsOrderItemStateHistory findOneByFkOmsOrderItemState(int $fk_oms_order_item_state) Return the first ChildSpyOmsOrderItemStateHistory filtered by the fk_oms_order_item_state column
 * @method     ChildSpyOmsOrderItemStateHistory findOneByCreatedAt(string $created_at) Return the first ChildSpyOmsOrderItemStateHistory filtered by the created_at column
 * @method     ChildSpyOmsOrderItemStateHistory findOneByUpdatedAt(string $updated_at) Return the first ChildSpyOmsOrderItemStateHistory filtered by the updated_at column *
 ...
 * @method     ChildSpyOmsOrderItemStateHistory requireOneByUpdatedAt(string $updated_at) Return the first ChildSpyOmsOrderItemStateHistory filtered by the updated_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSpyOmsOrderItemStateHistory[]|ObjectCollection findByUpdatedAt(string $updated_at) Return ChildSpyOmsOrderItemStateHistory objects filtered by the updated_at column
...
abstract class SpyOmsOrderItemStateHistoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpyOmsOrderItemStateHistoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpyOmsOrderItemStateHistory', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyOmsOrderItemStateHistoryTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id_oms_order_item_state_history, fk_sales_order_item, fk_oms_order_item_state, created_at, updated_at FROM spy_oms_order_item_state_history WHERE id_oms_order_item_state_history = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyOmsOrderItemStateHistoryTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * $query->filterByIdOmsOrderItemStateHistory(array(12, 34)); // WHERE id_oms_order_item_state_history IN (12, 34)
     * $query->filterByIdOmsOrderItemStateHistory(array('min' => 12)); // WHERE id_oms_order_item_state_history > 12
     * </code>
     *
     ...
     * @return $this|ChildSpyOmsOrderItemStateHistoryQuery The current query, for fluid interface
     */
    public function filterByIdOmsOrderItemStateHistory($idOmsOrderItemStateHistory = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_ID_OMS_ORDER_ITEM_STATE_HISTORY, $idOmsOrderItemStateHistory, $comparison);
    }
    ...
    public function filterByFkSalesOrderItem($fkSalesOrderItem = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_FK_SALES_ORDER_ITEM, $fkSalesOrderItem, $comparison);
    }
    ...
    public function filterByFkOmsOrderItemState($fkOmsOrderItemState = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_FK_OMS_ORDER_ITEM_STATE, $fkOmsOrderItemState, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(SpyOmsOrderItemStateHistoryTableMap::COL_UPDATED_AT);
    }
