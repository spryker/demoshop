...
use Propel\Map\SpySalesOrderNoteTableMap;
 ...
 *
 * @method     ChildSpySalesOrderNote findOne(ConnectionInterface $con = null) Return the first ChildSpySalesOrderNote matching the query
 ...
 *
 * @method     ChildSpySalesOrderNote findOneByIdSalesOrderNote(int $id_sales_order_note) Return the first ChildSpySalesOrderNote filtered by the id_sales_order_note column
 * @method     ChildSpySalesOrderNote findOneByFkSalesOrder(int $fk_sales_order) Return the first ChildSpySalesOrderNote filtered by the fk_sales_order column
 * @method     ChildSpySalesOrderNote findOneByMessage(string $message) Return the first ChildSpySalesOrderNote filtered by the message column
 * @method     ChildSpySalesOrderNote findOneByCommand(string $command) Return the first ChildSpySalesOrderNote filtered by the command column
 * @method     ChildSpySalesOrderNote findOneBySuccess(boolean $success) Return the first ChildSpySalesOrderNote filtered by the success column
 * @method     ChildSpySalesOrderNote findOneByCreatedAt(string $created_at) Return the first ChildSpySalesOrderNote filtered by the created_at column
 * @method     ChildSpySalesOrderNote findOneByUpdatedAt(string $updated_at) Return the first ChildSpySalesOrderNote filtered by the updated_at column *
...
abstract class SpySalesOrderNoteQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpySalesOrderNoteQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpySalesOrderNote', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpySalesOrderNoteTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id_sales_order_note, fk_sales_order, message, command, success, created_at, updated_at FROM spy_sales_order_note WHERE id_sales_order_note = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpySalesOrderNoteTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByIdSalesOrderNote($idSalesOrderNote = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_ID_SALES_ORDER_NOTE, $idSalesOrderNote, $comparison);
    }
    ...
    public function filterByFkSalesOrder($fkSalesOrder = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_FK_SALES_ORDER, $fkSalesOrder, $comparison);
    }
    ...
    public function filterByMessage($message = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_MESSAGE, $message, $comparison);
    }
    ...
    public function filterByCommand($command = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_COMMAND, $command, $comparison);
    }
    ...
    public function filterBySuccess($success = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_SUCCESS, $success, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpySalesOrderNoteTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
