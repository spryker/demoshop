...
use Propel\Map\SpyProductOptionValuePriceTableMap;
...
*/
abstract class SpyProductOptionValuePrice extends SpyProductOptionValuePrice implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyProductOptionValuePriceTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyProductOptionValuePrice object.
     */
     ...
     * @return $this|\Propel\SpyProductOptionValuePrice The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyProductOptionValuePrice'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyProductOptionValuePrice
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyProductOptionValuePrice The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyProductOptionValuePrice (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyProductOptionValuePrice Clone of current object.
     * @throws PropelException
     */
