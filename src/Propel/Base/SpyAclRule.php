...
*/
abstract class SpyAclRule extends SpyAclRule implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyAclRuleTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyAclRule object.
     */
     ...
     *
     * @return $this|SpyAclRule The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyAclRule The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyAclRule'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyAclRule The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyAclRule (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyAclRule Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aAclRole === null && ($this->fk_acl_role !== null)) {
