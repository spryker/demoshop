...
*/
abstract class SpyProductOptionConfigurationPreset extends SpyProductOptionConfigurationPreset implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyProductOptionConfigurationPresetTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyProductOptionConfigurationPreset object.
     */
     ...
     * @return $this|\Propel\SpyProductOptionConfigurationPreset The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyProductOptionConfigurationPreset'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        try {
            $pk = $con->lastInsertId('spy_product_option_configuration_preset_pk_seq');
        } catch (Exception $e) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyProductOptionConfigurationPreset
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyProductOptionConfigurationPreset The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyProductOptionConfigurationPreset (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyProductOptionConfigurationPreset Clone of current object.
     * @throws PropelException
     */
