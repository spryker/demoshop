...
*/
abstract class SpySalesOrderItemOption extends SpySalesOrderItemOption implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpySalesOrderItemOptionTableMap';
    ...
    /**
     * The value for the label_option_type field.
     * @var        string
     */
    protected $label_option_type;

    /**
     * The value for the label_option_value field.
     * @var        string
     */
    protected $label_option_value;
    ...
    /**
     * Initializes internal state of Propel\Base\SpySalesOrderItemOption object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|SpySalesOrderItemOption The current object, for fluid interface
     */
    ...
    /**
     * Get the [label_option_type] column value.
     *
     * @return string
     */
    public function getLabelOptionType()
    {
        return $this->label_option_type;
    }

    /**
     * Get the [label_option_value] column value.
     *
     * @return string
     */
    public function getLabelOptionValue()
    {
        return $this->label_option_value;
    }
     ...
     * @return $this|\Propel\SpySalesOrderItemOption The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [label_option_type] column.
     *
     * @param string $v new value
     * @return $this|\Propel\SpySalesOrderItemOption The current object (for fluent API support)
     */
    public function setLabelOptionType($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->label_option_type !== $v) {
            $this->label_option_type = $v;
            $this->modifiedColumns[SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_TYPE] = true;
        }
    ...
    /**
     * Set the value of [label_option_value] column.
     *
     * @param string $v new value
     * @return $this|\Propel\SpySalesOrderItemOption The current object (for fluent API support)
     */
    public function setLabelOptionValue($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->label_option_value !== $v) {
            $this->label_option_value = $v;
            $this->modifiedColumns[SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_VALUE] = true;
        }
    ...
    public function setPriceToPay($v)
    {
        ...
        if ($this->price_to_pay !== $v) {
            $this->price_to_pay = $v;
            $this->modifiedColumns[SpySalesOrderItemOptionTableMap::COL_PRICE_TO_PAY] = true;
        }
    ...
    public function setTaxPercentage($v)
    {
        ...
        if ($this->tax_percentage !== $v) {
            ...
            $this->modifiedColumns[SpySalesOrderItemOptionTableMap::COL_TAX_PERCENTAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('LabelOptionType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label_option_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('LabelOptionValue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label_option_value = (null !== $col) ? (string) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('PriceToPay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price_to_pay = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('TaxPercentage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax_percentage = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SpySalesOrderItemOptionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = SpySalesOrderItemOptionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpySalesOrderItemOption'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'label_option_type';
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'label_option_value';
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_GROSS_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'gross_price';
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_PRICE_TO_PAY)) {
            $modifiedColumns[':p' . $index++]  = 'price_to_pay';
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_TAX_PERCENTAGE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'fk_sales_order_item':
                        ...
                        break;
                    case 'label_option_type':
                        $stmt->bindValue($identifier, $this->label_option_type, PDO::PARAM_STR);
                        break;
                    case 'label_option_value':
                        $stmt->bindValue($identifier, $this->label_option_value, PDO::PARAM_STR);
                        break;
                    case 'gross_price':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getLabelOptionType();
                break;
            case 3:
                return $this->getLabelOptionValue();
                break;
            case 4:
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getLabelOptionType(),
            $keys[3] => $this->getLabelOptionValue(),
            $keys[4] => $this->getGrossPrice(),
            $keys[5] => $this->getPriceToPay(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpySalesOrderItemOption
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setLabelOptionType($value);
                break;
            case 3:
                $this->setLabelOptionValue($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLabelOptionType($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setLabelOptionValue($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setGrossPrice($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPriceToPay($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setTaxPercentage($arr[$keys[6]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpySalesOrderItemOption The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_TYPE)) {
            $criteria->add(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_TYPE, $this->label_option_type);
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_VALUE)) {
            $criteria->add(SpySalesOrderItemOptionTableMap::COL_LABEL_OPTION_VALUE, $this->label_option_value);
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_GROSS_PRICE)) {
            $criteria->add(SpySalesOrderItemOptionTableMap::COL_GROSS_PRICE, $this->gross_price);
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_PRICE_TO_PAY)) {
            $criteria->add(SpySalesOrderItemOptionTableMap::COL_PRICE_TO_PAY, $this->price_to_pay);
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_TAX_PERCENTAGE)) {
            $criteria->add(SpySalesOrderItemOptionTableMap::COL_TAX_PERCENTAGE, $this->tax_percentage);
        }
        if ($this->isColumnModified(SpySalesOrderItemOptionTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpySalesOrderItemOption (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLabelOptionType($this->getLabelOptionType());
        $copyObj->setLabelOptionValue($this->getLabelOptionValue());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpySalesOrderItemOption Clone of current object.
     * @throws PropelException
     */
    ...
    public function clear()
    {
        ...
        $this->label_option_type = null;
        $this->label_option_value = null;
