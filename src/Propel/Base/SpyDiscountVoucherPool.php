...
*/
abstract class SpyDiscountVoucherPool extends SpyDiscountVoucherPool implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyDiscountVoucherPoolTableMap';
    ...
    /**
     * The value for the fk_discount_voucher_pool_category field.
     * @var        int
     */
    protected $fk_discount_voucher_pool_category;
    ...
    /**
     * @var        ChildSpyDiscountVoucherPoolCategory
     */
    protected $aVoucherPoolCategory;
    ...
    /**
     * Initializes internal state of Propel\Base\SpyDiscountVoucherPool object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|SpyDiscountVoucherPool The current object, for fluid interface
     */
    ...
    /**
     * Get the [fk_discount_voucher_pool_category] column value.
     *
     * @return int
     */
    public function getFkDiscountVoucherPoolCategory()
    {
        return $this->fk_discount_voucher_pool_category;
    }
     ...
     * @return $this|\Propel\SpyDiscountVoucherPool The current object (for fluent API support)
     */
    public function setIdDiscountVoucherPool($v)
    {
        ...
        if ($this->id_discount_voucher_pool !== $v) {
    ...
    /**
     * Set the value of [fk_discount_voucher_pool_category] column.
     *
     * @param int $v new value
     * @return $this|\Propel\SpyDiscountVoucherPool The current object (for fluent API support)
     */
    public function setFkDiscountVoucherPoolCategory($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->fk_discount_voucher_pool_category !== $v) {
            $this->fk_discount_voucher_pool_category = $v;
            $this->modifiedColumns[SpyDiscountVoucherPoolTableMap::COL_FK_DISCOUNT_VOUCHER_POOL_CATEGORY] = true;
        }

        if ($this->aVoucherPoolCategory !== null && $this->aVoucherPoolCategory->getIdDiscountVoucherPoolCategory() !== $v) {
            $this->aVoucherPoolCategory = null;
        }

        return $this;
    } // setFkDiscountVoucherPoolCategory()
    ...
    public function setTemplate($v)
    {
        ...
        if ($this->template !== $v) {
            $this->template = $v;
            $this->modifiedColumns[SpyDiscountVoucherPoolTableMap::COL_TEMPLATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyDiscountVoucherPoolTableMap::translateFieldName('FkDiscountVoucherPoolCategory', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_discount_voucher_pool_category = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SpyDiscountVoucherPoolTableMap::translateFieldName('Template', TableMap::TYPE_PHPNAME, $indexType)];
            $this->template = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SpyDiscountVoucherPoolTableMap::translateFieldName('IsActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SpyDiscountVoucherPoolTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SpyDiscountVoucherPoolTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = SpyDiscountVoucherPoolTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyDiscountVoucherPool'), 0, $e);
        }
    }
    ...
    {
        if ($this->aVoucherPoolCategory !== null && $this->fk_discount_voucher_pool_category !== $this->aVoucherPoolCategory->getIdDiscountVoucherPoolCategory()) {
            $this->aVoucherPoolCategory = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aVoucherPoolCategory !== null) {
                if ($this->aVoucherPoolCategory->isModified() || $this->aVoucherPoolCategory->isNew()) {
                    $affectedRows += $this->aVoucherPoolCategory->save($con);
                }
                $this->setVoucherPoolCategory($this->aVoucherPoolCategory);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_FK_DISCOUNT_VOUCHER_POOL_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = 'fk_discount_voucher_pool_category';
        }
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_TEMPLATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_discount_voucher_pool':
                        ...
                        break;
                    case 'fk_discount_voucher_pool_category':
                        $stmt->bindValue($identifier, $this->fk_discount_voucher_pool_category, PDO::PARAM_INT);
                        break;
                    case 'name':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getFkDiscountVoucherPoolCategory();
                break;
            case 2:
                return $this->getName();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getFkDiscountVoucherPoolCategory(),
            $keys[2] => $this->getName(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aVoucherPoolCategory) {

                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'spyDiscountVoucherPoolCategory';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'spy_discount_voucher_pool_category';
                        break;
                    default:
                        $key = 'SpyDiscountVoucherPoolCategory';
                }

                $result[$key] = $this->aVoucherPoolCategory->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyDiscountVoucherPool
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setFkDiscountVoucherPoolCategory($value);
                break;
            case 2:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFkDiscountVoucherPoolCategory($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setTemplate($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyDiscountVoucherPool The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_FK_DISCOUNT_VOUCHER_POOL_CATEGORY)) {
            $criteria->add(SpyDiscountVoucherPoolTableMap::COL_FK_DISCOUNT_VOUCHER_POOL_CATEGORY, $this->fk_discount_voucher_pool_category);
        }
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_NAME)) {
            $criteria->add(SpyDiscountVoucherPoolTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_TEMPLATE)) {
            $criteria->add(SpyDiscountVoucherPoolTableMap::COL_TEMPLATE, $this->template);
        }
        if ($this->isColumnModified(SpyDiscountVoucherPoolTableMap::COL_IS_ACTIVE)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyDiscountVoucherPool (or compatible) type.
    ...
    {
        $copyObj->setFkDiscountVoucherPoolCategory($this->getFkDiscountVoucherPoolCategory());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyDiscountVoucherPool Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildSpyDiscountVoucherPoolCategory object.
     *
     * @param  ChildSpyDiscountVoucherPoolCategory $v
     * @return $this|\Propel\SpyDiscountVoucherPool The current object (for fluent API support)
     * @throws PropelException
     */
    public function setVoucherPoolCategory(ChildSpyDiscountVoucherPoolCategory $v = null)
    {
        if ($v === null) {
            $this->setFkDiscountVoucherPoolCategory(NULL);
        } else {
            $this->setFkDiscountVoucherPoolCategory($v->getIdDiscountVoucherPoolCategory());
        }

        $this->aVoucherPoolCategory = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildSpyDiscountVoucherPoolCategory object, it will not be re-added.
        if ($v !== null) {
            $v->addDiscountVoucherPool($this);
        }
    ...
    /**
     * Get the associated ChildSpyDiscountVoucherPoolCategory object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildSpyDiscountVoucherPoolCategory The associated ChildSpyDiscountVoucherPoolCategory object.
     * @throws PropelException
     */
    public function getVoucherPoolCategory(ConnectionInterface $con = null)
    {
        if ($this->aVoucherPoolCategory === null && ($this->fk_discount_voucher_pool_category !== null)) {
            $this->aVoucherPoolCategory = ChildSpyDiscountVoucherPoolCategoryQuery::create()->findPk($this->fk_discount_voucher_pool_category, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVoucherPoolCategory->addDiscountVoucherPools($this);
             */
        }

        return $this->aVoucherPoolCategory;
    }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('DiscountVoucher' == $relationName) {
            return $this->initDiscountVouchers();
        }
    }
    ...
    public function initDiscounts($overrideExisting = true)
    {
        ...
        $this->collDiscounts->setModel('\Propel\SpyDiscount');
    }
    ...
    public function initDiscountVouchers($overrideExisting = true)
    {
        ...
        $this->collDiscountVouchers = new ObjectCollection();
        $this->collDiscountVouchers->setModel('\Propel\SpyDiscountVoucher');
    }
    ...
    {
        if (null !== $this->aVoucherPoolCategory) {
            $this->aVoucherPoolCategory->removeDiscountVoucherPool($this);
        }
        $this->id_discount_voucher_pool = null;
        $this->fk_discount_voucher_pool_category = null;
        $this->name = null;
        $this->template = null;
        $this->is_active = null;
