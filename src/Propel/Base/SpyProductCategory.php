...
*/
abstract class SpyProductCategory extends SpyProductCategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyProductCategoryTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyProductCategory object.
     */
     ...
     *
     * @return $this|SpyProductCategory The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyProductCategory The current object (for fluent API support)
     */
    ...
    public function setFkAbstractProduct($v)
    {
        ...
        if ($this->fk_abstract_product !== $v) {
            ...
            $this->modifiedColumns[SpyProductCategoryTableMap::COL_FK_ABSTRACT_PRODUCT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyProductCategoryTableMap::translateFieldName('FkAbstractProduct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_abstract_product = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyProductCategoryTableMap::translateFieldName('FkCategory', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SpyProductCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyProductCategory'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SpyProductCategoryTableMap::COL_FK_ABSTRACT_PRODUCT)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyProductCategory
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyProductCategory The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpyProductCategoryTableMap::COL_FK_ABSTRACT_PRODUCT)) {
            $criteria->add(SpyProductCategoryTableMap::COL_FK_ABSTRACT_PRODUCT, $this->fk_abstract_product);
        }
        if ($this->isColumnModified(SpyProductCategoryTableMap::COL_FK_CATEGORY)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyProductCategory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyProductCategory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aSpyCategory === null && ($this->fk_category !== null)) {
    ...
    public function getSpyAbstractProduct(ConnectionInterface $con = null)
    {
        if ($this->aSpyAbstractProduct === null && ($this->fk_abstract_product !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSpyAbstractProduct->addSpyProductCategories($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aSpyAbstractProduct) {
            $this->aSpyAbstractProduct->removeSpyProductCategory($this);
        }
