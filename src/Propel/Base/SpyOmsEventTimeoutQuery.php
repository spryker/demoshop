 ...
 *
 * @method     ChildSpyOmsEventTimeout findOne(ConnectionInterface $con = null) Return the first ChildSpyOmsEventTimeout matching the query
 ...
 *
 * @method     ChildSpyOmsEventTimeout findOneByIdOmsEventTimeout(int $id_oms_event_timeout) Return the first ChildSpyOmsEventTimeout filtered by the id_oms_event_timeout column
 * @method     ChildSpyOmsEventTimeout findOneByFkSalesOrderItem(int $fk_sales_order_item) Return the first ChildSpyOmsEventTimeout filtered by the fk_sales_order_item column
 * @method     ChildSpyOmsEventTimeout findOneByFkOmsOrderItemState(int $fk_oms_order_item_state) Return the first ChildSpyOmsEventTimeout filtered by the fk_oms_order_item_state column
 * @method     ChildSpyOmsEventTimeout findOneByTimeout(string $timeout) Return the first ChildSpyOmsEventTimeout filtered by the timeout column
 * @method     ChildSpyOmsEventTimeout findOneByEvent(string $event) Return the first ChildSpyOmsEventTimeout filtered by the event column
 * @method     ChildSpyOmsEventTimeout findOneByCreatedAt(string $created_at) Return the first ChildSpyOmsEventTimeout filtered by the created_at column
 * @method     ChildSpyOmsEventTimeout findOneByUpdatedAt(string $updated_at) Return the first ChildSpyOmsEventTimeout filtered by the updated_at column *
...
abstract class SpyOmsEventTimeoutQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Base\SpyOmsEventTimeoutQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = '\\Propel\\SpyOmsEventTimeout', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = SpyOmsEventTimeoutTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id_oms_event_timeout, fk_sales_order_item, fk_oms_order_item_state, timeout, event, created_at, updated_at FROM spy_oms_event_timeout WHERE id_oms_event_timeout = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SpyOmsEventTimeoutTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByIdOmsEventTimeout($idOmsEventTimeout = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_ID_OMS_EVENT_TIMEOUT, $idOmsEventTimeout, $comparison);
    }
    ...
    public function filterByFkSalesOrderItem($fkSalesOrderItem = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_FK_SALES_ORDER_ITEM, $fkSalesOrderItem, $comparison);
    }
    ...
    public function filterByFkOmsOrderItemState($fkOmsOrderItemState = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_FK_OMS_ORDER_ITEM_STATE, $fkOmsOrderItemState, $comparison);
    }
    ...
    public function filterByTimeout($timeout = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_TIMEOUT, $timeout, $comparison);
    }
    ...
    public function filterByEvent($event = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_EVENT, $event, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SpyOmsEventTimeoutTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
