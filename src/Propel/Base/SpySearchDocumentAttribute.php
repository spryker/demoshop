...
*/
abstract class SpySearchDocumentAttribute extends SpySearchDocumentAttribute implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpySearchDocumentAttributeTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpySearchDocumentAttribute object.
     */
     ...
     * @return $this|\Propel\SpySearchDocumentAttribute The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpySearchDocumentAttribute'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpySearchDocumentAttribute
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpySearchDocumentAttribute The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpySearchDocumentAttribute (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpySearchDocumentAttribute Clone of current object.
     * @throws PropelException
     */
