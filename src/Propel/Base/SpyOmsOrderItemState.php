...
*/
abstract class SpyOmsOrderItemState extends SpyOmsOrderItemState implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyOmsOrderItemStateTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyOmsOrderItemState object.
     */
     ...
     *
     * @return $this|SpyOmsOrderItemState The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyOmsOrderItemState The current object (for fluent API support)
     */
    public function setIdOmsOrderItemState($v)
    {
        ...
        if ($this->id_oms_order_item_state !== $v) {
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SpyOmsOrderItemStateTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SpyOmsOrderItemStateTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyOmsOrderItemState'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyOmsOrderItemState
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyOmsOrderItemState The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyOmsOrderItemState (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyOmsOrderItemState Clone of current object.
     * @throws PropelException
     */
    ...
    public function initOrders($overrideExisting = true)
    {
        ...
        $this->collOrders->setModel('\Propel\SpySalesOrderItem');
    }
    ...
    public function getOrders(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collOrders || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrders) {
                ...
                $collOrders = ChildSpySalesOrderItemQuery::create(null, $criteria)
                    ->filterByState($this)
                    ->find($con);
    ...
    {
        /** @var ChildSpySalesOrderItem[] $ordersToDelete */
     ...
     * @return $this|\Propel\SpyOmsOrderItemState The current object (for fluent API support)
     */
    public function addOrder(ChildSpySalesOrderItem $l)
    {
        if ($this->collOrders === null) {
            $this->initOrders();
            $this->collOrdersPartial = true;
    ...
    /**
     * @param ChildSpySalesOrderItem $order The ChildSpySalesOrderItem object to add.
     */
    protected function doAddOrder(ChildSpySalesOrderItem $order)
    {
    ...
    /**
     * @param  ChildSpySalesOrderItem $order The ChildSpySalesOrderItem object to remove.
     * @return $this|ChildSpyOmsOrderItemState The current object (for fluent API support)
     */
    public function removeOrder(ChildSpySalesOrderItem $order)
    {
     ...
     * @return ObjectCollection|ChildSpySalesOrderItem[] List of ChildSpySalesOrderItem objects
     */
    public function getOrdersJoinSpyRefund(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSpySalesOrderItemQuery::create(null, $criteria);
