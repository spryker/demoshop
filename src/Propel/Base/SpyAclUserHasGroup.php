...
*/
abstract class SpyAclUserHasGroup extends SpyAclUserHasGroup implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Map\\SpyAclUserHasGroupTableMap';
    ...
    /**
     * Initializes internal state of Propel\Base\SpyAclUserHasGroup object.
     */
     ...
     *
     * @return $this|SpyAclUserHasGroup The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\SpyAclUserHasGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\SpyAclUserHasGroup'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_FIELDNAME.
     * @return $this|\Propel\SpyAclUserHasGroup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\SpyAclUserHasGroup The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation spy_acl_user_has_group_fk_f93f9c to table spy_user
        ...
        //relation spy_acl_user_has_group_fk_537946 to table spy_acl_group
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\SpyAclUserHasGroup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\SpyAclUserHasGroup Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildSpyUser object.
     *
     * @param  ChildSpyUser $v
     * @return $this|\Propel\SpyAclUserHasGroup The current object (for fluent API support)
     * @throws PropelException
     */
    public function setSpyUser(ChildSpyUser $v = null)
    {
        if ($v === null) {
            $this->setFkUser(NULL);
        } else {
        ...
        // If this object has already been added to the ChildSpyUser object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ChildSpyUser object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildSpyUser The associated ChildSpyUser object.
     * @throws PropelException
     */
    public function getSpyUser(ConnectionInterface $con = null)
    {
        if ($this->aSpyUser === null && ($this->fk_user !== null)) {
            $this->aSpyUser = ChildSpyUserQuery::create()->findPk($this->fk_user, $con);
    ...
    {
        if ($this->aSpyAclGroup === null && ($this->fk_acl_group !== null)) {
