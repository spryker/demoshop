...
use Propel\SpyCmsGlossaryKeyMapping;
use Propel\SpyCmsGlossaryKeyMappingQuery;
...
class SpyCmsGlossaryKeyMappingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyCmsGlossaryKeyMappingTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyCmsGlossaryKeyMapping';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyCmsGlossaryKeyMapping';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsGlossaryKeyMapping', 'FkPage', 'FkGlossaryKey', 'Placeholder', ),
        self::TYPE_CAMELNAME     => array('idCmsGlossaryKeyMapping', 'fkPage', 'fkGlossaryKey', 'placeholder', ),
        self::TYPE_COLNAME       => array(SpyCmsGlossaryKeyMappingTableMap::COL_ID_CMS_GLOSSARY_KEY_MAPPING, SpyCmsGlossaryKeyMappingTableMap::COL_FK_PAGE, SpyCmsGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY, SpyCmsGlossaryKeyMappingTableMap::COL_PLACEHOLDER, ),
        self::TYPE_FIELDNAME     => array('id_cms_glossary_key_mapping', 'fk_page', 'fk_glossary_key', 'placeholder', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsGlossaryKeyMapping' => 0, 'FkPage' => 1, 'FkGlossaryKey' => 2, 'Placeholder' => 3, ),
        self::TYPE_CAMELNAME     => array('idCmsGlossaryKeyMapping' => 0, 'fkPage' => 1, 'fkGlossaryKey' => 2, 'placeholder' => 3, ),
        self::TYPE_COLNAME       => array(SpyCmsGlossaryKeyMappingTableMap::COL_ID_CMS_GLOSSARY_KEY_MAPPING => 0, SpyCmsGlossaryKeyMappingTableMap::COL_FK_PAGE => 1, SpyCmsGlossaryKeyMappingTableMap::COL_FK_GLOSSARY_KEY => 2, SpyCmsGlossaryKeyMappingTableMap::COL_PLACEHOLDER => 3, ),
        self::TYPE_FIELDNAME     => array('id_cms_glossary_key_mapping' => 0, 'fk_page' => 1, 'fk_glossary_key' => 2, 'placeholder' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyCmsGlossaryKeyMapping');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCmsGlossaryKeyMapping', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyCmsGlossaryKeyMappingTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyCmsGlossaryKeyMappingTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyCmsGlossaryKeyMappingTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyCmsGlossaryKeyMapping) { // it's a model object
...
//
SpyCmsGlossaryKeyMappingTableMap::buildTableMap();
