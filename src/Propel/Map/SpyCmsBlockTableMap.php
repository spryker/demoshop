...
use Propel\SpyCmsBlock;
use Propel\SpyCmsBlockQuery;
...
class SpyCmsBlockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyCmsBlockTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyCmsBlock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyCmsBlock';
     ...
     */
    const COL_FK_PAGE = 'spy_cms_block.fk_page';
     ...
     */
    const COL_TYPE = 'spy_cms_block.type';

    /**
     * the column name for the value field
     */
    const COL_VALUE = 'spy_cms_block.value';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdCmsBlock', 'FkPage', 'Name', 'Type', 'Value', ),
        self::TYPE_CAMELNAME     => array('idCmsBlock', 'fkPage', 'name', 'type', 'value', ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTableMap::COL_ID_CMS_BLOCK, SpyCmsBlockTableMap::COL_FK_PAGE, SpyCmsBlockTableMap::COL_NAME, SpyCmsBlockTableMap::COL_TYPE, SpyCmsBlockTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id_cms_block', 'fk_page', 'name', 'type', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdCmsBlock' => 0, 'FkPage' => 1, 'Name' => 2, 'Type' => 3, 'Value' => 4, ),
        self::TYPE_CAMELNAME     => array('idCmsBlock' => 0, 'fkPage' => 1, 'name' => 2, 'type' => 3, 'value' => 4, ),
        self::TYPE_COLNAME       => array(SpyCmsBlockTableMap::COL_ID_CMS_BLOCK => 0, SpyCmsBlockTableMap::COL_FK_PAGE => 1, SpyCmsBlockTableMap::COL_NAME => 2, SpyCmsBlockTableMap::COL_TYPE => 3, SpyCmsBlockTableMap::COL_VALUE => 4, ),
        self::TYPE_FIELDNAME     => array('id_cms_block' => 0, 'fk_page' => 1, 'name' => 2, 'type' => 3, 'value' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyCmsBlock');
    ...
    {
        $this->addRelation('SpyCmsPage', '\\Propel\\SpyCmsPage', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_page',
    1 => ':id_cms_page',
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCmsBlock', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyCmsBlockTableMap::COL_FK_PAGE);
            $criteria->addSelectColumn(SpyCmsBlockTableMap::COL_NAME);
            $criteria->addSelectColumn(SpyCmsBlockTableMap::COL_TYPE);
            $criteria->addSelectColumn(SpyCmsBlockTableMap::COL_VALUE);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyCmsBlockTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyCmsBlockTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyCmsBlockTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyCmsBlock) { // it's a model object
...
//
SpyCmsBlockTableMap::buildTableMap();
