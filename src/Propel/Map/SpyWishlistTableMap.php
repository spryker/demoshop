...
use Propel\SpyWishlist;
use Propel\SpyWishlistQuery;
...
class SpyWishlistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyWishlistTableMap';
     ...
     */
    const TABLE_NAME = 'spy_wishlist';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\SpyWishlist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyWishlist';
     ...
     */
    const COL_ID_WISHLIST = 'spy_wishlist.id_wishlist';

    /**
     * the column name for the fk_customer field
     */
    const COL_FK_CUSTOMER = 'spy_wishlist.fk_customer';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdWishlist', 'FkCustomer', ),
        self::TYPE_CAMELNAME     => array('idWishlist', 'fkCustomer', ),
        self::TYPE_COLNAME       => array(SpyWishlistTableMap::COL_ID_WISHLIST, SpyWishlistTableMap::COL_FK_CUSTOMER, ),
        self::TYPE_FIELDNAME     => array('id_wishlist', 'fk_customer', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdWishlist' => 0, 'FkCustomer' => 1, ),
        self::TYPE_CAMELNAME     => array('idWishlist' => 0, 'fkCustomer' => 1, ),
        self::TYPE_COLNAME       => array(SpyWishlistTableMap::COL_ID_WISHLIST => 0, SpyWishlistTableMap::COL_FK_CUSTOMER => 1, ),
        self::TYPE_FIELDNAME     => array('id_wishlist' => 0, 'fk_customer' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyWishlist');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdWishlist', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyWishlistTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyWishlistTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyWishlistTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyWishlist) { // it's a model object
...
//
SpyWishlistTableMap::buildTableMap();
