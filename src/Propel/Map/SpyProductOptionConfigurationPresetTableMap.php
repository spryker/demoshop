...
use Propel\SpyProductOptionConfigurationPreset;
use Propel\SpyProductOptionConfigurationPresetQuery;
...
class SpyProductOptionConfigurationPresetTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyProductOptionConfigurationPresetTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyProductOptionConfigurationPreset';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyProductOptionConfigurationPreset';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyProductOptionConfigurationPreset');
        $this->setPackage('src.Propel');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('spy_product_option_configuration_preset_pk_seq');
        // columns
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyProductOptionConfigurationPreset) { // it's a model object
