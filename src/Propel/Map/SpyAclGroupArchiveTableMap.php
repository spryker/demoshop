...
use Propel\SpyAclGroupArchive;
use Propel\SpyAclGroupArchiveQuery;
...
class SpyAclGroupArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyAclGroupArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyAclGroupArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyAclGroupArchive';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyAclGroupArchive');
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyAclGroupArchiveTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyAclGroupArchiveTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyAclGroupArchiveTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyAclGroupArchive) { // it's a model object
...
//
SpyAclGroupArchiveTableMap::buildTableMap();
