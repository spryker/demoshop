...
use Propel\SpyPriceType;
use Propel\SpyPriceTypeQuery;
...
class SpyPriceTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyPriceTypeTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyPriceType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyPriceType';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceType', 'Name', ),
        self::TYPE_CAMELNAME     => array('idPriceType', 'name', ),
        self::TYPE_COLNAME       => array(SpyPriceTypeTableMap::COL_ID_PRICE_TYPE, SpyPriceTypeTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_price_type', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceType' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('idPriceType' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(SpyPriceTypeTableMap::COL_ID_PRICE_TYPE => 0, SpyPriceTypeTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id_price_type' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyPriceType');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdPriceType', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyPriceTypeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyPriceTypeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyPriceTypeTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyPriceType) { // it's a model object
...
//
SpyPriceTypeTableMap::buildTableMap();
