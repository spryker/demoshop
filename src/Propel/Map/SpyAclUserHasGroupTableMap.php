...
use Propel\SpyAclUserHasGroup;
use Propel\SpyAclUserHasGroupQuery;
...
class SpyAclUserHasGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyAclUserHasGroupTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyAclUserHasGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyAclUserHasGroup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyAclUserHasGroup');
    ...
    {
        $this->addRelation('SpyUser', '\\Propel\\SpyUser', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_user',
    1 => ':id_user',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Propel\SpyAclUserHasGroup $obj A \Propel\SpyAclUserHasGroup object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getFkUser(), (string) $obj->getFkAclGroup()));
            } // if key === null
     ...
     *
     * @param mixed $value A \Propel\SpyAclUserHasGroup object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Propel\SpyAclUserHasGroup) {
                $key = serialize(array((string) $value->getFkUser(), (string) $value->getFkAclGroup()));
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Propel\SpyAclUserHasGroup object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('FkUser', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('FkAclGroup', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyAclUserHasGroupTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyAclUserHasGroupTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyAclUserHasGroupTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyAclUserHasGroup) { // it's a model object
...
//
SpyAclUserHasGroupTableMap::buildTableMap();
