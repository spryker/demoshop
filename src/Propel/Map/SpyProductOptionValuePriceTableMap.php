...
use Propel\SpyProductOptionValuePrice;
use Propel\SpyProductOptionValuePriceQuery;
...
class SpyProductOptionValuePriceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyProductOptionValuePriceTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyProductOptionValuePrice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyProductOptionValuePrice';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyProductOptionValuePrice');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyProductOptionValuePrice) { // it's a model object
