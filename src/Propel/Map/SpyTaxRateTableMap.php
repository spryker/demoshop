...
use Propel\SpyTaxRate;
use Propel\SpyTaxRateQuery;
...
class SpyTaxRateTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyTaxRateTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyTaxRate';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyTaxRate';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdTaxRate', 'Name', 'Rate', ),
        self::TYPE_CAMELNAME     => array('idTaxRate', 'name', 'rate', ),
        self::TYPE_COLNAME       => array(SpyTaxRateTableMap::COL_ID_TAX_RATE, SpyTaxRateTableMap::COL_NAME, SpyTaxRateTableMap::COL_RATE, ),
        self::TYPE_FIELDNAME     => array('id_tax_rate', 'name', 'rate', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdTaxRate' => 0, 'Name' => 1, 'Rate' => 2, ),
        self::TYPE_CAMELNAME     => array('idTaxRate' => 0, 'name' => 1, 'rate' => 2, ),
        self::TYPE_COLNAME       => array(SpyTaxRateTableMap::COL_ID_TAX_RATE => 0, SpyTaxRateTableMap::COL_NAME => 1, SpyTaxRateTableMap::COL_RATE => 2, ),
        self::TYPE_FIELDNAME     => array('id_tax_rate' => 0, 'name' => 1, 'rate' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyTaxRate');
        ...
        $this->addColumn('rate', 'Rate', 'DECIMAL', true, 8, 0);
    } // initialize()
  ...
  array (
    ...
    1 => ':id_tax_rate',
        ...
        $this->addRelation('SpyTaxSet', '\\Propel\\SpyTaxSet', RelationMap::MANY_TO_MANY, array(), 'CASCADE', null, 'SpyTaxSets');
    } // buildRelations()
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdTaxRate', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyTaxRateTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyTaxRateTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyTaxRateTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyTaxRate) { // it's a model object
...
//
SpyTaxRateTableMap::buildTableMap();
