...
use Propel\SpyPriceProduct;
use Propel\SpyPriceProductQuery;
...
class SpyPriceProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyPriceProductTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyPriceProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyPriceProduct';
     ...
     */
    const COL_FK_ABSTRACT_PRODUCT = 'spy_price_product.fk_abstract_product';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdPriceProduct', 'Price', 'FkProduct', 'FkPriceType', 'FkAbstractProduct', ),
        self::TYPE_CAMELNAME     => array('idPriceProduct', 'price', 'fkProduct', 'fkPriceType', 'fkAbstractProduct', ),
        self::TYPE_COLNAME       => array(SpyPriceProductTableMap::COL_ID_PRICE_PRODUCT, SpyPriceProductTableMap::COL_PRICE, SpyPriceProductTableMap::COL_FK_PRODUCT, SpyPriceProductTableMap::COL_FK_PRICE_TYPE, SpyPriceProductTableMap::COL_FK_ABSTRACT_PRODUCT, ),
        self::TYPE_FIELDNAME     => array('id_price_product', 'price', 'fk_product', 'fk_price_type', 'fk_abstract_product', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdPriceProduct' => 0, 'Price' => 1, 'FkProduct' => 2, 'FkPriceType' => 3, 'FkAbstractProduct' => 4, ),
        self::TYPE_CAMELNAME     => array('idPriceProduct' => 0, 'price' => 1, 'fkProduct' => 2, 'fkPriceType' => 3, 'fkAbstractProduct' => 4, ),
        self::TYPE_COLNAME       => array(SpyPriceProductTableMap::COL_ID_PRICE_PRODUCT => 0, SpyPriceProductTableMap::COL_PRICE => 1, SpyPriceProductTableMap::COL_FK_PRODUCT => 2, SpyPriceProductTableMap::COL_FK_PRICE_TYPE => 3, SpyPriceProductTableMap::COL_FK_ABSTRACT_PRODUCT => 4, ),
        self::TYPE_FIELDNAME     => array('id_price_product' => 0, 'price' => 1, 'fk_product' => 2, 'fk_price_type' => 3, 'fk_abstract_product' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyPriceProduct');
        ...
        $this->addForeignKey('fk_abstract_product', 'FkAbstractProduct', 'INTEGER', 'spy_abstract_product', 'id_abstract_product', false, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Product', '\\Propel\\SpyProduct', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_product',
    1 => ':id_product',
        ...
        $this->addRelation('PriceType', '\\Propel\\SpyPriceType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_price_type',
    1 => ':id_price_type',
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdPriceProduct', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SpyPriceProductTableMap::COL_FK_ABSTRACT_PRODUCT);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyPriceProductTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyPriceProductTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyPriceProductTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyPriceProduct) { // it's a model object
...
//
SpyPriceProductTableMap::buildTableMap();
