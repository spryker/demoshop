...
class SpyStockTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyStockTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyStock';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyStock';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('IdStock', 'Name', ),
        self::TYPE_CAMELNAME     => array('idStock', 'name', ),
        self::TYPE_COLNAME       => array(SpyStockTableMap::COL_ID_STOCK, SpyStockTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id_stock', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('IdStock' => 0, 'Name' => 1, ),
        self::TYPE_CAMELNAME     => array('idStock' => 0, 'name' => 1, ),
        self::TYPE_COLNAME       => array(SpyStockTableMap::COL_ID_STOCK => 0, SpyStockTableMap::COL_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id_stock' => 0, 'name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyStock');
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdStock', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyStockTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyStockTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyStockTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyStock) { // it's a model object
...
//
SpyStockTableMap::buildTableMap();
