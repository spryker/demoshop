...
use Propel\SpyAclRoleArchive;
use Propel\SpyAclRoleArchiveQuery;
...
class SpyAclRoleArchiveTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyAclRoleArchiveTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyAclRoleArchive';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyAclRoleArchive';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyAclRoleArchive');
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyAclRoleArchiveTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyAclRoleArchiveTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyAclRoleArchiveTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyAclRoleArchive) { // it's a model object
...
//
SpyAclRoleArchiveTableMap::buildTableMap();
