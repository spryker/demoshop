...
use Propel\SpySequenceNumber;
use Propel\SpySequenceNumberQuery;
...
class SpySequenceNumberTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpySequenceNumberTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpySequenceNumber';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpySequenceNumber';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpySequenceNumber');
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdSequenceNumber', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpySequenceNumberTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpySequenceNumberTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpySequenceNumberTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpySequenceNumber) { // it's a model object
...
//
SpySequenceNumberTableMap::buildTableMap();
