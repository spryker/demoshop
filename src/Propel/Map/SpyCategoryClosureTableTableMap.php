...
use Propel\SpyCategoryClosureTable;
use Propel\SpyCategoryClosureTableQuery;
...
class SpyCategoryClosureTableTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Propel.Map.SpyCategoryClosureTableTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\SpyCategoryClosureTable';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Propel.SpyCategoryClosureTable';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\SpyCategoryClosureTable');
    ...
    {
        $this->addRelation('Node', '\\Propel\\SpyCategoryNode', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':fk_category_node',
    1 => ':id_category_node',
        ...
        $this->addRelation('DescendantNode', '\\Propel\\SpyCategoryNode', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('IdCategoryClosureTable', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(SpyCategoryClosureTableTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(SpyCategoryClosureTableTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new SpyCategoryClosureTableTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\SpyCategoryClosureTable) { // it's a model object
...
//
SpyCategoryClosureTableTableMap::buildTableMap();
