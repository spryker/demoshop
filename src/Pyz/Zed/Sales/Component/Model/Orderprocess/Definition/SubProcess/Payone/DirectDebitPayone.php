        ...
        implements PayoneFacadeInterface, Orderprocess, PayoneStateMachineConstants
{
     ...
     */
    public function __construct($processName = 'Payone Direct Debit Subprocess')
    {
    ...
    protected function addTransitions()
    {
        ...
        $this->setup->addTransition(self::STATE_PAYONE_WAITING_FOR_AUTHORIZATION_APPOINTMENT, self::STATE_PAYONE_WAITING_FOR_AUTHORIZATION_APPOINTMENT, self::EVENT_ON_ENTER);
