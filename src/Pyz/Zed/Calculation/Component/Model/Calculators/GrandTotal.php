...
class Pyz_Zed_Calculation_Component_Model_Calculators_GrandTotal extends ProjectA_Zed_Calculation_Component_Model_Calculators_GrandTotal
{
...
//            /* @var Pyz_Shared_Sales_Transfer_Expense $expense */
