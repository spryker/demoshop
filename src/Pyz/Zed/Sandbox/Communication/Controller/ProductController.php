...
//        $connection = Propel::getConnection();
 //       $connection->beginTransaction();
        ...
        $localeTransfer->setIdLocale(46); //this is required otherwise the locale id is not resolved by name
        ...
        $localizedAttributesTransferEN->setLocale($localeTransfer);
        ...
        */
        ...
        foreach ($variantData as $variantItemData) {
            ...
            $concreteProductTransfer->setLocalizedAttributes([$localizedAttributesTransferDE]);
