...
use \Pyz\Zed\Catalog\Component\Exporter\QueryBuilder\Solr\ProductsWithoutElectronicsConfig;
...
class ProductsWithoutElectronicsConfigExporter extends ProductsExporter
{
    ...
    /**
     * @return \ProjectA\Zed\Catalog\Component\Exporter\QueryBuilder\AbstractProduct|ProductsWithoutElectronicsConfig
     */
    protected function getProductQueryBuilder()
    {
        return $this->factory->createExporterQueryBuilderSolrProductsWithoutElectronicsConfig();
    }
}
