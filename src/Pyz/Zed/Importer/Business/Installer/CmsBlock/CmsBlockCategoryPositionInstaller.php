...
class CmsBlockCategoryPositionInstaller extends AbstractInstaller
{
    ...
    {
        return $this->dataDirectory . 'cms_block_category_position.csv';
    }
    ...
    {
        return 'CMS Blocks Category Position';
    }
