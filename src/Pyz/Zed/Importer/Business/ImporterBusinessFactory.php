...
class ImporterBusinessFactory extends SprykerInstallerBusinessFactory
{
    ...
    protected function getInstallerCollection()
    {
        return [
            ...
            ImporterConfig::RESOURCE_PRODUCT_RELATIONS => $this->createInstallerFactory()->createProductRelationsInstaller(),
            ImporterConfig::RESOURCE_PRODUCT_GROUPS => $this->createInstallerFactory()->createProductGroupInstaller(),
            ImporterConfig::RESOURCE_PRODUCT_SETS => $this->createInstallerFactory()->createProductSetInstaller(),
