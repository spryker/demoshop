...
class ConsoleDependencyProvider extends SprykerConsoleDependencyProvider
{
    ...
    public function getConsoleCommands(Container $container)
    {
        $commands = [
            ...
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_CMS_TEMPLATE),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_CMS_PAGE),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_CMS_BLOCK),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_DISCOUNT),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_DISCOUNT_VOUCHER),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_PRICE_TYPE),
            ...
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_PRODUCT_PRICE),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_PRODUCT_STOCK),
            ...
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_PRODUCT_GROUP),
            new DataImportConsole('data:import:' . DataImportConfig::IMPORT_TYPE_PRODUCT_OPTION),
