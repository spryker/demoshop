...
class ConsoleConfig extends SprykerConsoleConfig
{
    ...
    public function getConsoleCommands()
    {
        $commands = [
            ...
            $this->getLocator()->setup()->consoleDeployCheckMigrationsConsole(),
            $this->getLocator()->setup()->consoleDeployRunMigrationsConsole(),
            $this->getLocator()->setup()->consoleDeployActivateMaintenance(),
            $this->getLocator()->setup()->consoleDeployRunMigrationsConsole(),
