 ...
 */
class ProductAbstractCollectorStoragePlugin extends AbstractCollectorPlugin
{
    /**
    ...
    public function run(
        ...
        $this->getFacade()
            ->runStorageProductAbstractCollector($baseQuery, $locale, $result, $dataReader, $dataWriter, $touchUpdater, $output);
    }
}
