 ...
 */
class NavigationCollectorStoragePlugin extends AbstractPlugin implements CollectorPluginInterface
{
    ...
    public function run(SpyTouchQuery $baseQuery, LocaleTransfer $locale, BatchResultInterface $result, WriterInterface $dataWriter)
    {
        return $this->getDependencyContainer()
            ->getCollectorFacade()
            ->runStorageNavigationCollector($baseQuery, $locale, $result, $dataWriter)
        ;
    }
