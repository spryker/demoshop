 ...
 */
class TranslationCollectorStoragePlugin extends AbstractCollectorPlugin
{
    ...
    public function run(
        ...
        $this->getFactory()
            ->getCollectorFacade()
            ->runStorageTranslationCollector($baseQuery, $locale, $result, $this->dataWriter, $this->touchUpdater, $this->output);
    }
