 ...
 */
class NewCategoryNodeCollectorStoragePlugin extends AbstractCollectorPlugin
{
    ...
    public function run(
        ...
        return $this->getDependencyContainer()
            ->getCollectorFacade()
            ->runStorageNewCategoryNodeCollector($baseQuery, $locale, $result, $dataWriter, $touchUpdater)
        ;
    }
