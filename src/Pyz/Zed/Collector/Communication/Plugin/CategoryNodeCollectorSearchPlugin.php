 ...
 */
class CategoryNodeCollectorSearchPlugin extends AbstractCollectorPlugin
{
    /**
    ...
    public function run(
        ...
        $this->getFacade()
            ->runSearchCategoryNodeCollector($baseQuery, $locale, $result, $dataReader, $dataWriter, $touchUpdater, $output);
    }
}
