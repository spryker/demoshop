 ...
 */
class CmsPageCollectorSearchPlugin extends AbstractCollectorPlugin
{
    ...
    public function run(
        ...
        $this->getFacade()
            ->runSearchCmsPageCollector($baseQuery, $locale, $result, $dataReader, $dataWriter, $touchUpdater, $output);
    }
