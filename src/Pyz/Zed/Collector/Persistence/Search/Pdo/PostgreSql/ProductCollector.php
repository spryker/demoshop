...
';
        $this->criteriaBuilder
            ...
            ->setGroupBy('id_product_abstract, abstract_sku, t.id_touch, t.item_id, spy_touch_search.id_touch_search, spy_stock_product.quantity, spy_stock_product.is_never_out_of_stock')
