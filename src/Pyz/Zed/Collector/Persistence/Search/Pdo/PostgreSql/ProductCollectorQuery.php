...
FROM "spy_touch"
  ...
  LEFT JOIN spy_touch_search ON spy_touch_search.fk_touch = spy_touch.id_touch
  LEFT JOIN spy_product_image_set ON
          (spy_product_image_set.fk_product_abstract = spy_product_abstract.id_product_abstract OR spy_product_image_set.fk_product = spy_product.id_product) AND
