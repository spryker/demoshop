...
FROM "spy_touch"
  ...
  LEFT JOIN spy_price_product abstract_price_table
    ON (spy_product_abstract.id_product_abstract = abstract_price_table.fk_product_abstract)
  ...
  LEFT JOIN spy_tax_set ON (spy_product_abstract.fk_tax_set = spy_tax_set.id_tax_set)
...
GROUP BY abstract_sku, abstract_sku, abstract_sku, spy_product_abstract.id_product_abstract,
  spy_product_abstract.attributes, "spy_product_abstract_localized_attributes"."attributes",
  "spy_product_abstract_localized_attributes"."name", abstract_price_table.price, spy_tax_set.name,
