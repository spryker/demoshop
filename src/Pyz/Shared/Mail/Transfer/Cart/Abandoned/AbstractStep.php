 ...
 * @version $Id$
 */
class Pyz_Shared_Mail_Transfer_Cart_Abandoned_AbstractStep extends Pyz_Shared_Mail_Transfer_Mail
{
    protected $id;
    protected $_id = array('is_int');

    protected $cartItems = 'Pyz_Shared_Mail_Transfer_Item_Collection';
    ...
    /**
     * @return Pyz_Shared_Mail_Transfer_Cart_Abandoned_Item_Collection
     */
    ...
    /**
     * @param Pyz_Shared_Mail_Transfer_Cart_Abandoned_Item_Collection $cartItems
     */
