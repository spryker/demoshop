 ...
 * @version $Id$
 */
class Pyz_Shared_Mail_Transfer_AccountingAwaitingRefund extends Pyz_Shared_Mail_Transfer_Order implements ProjectA_Shared_Mail_Transfer_Interface_Unique
{
