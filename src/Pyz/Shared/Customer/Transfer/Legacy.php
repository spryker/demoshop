...
/**
 * Class Pyz_Shared_Customer_Transfer_Legacy
 *
 * @author Stefan Sorge
 */
class Pyz_Shared_Customer_Transfer_Legacy extends Pyz_Shared_Customer_Transfer_Customer
{
    /**
     * @var string
     */
     ...
     * @param $userId
     *
     * @return Pyz_Shared_Customer_Transfer_Legacy
     */
