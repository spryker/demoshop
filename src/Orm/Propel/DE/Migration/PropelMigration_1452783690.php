 ...
 * up to version 1452783690.
 * Generated on 2016-01-14 15:01:30 by vagrant
 */
class PropelMigration_1452783690
{
    public $comment = '';
...
ALTER TABLE `spy_sales_order`
  ...
  ADD `shipment_delivery_time` INTEGER AFTER `fk_shipment_method`;
