...
ALTER TABLE `spy_price_product` DROP FOREIGN KEY `spy_price_product-fk_abstract_product`;
...
ALTER TABLE `spy_product` DROP FOREIGN KEY `spy_product-fk_abstract_product`;
...
ALTER TABLE `spy_product_category` DROP FOREIGN KEY `spy_product_category-fk_abstract_product`;
...
ALTER TABLE `spy_product_search_attributes_operation` DROP FOREIGN KEY `spy_product_search_attributes_operation-source_attribute_id`;
...
ALTER TABLE `spy_url` DROP FOREIGN KEY `spy_url-fk_resource_abstract_product`;

ALTER TABLE `spy_url` DROP FOREIGN KEY `spy_url-fk_resource_redirect`;
...
ALTER TABLE `spy_wishlist_item` DROP FOREIGN KEY `spy_wishlist_item-fk_abstract_product`;
...
ALTER TABLE `spy_price_product` DROP FOREIGN KEY `spy_price_product-fk_product_abstract`;
...
ALTER TABLE `spy_product` DROP FOREIGN KEY `spy_product-fk_product_abstract`;
...
ALTER TABLE `spy_product_category` DROP FOREIGN KEY `spy_product_category-fk_product_abstract`;
...
ALTER TABLE `spy_url` DROP FOREIGN KEY `spy_url-fk_resource_product_abstract`;
...
ALTER TABLE `spy_wishlist_item` DROP FOREIGN KEY `spy_wishlist_item-fk_product_abstract`;
