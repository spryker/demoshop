 ...
 * up to version 1457015524.
 * Generated on 2016-03-03 14:32:04 by vagrant
 */
class PropelMigration_1457015524
{
    public $comment = '';
...
(
    ...
    INDEX `spy_wishlist_item-fi_product_abstract` (`fk_product_abstract`),
    ...
    CONSTRAINT `spy_wishlist_item-fk_product`
        FOREIGN KEY (`fk_product`)
        REFERENCES `spy_product` (`id_product`),
    CONSTRAINT `spy_wishlist_item-fk_product_abstract`
        FOREIGN KEY (`fk_product_abstract`)
        REFERENCES `spy_product_abstract` (`id_product_abstract`)
) ENGINE=InnoDB;
