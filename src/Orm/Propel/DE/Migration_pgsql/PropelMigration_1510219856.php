 ...
 * up to version 1510219856.
 * Generated on 2017-11-09 09:30:56 by vagrant
 */
class PropelMigration_1510219856
{
    public $comment = '';
...
CREATE SEQUENCE "pyz_quote_pk_seq";

CREATE TABLE "pyz_quote"
(
    "id_quote" INTEGER NOT NULL,
    "quote_transfer" VARCHAR(30000) NOT NULL,
    "fk_customer" INTEGER,
...
(
    "fk_customer_organization_role" INTEGER,
...
CREATE SEQUENCE "spy_customer_organization_role_pk_sequence";

CREATE TABLE "spy_customer_organization_role"
(
    "id_customer_organization_role" INTEGER NOT NULL,
    "role" VARCHAR(255) NOT NULL,
    "default" INTEGER,
    PRIMARY KEY ("id_customer_organization_role")
);
...
ALTER TABLE "pyz_quote" ADD CONSTRAINT "pyz_quote-fk_customer"
...
ALTER TABLE "spy_customer_group_to_customer" ADD CONSTRAINT "spy_customer-fk_customer_organization_role"
    FOREIGN KEY ("fk_customer_organization_role")
    REFERENCES "spy_customer_organization_role" ("id_customer_organization_role");
...
DROP TABLE IF EXISTS "pyz_quote" CASCADE;

DROP SEQUENCE "pyz_quote_pk_seq";
...
DROP TABLE IF EXISTS "spy_customer_organization_role" CASCADE;

DROP SEQUENCE "spy_customer_organization_role_pk_sequence";
