 ...
 */
abstract class Generated_Zed_Sales_Persistence_Propel_Om_BasePacSalesOrderAddress extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer
     */
    ...
    public function getSalutation()
    {
        ...
        $valueSet = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::getValueSet(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::SALUTATION);
     ...
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress The current object (for fluent API support)
     */
    public function setIdSalesOrderAddress($v)
    {
        ...
        if ($this->id_sales_order_address !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS;
        }
    ...
    public function setFkMiscCountry($v)
    {
        ...
        if ($this->fk_misc_country !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_COUNTRY;
        }
    ...
    public function setFkMiscRegion($v)
    {
        ...
        if ($this->fk_misc_region !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_REGION;
        }
    ...
    public function setSalutation($v)
    {
        ...
        if ($this->salutation !== $v) {
            $this->salutation = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::SALUTATION;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FIRST_NAME;
        }
    ...
    public function setMiddleName($v)
    {
        ...
        if ($this->middle_name !== $v) {
            $this->middle_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::MIDDLE_NAME;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::LAST_NAME;
        }
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS1;
        }
    ...
    public function setAddress2($v)
    {
        ...
        if ($this->address2 !== $v) {
            $this->address2 = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS2;
        }
    ...
    public function setAddress3($v)
    {
        ...
        if ($this->address3 !== $v) {
            $this->address3 = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS3;
        }
    ...
    public function setCompany($v)
    {
        ...
        if ($this->company !== $v) {
            $this->company = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMPANY;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CITY;
        }
    ...
    public function setZipCode($v)
    {
        ...
        if ($this->zip_code !== $v) {
            $this->zip_code = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ZIP_CODE;
        }
    ...
    public function setPoBox($v)
    {
        ...
        if ($this->po_box !== $v) {
            $this->po_box = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PO_BOX;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PHONE;
        }
    ...
    public function setCellPhone($v)
    {
        ...
        if ($this->cell_phone !== $v) {
            $this->cell_phone = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CELL_PHONE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DESCRIPTION;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMMENT;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::EMAIL;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fk_misc_region = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            $this->company = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->city = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->zip_code = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->po_box = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->phone = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->cell_phone = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            ...
            return $startcol + 21; // 21 = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->salesOrderAddressHistoriesScheduledForDeletion !== null) {
                if (!$this->salesOrderAddressHistoriesScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressHistoryQuery::create()
            ...
            if ($this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion !== null) {
                if (!$this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_address`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`fk_misc_country`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_REGION)) {
            $modifiedColumns[':p' . $index++]  = '`fk_misc_region`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::SALUTATION)) {
            $modifiedColumns[':p' . $index++]  = '`salutation`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`first_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::MIDDLE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`middle_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`last_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS1)) {
            $modifiedColumns[':p' . $index++]  = '`address1`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = '`address2`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = '`address3`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMPANY)) {
            $modifiedColumns[':p' . $index++]  = '`company`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CITY)) {
            $modifiedColumns[':p' . $index++]  = '`city`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ZIP_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`zip_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PO_BOX)) {
            $modifiedColumns[':p' . $index++]  = '`po_box`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`phone`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CELL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = '`cell_phone`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`comment`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::EMAIL)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSalesOrderAddress(),
            $keys[1] => $this->getFkMiscCountry(),
            $keys[2] => $this->getFkMiscRegion(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFkMiscRegion($arr[$keys[2]]);
        ...
        if (array_key_exists($keys[10], $arr)) $this->setCompany($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setCity($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setZipCode($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setPoBox($arr[$keys[13]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS, $this->id_sales_order_address);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_COUNTRY)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_COUNTRY, $this->fk_misc_country);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_REGION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FK_MISC_REGION, $this->fk_misc_region);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::SALUTATION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::SALUTATION, $this->salutation);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FIRST_NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::FIRST_NAME, $this->first_name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::MIDDLE_NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::MIDDLE_NAME, $this->middle_name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::LAST_NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::LAST_NAME, $this->last_name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS1)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS1, $this->address1);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS2)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS2, $this->address2);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS3)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ADDRESS3, $this->address3);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMPANY)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMPANY, $this->company);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CITY)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CITY, $this->city);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ZIP_CODE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ZIP_CODE, $this->zip_code);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PO_BOX)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PO_BOX, $this->po_box);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PHONE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::PHONE, $this->phone);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CELL_PHONE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CELL_PHONE, $this->cell_phone);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMMENT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::COMMENT, $this->comment);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::EMAIL)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::EMAIL, $this->email);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::ID_SALES_ORDER_ADDRESS, $this->id_sales_order_address);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer();
        }
     ...
     * If this ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress is new, it will return
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressHistory[] List of ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressHistory objects
     */
    public function getSalesOrderAddressHistoriesJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressHistoryQuery::create(null, $criteria);
    ...
    public function initPacSalesOrdersRelatedByFkSalesOrderAddressBilling($overrideExisting = true)
    {
        ...
        $this->collPacSalesOrdersRelatedByFkSalesOrderAddressBilling->setModel('ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrder');
    }
    ...
    public function getPacSalesOrdersRelatedByFkSalesOrderAddressBilling($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPacSalesOrdersRelatedByFkSalesOrderAddressBilling || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacSalesOrdersRelatedByFkSalesOrderAddressBilling) {
                ...
                $collPacSalesOrdersRelatedByFkSalesOrderAddressBilling = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderQuery::create(null, $criteria)
    ...
    public function setPacSalesOrdersRelatedByFkSalesOrderAddressBilling(PropelCollection $pacSalesOrdersRelatedByFkSalesOrderAddressBilling, PropelPDO $con = null)
    {
        ...
        $this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion = $pacSalesOrdersRelatedByFkSalesOrderAddressBillingToDelete;
     ...
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress The current object (for fluent API support)
     */
    public function addPacSalesOrderRelatedByFkSalesOrderAddressBilling(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrder $l)
    {
        if ($this->collPacSalesOrdersRelatedByFkSalesOrderAddressBilling === null) {
            $this->initPacSalesOrdersRelatedByFkSalesOrderAddressBilling();
            $this->collPacSalesOrdersRelatedByFkSalesOrderAddressBillingPartial = true;
        ...
        if (!in_array($l, $this->collPacSalesOrdersRelatedByFkSalesOrderAddressBilling->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion and $this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion->contains($l)) {
                $this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion->remove($this->pacSalesOrdersRelatedByFkSalesOrderAddressBillingScheduledForDeletion->search($l));
            }
        }
    ...
    public function initPacSalesOrdersRelatedByFkSalesOrderAddressShipping($overrideExisting = true)
    {
        ...
        $this->collPacSalesOrdersRelatedByFkSalesOrderAddressShipping->setModel('ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrder');
    }
    ...
    public function getPacSalesOrdersRelatedByFkSalesOrderAddressShipping($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPacSalesOrdersRelatedByFkSalesOrderAddressShipping || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacSalesOrdersRelatedByFkSalesOrderAddressShipping) {
                ...
                $collPacSalesOrdersRelatedByFkSalesOrderAddressShipping = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderQuery::create(null, $criteria)
    ...
    public function setPacSalesOrdersRelatedByFkSalesOrderAddressShipping(PropelCollection $pacSalesOrdersRelatedByFkSalesOrderAddressShipping, PropelPDO $con = null)
    {
        ...
        $this->pacSalesOrdersRelatedByFkSalesOrderAddressShippingScheduledForDeletion = $pacSalesOrdersRelatedByFkSalesOrderAddressShippingToDelete;
     ...
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress The current object (for fluent API support)
     */
    public function addPacSalesOrderRelatedByFkSalesOrderAddressShipping(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrder $l)
    {
        if ($this->collPacSalesOrdersRelatedByFkSalesOrderAddressShipping === null) {
            $this->initPacSalesOrdersRelatedByFkSalesOrderAddressShipping();
            $this->collPacSalesOrdersRelatedByFkSalesOrderAddressShippingPartial = true;
        ...
        if (!in_array($l, $this->collPacSalesOrdersRelatedByFkSalesOrderAddressShipping->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->pacSalesOrdersRelatedByFkSalesOrderAddressShippingScheduledForDeletion and $this->pacSalesOrdersRelatedByFkSalesOrderAddressShippingScheduledForDeletion->contains($l)) {
                $this->pacSalesOrdersRelatedByFkSalesOrderAddressShippingScheduledForDeletion->remove($this->pacSalesOrdersRelatedByFkSalesOrderAddressShippingScheduledForDeletion->search($l));
            }
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressPeer::DEFAULT_STRING_FORMAT);
    }
