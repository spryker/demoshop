 ...
 */
abstract class Generated_Zed_Sales_Persistence_Propel_Om_BasePacSalesDiscount extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode[] Collection to store aggregation of ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode objects.
     */
    ...
    public function getScope()
    {
        ...
        $valueSet = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::getValueSet(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::SCOPE);
     ...
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     */
    public function setIdSalesDiscount($v)
    {
        ...
        if ($this->id_sales_discount !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ID_SALES_DISCOUNT;
        }
    ...
    public function setFkSalesOrder($v)
    {
        ...
        if ($this->fk_sales_order !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setFkSalesExpense($v)
    {
        ...
        if ($this->fk_sales_expense !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_EXPENSE;
        }
    ...
    public function setFkSalesOrderItemOption($v)
    {
        ...
        if ($this->fk_sales_order_item_option !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM_OPTION;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DESCRIPTION;
        }
    ...
    public function setDisplayName($v)
    {
        ...
        if ($this->display_name !== $v) {
            $this->display_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DISPLAY_NAME;
        }
    ...
    public function setScope($v)
    {
        ...
        if ($this->scope !== $v) {
            $this->scope = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::SCOPE;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ACTION;
        }
    ...
    public function setConditions($v)
    {
        ...
        if ($this->conditions !== $v) {
            $this->conditions = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CONDITIONS;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::AMOUNT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->conditions = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->amount = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            ...
            return $startcol + 14; // 14 = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->discountCodesScheduledForDeletion !== null) {
                if (!$this->discountCodesScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCodeQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ID_SALES_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_discount`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_EXPENSE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_expense`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM_OPTION)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item_option`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DISPLAY_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`display_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::SCOPE)) {
            $modifiedColumns[':p' . $index++]  = '`scope`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ACTION)) {
            $modifiedColumns[':p' . $index++]  = '`action`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CONDITIONS)) {
            $modifiedColumns[':p' . $index++]  = '`conditions`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::AMOUNT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collDiscountCodes) {
                $result['DiscountCodes'] = $this->collDiscountCodes->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) $this->setConditions($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ID_SALES_DISCOUNT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ID_SALES_DISCOUNT, $this->id_sales_discount);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER, $this->fk_sales_order);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_EXPENSE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_EXPENSE, $this->fk_sales_expense);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM_OPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::FK_SALES_ORDER_ITEM_OPTION, $this->fk_sales_order_item_option);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DISPLAY_NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DISPLAY_NAME, $this->display_name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::SCOPE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::SCOPE, $this->scope);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ACTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ACTION, $this->action);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CONDITIONS)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CONDITIONS, $this->conditions);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::AMOUNT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::AMOUNT, $this->amount);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::ID_SALES_DISCOUNT, $this->id_sales_discount);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer();
        }
    ...
    /**
     * Declares an association between this object and a ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense object.
     *
     * @param                  ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense $v
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     * @throws PropelException
     */
    public function setExpense(ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense object, it will not be re-added.
        if ($v !== null) {
            $v->addDiscount($this);
        }
    ...
    /**
     * Get the associated ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense The associated ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpense object.
     * @throws PropelException
     */
    public function getExpense(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aExpense === null && ($this->fk_sales_expense !== null) && $doQuery) {
            $this->aExpense = ProjectA_Zed_Sales_Persistence_Propel_PacSalesExpenseQuery::create()->findPk($this->fk_sales_expense, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    /**
     * Declares an association between this object and a ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption object.
     *
     * @param                  ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption $v
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     * @throws PropelException
     */
    public function setOption(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption object, it will not be re-added.
        if ($v !== null) {
            $v->addDiscount($this);
        }
    ...
    /**
     * Get the associated ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption The associated ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption object.
     * @throws PropelException
     */
    public function getOption(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOption === null && ($this->fk_sales_order_item_option !== null) && $doQuery) {
            $this->aOption = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionQuery::create()->findPk($this->fk_sales_order_item_option, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function clearDiscountCodes()
    {
        ...
        $this->collDiscountCodesPartial = null;
    ...
    public function initDiscountCodes($overrideExisting = true)
    {
        ...
        $this->collDiscountCodes = new PropelObjectCollection();
        $this->collDiscountCodes->setModel('ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode');
    }

    /**
     * Gets an array of ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode[] List of ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode objects
     * @throws PropelException
     */
    public function getDiscountCodes($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collDiscountCodes || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collDiscountCodes) {
                ...
                $collDiscountCodes = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCodeQuery::create(null, $criteria)
                ...
                if (null !== $criteria) {
                    ...
                    $collDiscountCodes->getInternalIterator()->rewind();
    ...
    /**
     * Sets a collection of DiscountCode objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $discountCodes A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     */
    public function setDiscountCodes(PropelCollection $discountCodes, PropelPDO $con = null)
    {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode objects.
     * @throws PropelException
     */
    public function countDiscountCodes(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collDiscountCodesPartial && !$this->isNew();
        if (null === $this->collDiscountCodes || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collDiscountCodes) {
            ...
            $query = ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCodeQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode object to this object
     * through the ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode foreign key attribute.
     *
     * @param    ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode $l ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     */
    public function addDiscountCode(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountCode $l)
    {
        if ($this->collDiscountCodes === null) {
            $this->initDiscountCodes();
            $this->collDiscountCodesPartial = true;
        ...
        if (!in_array($l, $this->collDiscountCodes->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param	DiscountCode $discountCode The discountCode object to add.
     */
    protected function doAddDiscountCode($discountCode)
    {
    ...
    /**
     * @param	DiscountCode $discountCode The discountCode object to remove.
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscount The current object (for fluent API support)
     */
    public function removeDiscountCode($discountCode)
    {
        if ($this->getDiscountCodes()->contains($discountCode)) {
            $this->collDiscountCodes->remove($this->collDiscountCodes->search($discountCode));
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collDiscountCodes instanceof PropelCollection) {
            $this->collDiscountCodes->clearIterator();
        }
        $this->collDiscountCodes = null;
        $this->aOrder = null;
        $this->aOrderItem = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_Propel_PacSalesDiscountPeer::DEFAULT_STRING_FORMAT);
    }
