...
/**
 * Base class that represents a row from the 'pac_sales_order_item_option' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Sales/Persistence/Propel.om
 */
abstract class Generated_Zed_Sales_Persistence_Propel_Om_BasePacSalesOrderItemOption extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Sales_Persistence_Propel_Om_BasePacSalesOrderItemOption object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption The current object (for fluent API support)
     */
    public function setIdSalesOrderItemOption($v)
    {
        ...
        if ($this->id_sales_order_item_option !== $v) {
            $this->id_sales_order_item_option = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setIdentifier($v)
    {
        ...
        if ($this->identifier !== $v) {
            $this->identifier = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::IDENTIFIER;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DESCRIPTION;
        }
    ...
    public function setGrossPrice($v)
    {
        ...
        if ($this->gross_price !== $v) {
            $this->gross_price = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::GROSS_PRICE;
        }
    ...
    public function setPriceToPay($v)
    {
        ...
        if ($this->price_to_pay !== $v) {
            $this->price_to_pay = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::PRICE_TO_PAY;
        }
    ...
    public function setTaxPercentage($v)
    {
        ...
        if ($this->tax_percentage !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_sales_order_item_option = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 10; // 10 = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION)) {
            $modifiedColumns[':p' . $index++]  = '`id_sales_order_item_option`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::IDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = '`identifier`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::GROSS_PRICE)) {
            $modifiedColumns[':p' . $index++]  = '`gross_price`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::PRICE_TO_PAY)) {
            $modifiedColumns[':p' . $index++]  = '`price_to_pay`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_sales_order_item_option` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSalesOrderItemOption($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION, $this->id_sales_order_item_option);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::IDENTIFIER)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::IDENTIFIER, $this->identifier);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::NAME)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::GROSS_PRICE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::GROSS_PRICE, $this->gross_price);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::PRICE_TO_PAY)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::PRICE_TO_PAY, $this->price_to_pay);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::TAX_PERCENTAGE, $this->tax_percentage);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::ID_SALES_ORDER_ITEM_OPTION, $this->id_sales_order_item_option);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer();
        }
     ...
     * If this ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOption is new, it will return
     ...
     * Otherwise if this PacSalesOrderItemOption is new, it will return
     * an empty collection; or if this PacSalesOrderItemOption has previously
     * been saved, it will retrieve related Discounts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacSalesOrderItemOption.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemOptionPeer::DEFAULT_STRING_FORMAT);
    }
