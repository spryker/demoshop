 ...
 */
abstract class Generated_Zed_Salesrule_Persistence_Propel_Om_BasePacSalesruleCode extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Salesrule_Persistence_Propel_Om_BasePacSalesruleCode object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode The current object (for fluent API support)
     */
    public function setIdSalesruleCode($v)
    {
        ...
        if ($this->id_salesrule_code !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::ID_SALESRULE_CODE;
        }
    ...
    public function setFkSalesruleCodepool($v)
    {
        ...
        if ($this->fk_salesrule_codepool !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_SALESRULE_CODEPOOL;
        }
    ...
    public function setFkCustomer($v)
    {
        ...
        if ($this->fk_customer !== $v) {
            $this->fk_customer = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_CUSTOMER;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CODE;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::IS_ACTIVE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::ID_SALESRULE_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`id_salesrule_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_SALESRULE_CODEPOOL)) {
            $modifiedColumns[':p' . $index++]  = '`fk_salesrule_codepool`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_CUSTOMER)) {
            $modifiedColumns[':p' . $index++]  = '`fk_customer`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::IS_ACTIVE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::ID_SALESRULE_CODE)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::ID_SALESRULE_CODE, $this->id_salesrule_code);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_SALESRULE_CODEPOOL)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_SALESRULE_CODEPOOL, $this->fk_salesrule_codepool);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_CUSTOMER)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::FK_CUSTOMER, $this->fk_customer);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CODE)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CODE, $this->code);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::IS_ACTIVE)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::IS_ACTIVE, $this->is_active);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::ID_SALESRULE_CODE, $this->id_salesrule_code);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer();
        }
    ...
    /**
     * Declares an association between this object and a ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool object.
     *
     * @param                  ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool $v
     * @return ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCodepool(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool The associated ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepool object.
     * @throws PropelException
     */
    public function getCodepool(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCodepool === null && ($this->fk_salesrule_codepool !== null) && $doQuery) {
            $this->aCodepool = ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodepoolQuery::create()->findPk($this->fk_salesrule_codepool, $con);
     ...
     * If this ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode is new, it will return
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCodePeer::DEFAULT_STRING_FORMAT);
    }
