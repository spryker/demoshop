 ...
 */
class Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleCodepoolTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Salesrule/Persistence/Propel.Map.PacSalesruleCodepoolTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacSalesruleCodepool';
    ...
    {
        $this->addRelation('SalesruleCode', 'ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode', RelationMap::ONE_TO_MANY, array('id_salesrule_codepool' => 'fk_salesrule_codepool', ), null, null, 'SalesruleCodes');
    } // buildRelations()
...
} // Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleCodepoolTableMap
