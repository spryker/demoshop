 ...
 */
class Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleCodeUsageTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Salesrule/Persistence/Propel.Map.PacSalesruleCodeUsageTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacSalesruleCodeUsage';
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Code', 'ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesruleCode', RelationMap::MANY_TO_ONE, array('fk_salesrule_code' => 'id_salesrule_code', ), null, null);
...
} // Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleCodeUsageTableMap
