 ...
 */
class Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleConditionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Salesrule/Persistence/Propel.Map.PacSalesruleConditionTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacSalesruleCondition';
    ...
    {
        $this->addRelation('Salesrule', 'ProjectA_Zed_Salesrule_Persistence_Propel_PacSalesrule', RelationMap::MANY_TO_ONE, array('fk_salesrule' => 'id_salesrule', ), null, null);
    } // buildRelations()
...
} // Generated_Zed_Salesrule_Persistence_Propel_Map_PacSalesruleConditionTableMap
