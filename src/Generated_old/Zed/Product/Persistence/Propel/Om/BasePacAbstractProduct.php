...
/**
 * Base class that represents a row from the 'pac_abstract_product' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Product/Persistence/Propel.om
 */
abstract class Generated_Zed_Product_Persistence_Propel_Om_BasePacAbstractProduct extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Product_Persistence_Propel_PacProduct[] Collection to store aggregation of ProjectA_Zed_Product_Persistence_Propel_PacProduct objects.
     */
    protected $collPacProducts;
    protected $collPacProductsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $pacProductsScheduledForDeletion = null;
     ...
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct The current object (for fluent API support)
     */
    public function setAbstractProductId($v)
    {
        ...
        if ($this->abstract_product_id !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::ABSTRACT_PRODUCT_ID;
        }
    ...
    public function setSku($v)
    {
        ...
        if ($this->sku !== $v) {
            $this->sku = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::SKU;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->abstract_product_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->pacProductsScheduledForDeletion !== null) {
                if (!$this->pacProductsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Product_Persistence_Propel_PacProductQuery::create()
                        ->filterByPrimaryKeys($this->pacProductsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->pacProductsScheduledForDeletion = null;
                }
            }

            if ($this->collPacProducts !== null) {
                foreach ($this->collPacProducts as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::ABSTRACT_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`abstract_product_id`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::SKU)) {
            $modifiedColumns[':p' . $index++]  = '`sku`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_abstract_product` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAbstractProductId(),
            $keys[1] => $this->getSku(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collPacProducts) {
                $result['PacProducts'] = $this->collPacProducts->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAbstractProductId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::ABSTRACT_PRODUCT_ID)) $criteria->add(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::ABSTRACT_PRODUCT_ID, $this->abstract_product_id);
        if ($this->isColumnModified(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::SKU)) $criteria->add(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::SKU, $this->sku);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::ABSTRACT_PRODUCT_ID, $this->abstract_product_id);
    ...
    /**
     * Generic method to set the primary key (abstract_product_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getAbstractProductId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getPacProducts() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addPacProduct($relObj->copy($deepCopy));
                }
            }
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAbstractProductId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer();
        }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('PacProduct' == $relationName) {
            $this->initPacProducts();
        }
    }
     ...
     * If this ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct is new, it will return
        ...
        if (null === $this->collPacLocalizedAbstractProductAttributess || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacLocalizedAbstractProductAttributess) {
                ...
                $collPacLocalizedAbstractProductAttributess = ProjectA_Zed_Product_Persistence_Propel_PacLocalizedAbstractProductAttributesQuery::create(null, $criteria)
                    ->filterByPacAbstractProduct($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPacLocalizedAbstractProductAttributess(PropelCollection $pacLocalizedAbstractProductAttributess, PropelPDO $con = null)
    {
        ...
        foreach ($pacLocalizedAbstractProductAttributessToDelete as $pacLocalizedAbstractProductAttributesRemoved) {
            $pacLocalizedAbstractProductAttributesRemoved->setPacAbstractProduct(null);
        }
    ...
    protected function doAddPacLocalizedAbstractProductAttributes($pacLocalizedAbstractProductAttributes)
    {
        ...
        $pacLocalizedAbstractProductAttributes->setPacAbstractProduct($this);
    }
    ...
    public function removePacLocalizedAbstractProductAttributes($pacLocalizedAbstractProductAttributes)
    {
        if ($this->getPacLocalizedAbstractProductAttributess()->contains($pacLocalizedAbstractProductAttributes)) {
            ...
            $pacLocalizedAbstractProductAttributes->setPacAbstractProduct(null);
        }
     ...
     * Otherwise if this PacAbstractProduct is new, it will return
     * an empty collection; or if this PacAbstractProduct has previously
     * been saved, it will retrieve related PacLocalizedAbstractProductAttributess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacAbstractProduct.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Product_Persistence_Propel_PacLocalizedAbstractProductAttributes[] List of ProjectA_Zed_Product_Persistence_Propel_PacLocalizedAbstractProductAttributes objects
     */
    public function getPacLocalizedAbstractProductAttributessJoinLocale($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Product_Persistence_Propel_PacLocalizedAbstractProductAttributesQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collPacProducts collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     ...
     * @see        addPacProducts()
     */
    public function clearPacProducts()
    {
        $this->collPacProducts = null; // important to set this to null since that means it is uninitialized
        $this->collPacProductsPartial = null;

        return $this;
    }

    /**
     * reset is the collPacProducts collection loaded partially
     *
     * @return void
     */
    public function resetPartialPacProducts($v = true)
    {
        $this->collPacProductsPartial = $v;
    }

    /**
     * Initializes the collPacProducts collection.
     *
     * By default this just sets the collPacProducts collection to an empty array (like clearcollPacProducts());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initPacProducts($overrideExisting = true)
    {
        if (null !== $this->collPacProducts && !$overrideExisting) {
            return;
        }
        $this->collPacProducts = new PropelObjectCollection();
        $this->collPacProducts->setModel('ProjectA_Zed_Product_Persistence_Propel_PacProduct');
    }

    /**
     * Gets an array of ProjectA_Zed_Product_Persistence_Propel_PacProduct objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Product_Persistence_Propel_PacProduct[] List of ProjectA_Zed_Product_Persistence_Propel_PacProduct objects
     * @throws PropelException
     */
    public function getPacProducts($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collPacProductsPartial && !$this->isNew();
        if (null === $this->collPacProducts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacProducts) {
                // return empty collection
                $this->initPacProducts();
            } else {
                $collPacProducts = ProjectA_Zed_Product_Persistence_Propel_PacProductQuery::create(null, $criteria)
                    ->filterByPacAbstractProduct($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collPacProductsPartial && count($collPacProducts)) {
                      $this->initPacProducts(false);

                      foreach ($collPacProducts as $obj) {
                        if (false == $this->collPacProducts->contains($obj)) {
                          $this->collPacProducts->append($obj);
                        }
                      }

                      $this->collPacProductsPartial = true;
                    }

                    $collPacProducts->getInternalIterator()->rewind();

                    return $collPacProducts;
                }

                if ($partial && $this->collPacProducts) {
                    foreach ($this->collPacProducts as $obj) {
                        if ($obj->isNew()) {
                            $collPacProducts[] = $obj;
                        }
                    }
                ...
                $this->collPacProducts = $collPacProducts;
                $this->collPacProductsPartial = false;
            }
        }

        return $this->collPacProducts;
    }

    /**
     * Sets a collection of PacProduct objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $pacProducts A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct The current object (for fluent API support)
     */
    public function setPacProducts(PropelCollection $pacProducts, PropelPDO $con = null)
    {
        $pacProductsToDelete = $this->getPacProducts(new Criteria(), $con)->diff($pacProducts);


        $this->pacProductsScheduledForDeletion = $pacProductsToDelete;

        foreach ($pacProductsToDelete as $pacProductRemoved) {
            $pacProductRemoved->setPacAbstractProduct(null);
        }

        $this->collPacProducts = null;
        foreach ($pacProducts as $pacProduct) {
            $this->addPacProduct($pacProduct);
        }

        $this->collPacProducts = $pacProducts;
        $this->collPacProductsPartial = false;
    ...
    /**
     * Returns the number of related ProjectA_Zed_Product_Persistence_Propel_PacProduct objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Product_Persistence_Propel_PacProduct objects.
     * @throws PropelException
     */
    public function countPacProducts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collPacProductsPartial && !$this->isNew();
        if (null === $this->collPacProducts || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collPacProducts) {
            ...
            if ($partial && !$criteria) {
                return count($this->getPacProducts());
            }
            $query = ProjectA_Zed_Product_Persistence_Propel_PacProductQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collPacProducts);
    }

    /**
     * Method called to associate a ProjectA_Zed_Product_Persistence_Propel_PacProduct object to this object
     * through the ProjectA_Zed_Product_Persistence_Propel_PacProduct foreign key attribute.
     *
     * @param    ProjectA_Zed_Product_Persistence_Propel_PacProduct $l ProjectA_Zed_Product_Persistence_Propel_PacProduct
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct The current object (for fluent API support)
     */
    public function addPacProduct(ProjectA_Zed_Product_Persistence_Propel_PacProduct $l)
    {
        if ($this->collPacProducts === null) {
            $this->initPacProducts();
            $this->collPacProductsPartial = true;
        ...
        if (!in_array($l, $this->collPacProducts->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddPacProduct($l);

            if ($this->pacProductsScheduledForDeletion and $this->pacProductsScheduledForDeletion->contains($l)) {
                $this->pacProductsScheduledForDeletion->remove($this->pacProductsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	PacProduct $pacProduct The pacProduct object to add.
     */
    protected function doAddPacProduct($pacProduct)
    {
        $this->collPacProducts[]= $pacProduct;
        $pacProduct->setPacAbstractProduct($this);
    }

    /**
     * @param	PacProduct $pacProduct The pacProduct object to remove.
     * @return ProjectA_Zed_Product_Persistence_Propel_PacAbstractProduct The current object (for fluent API support)
     */
    public function removePacProduct($pacProduct)
    {
        if ($this->getPacProducts()->contains($pacProduct)) {
            $this->collPacProducts->remove($this->collPacProducts->search($pacProduct));
            if (null === $this->pacProductsScheduledForDeletion) {
                $this->pacProductsScheduledForDeletion = clone $this->collPacProducts;
                $this->pacProductsScheduledForDeletion->clear();
            }
            $this->pacProductsScheduledForDeletion[]= clone $pacProduct;
            $pacProduct->setPacAbstractProduct(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collPacProducts) {
                foreach ($this->collPacProducts as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collPacLocalizedAbstractProductAttributess = null;
        if ($this->collPacProducts instanceof PropelCollection) {
            $this->collPacProducts->clearIterator();
        }
        $this->collPacProducts = null;
    }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Product_Persistence_Propel_PacAbstractProductPeer::DEFAULT_STRING_FORMAT);
    }
