...
/**
 * This class defines the structure of the 'pac_cms_block_text' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Cms_Persistence_Propel_Map_PacCmsBlockTextTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Cms/Persistence/Propel.Map.PacCmsBlockTextTableMap';
    ...
    {
        // attributes
        $this->setName('pac_cms_block_text');
        $this->setPhpName('PacCmsBlockText');

        $method = 'loadPacCmsBlockText';
        ...
        // columns
        $this->addPrimaryKey('id_cms_block_text', 'IdCmsBlockText', 'INTEGER', true, null, null);
...
} // Generated_Zed_Cms_Persistence_Propel_Map_PacCmsBlockTextTableMap
