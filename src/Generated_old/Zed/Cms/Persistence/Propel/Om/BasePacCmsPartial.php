...
/**
 * Base class that represents a row from the 'pac_cms_partial' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Cms/Persistence/Propel.om
 */
abstract class Generated_Zed_Cms_Persistence_Propel_Om_BasePacCmsPartial extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer
     */
    ...
    /**
     * The value for the id_cms_partial field.
     * @var        int
     */
    protected $id_cms_partial;
    ...
    /**
     * The value for the yves_partial_name field.
     * @var        string
     */
    protected $yves_partial_name;
    ...
    /**
     * Initializes internal state of Generated_Zed_Cms_Persistence_Propel_Om_BasePacCmsPartial object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [id_cms_partial] column value.
     *
     * @return int
     */
    public function getIdCmsPartial()
    {

        return $this->id_cms_partial;
    }
    ...
    /**
     * Get the [yves_partial_name] column value.
     *
     * @return string
     */
    public function getYvesPartialName()
    {

        return $this->yves_partial_name;
    }
    ...
    /**
     * Set the value of [id_cms_partial] column.
     *
     * @param  int $v new value
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial The current object (for fluent API support)
     */
    public function setIdCmsPartial($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_cms_partial !== $v) {
            $this->id_cms_partial = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::ID_CMS_PARTIAL;
        }
    ...
    public function setFkCmsBlockType($v)
    {
        ...
        if ($this->fk_cms_block_type !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::FK_CMS_BLOCK_TYPE;
        }
    ...
    /**
     * Set the value of [yves_partial_name] column.
     *
     * @param  string $v new value
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial The current object (for fluent API support)
     */
    public function setYvesPartialName($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->yves_partial_name !== $v) {
            $this->yves_partial_name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::YVES_PARTIAL_NAME;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::NAME;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CONTENT;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DESCRIPTION;
        }
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::IS_DELETED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_cms_partial = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->fk_cms_block_type = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->yves_partial_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->content = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->description = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->is_deleted = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
            ...
            return $startcol + 9; // 9 = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::ID_CMS_PARTIAL)) {
            $modifiedColumns[':p' . $index++]  = '`id_cms_partial`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::FK_CMS_BLOCK_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_cms_block_type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::YVES_PARTIAL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`yves_partial_name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`content`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::IS_DELETED)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_cms_partial` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_cms_partial`':
                        $stmt->bindValue($identifier, $this->id_cms_partial, PDO::PARAM_INT);
                        break;
                    case '`fk_cms_block_type`':
                        $stmt->bindValue($identifier, $this->fk_cms_block_type, PDO::PARAM_INT);
                        break;
                    case '`yves_partial_name`':
                        $stmt->bindValue($identifier, $this->yves_partial_name, PDO::PARAM_STR);
                        break;
                    case '`name`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdCmsPartial();
                break;
            case 1:
                return $this->getFkCmsBlockType();
                break;
            case 2:
                return $this->getYvesPartialName();
                break;
            case 3:
                return $this->getName();
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCmsPartial(),
            $keys[1] => $this->getFkCmsBlockType(),
            $keys[2] => $this->getYvesPartialName(),
            $keys[3] => $this->getName(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdCmsPartial($value);
                break;
            case 1:
                $this->setFkCmsBlockType($value);
                break;
            case 2:
                $this->setYvesPartialName($value);
                break;
            case 3:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdCmsPartial($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setFkCmsBlockType($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setYvesPartialName($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::ID_CMS_PARTIAL)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::ID_CMS_PARTIAL, $this->id_cms_partial);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::FK_CMS_BLOCK_TYPE)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::FK_CMS_BLOCK_TYPE, $this->fk_cms_block_type);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::YVES_PARTIAL_NAME)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::YVES_PARTIAL_NAME, $this->yves_partial_name);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::NAME)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CONTENT)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CONTENT, $this->content);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::IS_DELETED)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::ID_CMS_PARTIAL, $this->id_cms_partial);
    ...
    /**
     * Generic method to set the primary key (id_cms_partial column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdCmsPartial();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setYvesPartialName($this->getYvesPartialName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdCmsPartial(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer();
        }
    ...
    public function getPacCmsBlockType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPacCmsBlockType === null && ($this->fk_cms_block_type !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPacCmsBlockType->addPacCmsPartials($this);
             */
        }
     ...
     * If this ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartial is new, it will return
    ...
    public function setPacCmsTemplatePartials(PropelCollection $pacCmsTemplatePartials, PropelPDO $con = null)
    {
        ...
        foreach ($pacCmsTemplatePartialsToDelete as $pacCmsTemplatePartialRemoved) {
            $pacCmsTemplatePartialRemoved->setPacCmsPartial(null);
        }
    ...
    protected function doAddPacCmsTemplatePartial($pacCmsTemplatePartial)
    {
        ...
        $pacCmsTemplatePartial->setPacCmsPartial($this);
    }
    ...
    public function removePacCmsTemplatePartial($pacCmsTemplatePartial)
    {
        if ($this->getPacCmsTemplatePartials()->contains($pacCmsTemplatePartial)) {
            ...
            $pacCmsTemplatePartial->setPacCmsPartial(null);
        }
     ...
     * Otherwise if this PacCmsPartial is new, it will return
     * an empty collection; or if this PacCmsPartial has previously
     * been saved, it will retrieve related PacCmsTemplatePartials from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacCmsPartial.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Cms_Persistence_Propel_PacCmsTemplatePartial[] List of ProjectA_Zed_Cms_Persistence_Propel_PacCmsTemplatePartial objects
     */
    public function getPacCmsTemplatePartialsJoinPacCmsTemplate($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Cms_Persistence_Propel_PacCmsTemplatePartialQuery::create(null, $criteria);
    ...
    {
        $this->id_cms_partial = null;
        $this->fk_cms_block_type = null;
        $this->yves_partial_name = null;
        $this->name = null;
        $this->content = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPartialPeer::DEFAULT_STRING_FORMAT);
    }
