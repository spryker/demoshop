...
/**
 * Base class that represents a row from the 'pac_cms_page_attribute' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Cms/Persistence/Propel.om
 */
abstract class Generated_Zed_Cms_Persistence_Propel_Om_BasePacCmsPageAttribute extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer
     */
    ...
    /**
     * The value for the id_cms_page_attribute field.
     * @var        int
     */
    protected $id_cms_page_attribute;
    ...
    /**
     * The value for the is_meta_attribute field.
     * Note: this column has a database default value of: false
     * @var        boolean
     */
    protected $is_meta_attribute;
    ...
    {
        $this->is_meta_attribute = false;
    }

    /**
     * Initializes internal state of Generated_Zed_Cms_Persistence_Propel_Om_BasePacCmsPageAttribute object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [id_cms_page_attribute] column value.
     *
     * @return int
     */
    public function getIdCmsPageAttribute()
    {

        return $this->id_cms_page_attribute;
    }
    ...
    /**
     * Get the [is_meta_attribute] column value.
     *
     * @return boolean
     */
    public function getIsMetaAttribute()
    {

        return $this->is_meta_attribute;
    }
    ...
    /**
     * Set the value of [id_cms_page_attribute] column.
     *
     * @param  int $v new value
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute The current object (for fluent API support)
     */
    public function setIdCmsPageAttribute($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_cms_page_attribute !== $v) {
            $this->id_cms_page_attribute = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE;
        }


        return $this;
    } // setIdCmsPageAttribute()
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::NAME;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::TYPE;
        }
    ...
    /**
     * Sets the value of the [is_meta_attribute] column.
     ...
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute The current object (for fluent API support)
     */
    public function setIsMetaAttribute($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->is_meta_attribute !== $v) {
            $this->is_meta_attribute = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::IS_META_ATTRIBUTE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    {
            if ($this->is_meta_attribute !== false) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_cms_page_attribute = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->is_meta_attribute = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE;
        if (null !== $this->id_cms_page_attribute) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`id_cms_page_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::IS_META_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`is_meta_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_cms_page_attribute` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_cms_page_attribute`':
                        $stmt->bindValue($identifier, $this->id_cms_page_attribute, PDO::PARAM_INT);
                        break;
                    case '`name`':
                    ...
                    case '`type`':
                        ...
                        break;
                    case '`is_meta_attribute`':
                        $stmt->bindValue($identifier, (int) $this->is_meta_attribute, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdCmsPageAttribute();
                break;
            case 1:
                return $this->getName();
                break;
            case 2:
                ...
                break;
            case 3:
                return $this->getIsMetaAttribute();
                break;
            case 4:
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCmsPageAttribute(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getType(),
            $keys[3] => $this->getIsMetaAttribute(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdCmsPageAttribute($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdCmsPageAttribute($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setName($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setType($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setIsMetaAttribute($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE, $this->id_cms_page_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::NAME)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::TYPE)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::TYPE, $this->type);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::IS_META_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::IS_META_ATTRIBUTE, $this->is_meta_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::ID_CMS_PAGE_ATTRIBUTE, $this->id_cms_page_attribute);
    ...
    /**
     * Generic method to set the primary key (id_cms_page_attribute column).
     *
    ...
    {
        $this->setIdCmsPageAttribute($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdCmsPageAttribute();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsMetaAttribute($this->getIsMetaAttribute());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdCmsPageAttribute(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer();
        }
     ...
     * If this ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttribute is new, it will return
        ...
        if (null === $this->collPacCmsPageAttributeValues || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacCmsPageAttributeValues) {
                ...
                $collPacCmsPageAttributeValues = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributeValueQuery::create(null, $criteria)
                    ->filterByPacCmsPageAttribute($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPacCmsPageAttributeValues(PropelCollection $pacCmsPageAttributeValues, PropelPDO $con = null)
    {
        ...
        foreach ($pacCmsPageAttributeValuesToDelete as $pacCmsPageAttributeValueRemoved) {
            $pacCmsPageAttributeValueRemoved->setPacCmsPageAttribute(null);
        }
    ...
    protected function doAddPacCmsPageAttributeValue($pacCmsPageAttributeValue)
    {
        ...
        $pacCmsPageAttributeValue->setPacCmsPageAttribute($this);
    }
    ...
    public function removePacCmsPageAttributeValue($pacCmsPageAttributeValue)
    {
        if ($this->getPacCmsPageAttributeValues()->contains($pacCmsPageAttributeValue)) {
            ...
            $pacCmsPageAttributeValue->setPacCmsPageAttribute(null);
        }
     ...
     * Otherwise if this PacCmsPageAttribute is new, it will return
     * an empty collection; or if this PacCmsPageAttribute has previously
     * been saved, it will retrieve related PacCmsPageAttributeValues from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacCmsPageAttribute.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributeValue[] List of ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributeValue objects
     */
    public function getPacCmsPageAttributeValuesJoinPacCmsPage($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributeValueQuery::create(null, $criteria);
    ...
    {
        $this->id_cms_page_attribute = null;
        $this->name = null;
        $this->type = null;
        $this->is_meta_attribute = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Cms_Persistence_Propel_PacCmsPageAttributePeer::DEFAULT_STRING_FORMAT);
    }
