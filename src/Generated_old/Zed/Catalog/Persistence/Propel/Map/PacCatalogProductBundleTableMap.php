 ...
 */
class Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogProductBundleTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Catalog/Persistence/Propel.Map.PacCatalogProductBundleTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacCatalogProductBundle';
  ...
  1 => 'SplitBundle',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('BundleProduct', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct', RelationMap::ONE_TO_MANY, array('id_catalog_product' => 'fk_catalog_product_bundle', ), null, null, 'BundleProducts');
        $this->addRelation('BundleProductProduct', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct', RelationMap::MANY_TO_MANY, array(), null, null, 'BundleProductProducts');
    } // buildRelations()
...
} // Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogProductBundleTableMap
