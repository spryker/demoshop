 ...
 */
class Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogAttributeSetGroupTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Catalog/Persistence/Propel.Map.PacCatalogAttributeSetGroupTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacCatalogAttributeSetGroup';
    ...
    {
        $this->addRelation('Group', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup', RelationMap::MANY_TO_ONE, array('fk_catalog_group' => 'id_catalog_group', ), 'CASCADE', null);
...
} // Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogAttributeSetGroupTableMap
