 ...
 */
class Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogProductCategoryTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Catalog/Persistence/Propel.Map.PacCatalogProductCategoryTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacCatalogProductCategory';
        ...
        $this->addColumn('fk_category_name', 'FkCategoryName', 'INTEGER', true, null, null);
        // validators
    } // initialize()
...
} // Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogProductCategoryTableMap
