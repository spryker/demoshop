 ...
 */
class Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogValueTypeTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Catalog/Persistence/Propel.Map.PacCatalogValueTypeTableMap';
    ...
    public function initialize()
    {
        ...
        $method = 'loadPacCatalogValueType';
  ...
  6 => 'Timestamp',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AttributeSet', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeSet', RelationMap::MANY_TO_ONE, array('fk_catalog_attribute_set' => 'id_catalog_attribute_set', ), 'CASCADE', null);
        $this->addRelation('AttributeSetGroup', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeSetGroup', RelationMap::ONE_TO_MANY, array('id_catalog_value_type' => 'fk_catalog_value_type', ), null, null, 'AttributeSetGroups');
        $this->addRelation('Option', 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption', RelationMap::ONE_TO_MANY, array('id_catalog_value_type' => 'fk_catalog_value_type', ), null, null, 'Options');
...
} // Generated_Zed_Catalog_Persistence_Propel_Map_PacCatalogValueTypeTableMap
