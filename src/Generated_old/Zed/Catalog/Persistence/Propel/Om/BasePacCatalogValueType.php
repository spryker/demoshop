 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogValueType extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption[] Collection to store aggregation of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption objects.
     */
    protected $collOptions;
    protected $collOptionsPartial;

    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup[] Collection to store aggregation of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects.
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType The current object (for fluent API support)
     */
    public function setIdCatalogValueType($v)
    {
        ...
        if ($this->id_catalog_value_type !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::ID_CATALOG_VALUE_TYPE;
        }
    ...
    public function setFkCatalogAttribute($v)
    {
        ...
        if ($this->fk_catalog_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE;
        }
    ...
    public function setFkCatalogAttributeSet($v)
    {
        ...
        if ($this->fk_catalog_attribute_set !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE_SET;
        }
    ...
    public function setVariety($v)
    {
        ...
        if ($this->variety !== $v) {
            $this->variety = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::VARIETY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fk_catalog_attribute_set = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->variety = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->optionsScheduledForDeletion !== null) {
                if (!$this->optionsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::ID_CATALOG_VALUE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_value_type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE_SET)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_attribute_set`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::VARIETY)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCatalogValueType(),
            $keys[1] => $this->getFkCatalogAttribute(),
            $keys[2] => $this->getFkCatalogAttributeSet(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFkCatalogAttributeSet($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setVariety($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::ID_CATALOG_VALUE_TYPE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::ID_CATALOG_VALUE_TYPE, $this->id_catalog_value_type);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE, $this->fk_catalog_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE_SET)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::FK_CATALOG_ATTRIBUTE_SET, $this->fk_catalog_attribute_set);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::VARIETY)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::VARIETY, $this->variety);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::ID_CATALOG_VALUE_TYPE, $this->id_catalog_value_type);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer();
        }
     ...
     * If this ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType is new, it will return
    ...
    public function initOptions($overrideExisting = true)
    {
        ...
        $this->collOptions->setModel('ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption');
    }

    /**
     * Gets an array of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption objects
     * @throws PropelException
     */
    public function getOptions($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collOptions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOptions) {
                ...
                $collOptions = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionQuery::create(null, $criteria)
                    ->filterByValueType($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption objects.
     * @throws PropelException
     */
    public function countOptions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collOptions || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption object to this object
     * through the ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption foreign key attribute.
     *
     * @param    ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption $l ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType The current object (for fluent API support)
     */
    public function addOption(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOption $l)
    {
        if ($this->collOptions === null) {
            $this->initOptions();
            $this->collOptionsPartial = true;
    ...
    public function initGroups()
    {
        ...
        $this->collGroups->setModel('ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup');
    }

    /**
     * Gets a collection of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects related by a many-to-many relationship
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects
     */
    public function getGroups($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collGroups || null !== $criteria) {
            if ($this->isNew() && null === $this->collGroups) {
                ...
                $collGroups = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroupQuery::create(null, $criteria)
                    ->filterByValueType($this)
                    ->find($con);
                if (null !== $criteria) {
                    return $collGroups;
    ...
    /**
     * Sets a collection of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_set_group cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    /**
     * Gets the number of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects related by a many-to-many relationship
     * to the current object by way of the pac_catalog_attribute_set_group cross-reference table.
     *
     * @param Criteria $criteria Optional query object to filter the query
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return int the number of related ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup objects
     */
    public function countGroups($criteria = null, $distinct = false, PropelPDO $con = null)
    {
        if (null === $this->collGroups || null !== $criteria) {
            if ($this->isNew() && null === $this->collGroups) {
                ...
                $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroupQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
    ...
    /**
     * Associate a ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup object to this object
     * through the pac_catalog_attribute_set_group cross reference table.
     *
     * @param  ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $pacCatalogGroup The ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeSetGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType The current object (for fluent API support)
     */
    public function addGroup(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $pacCatalogGroup)
    {
        ...
        if (!$this->collGroups->contains($pacCatalogGroup)) { // only add it if the **same** object is not already associated
            ...
            if ($this->groupsScheduledForDeletion and $this->groupsScheduledForDeletion->contains($pacCatalogGroup)) {
                $this->groupsScheduledForDeletion->remove($this->groupsScheduledForDeletion->search($pacCatalogGroup));
            }
        }
     ...
     */
    protected function doAddGroup(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $group)
    {
        // set the back reference to this object directly as using provided method either results
        // in endless loop or in multiple relations
        if (!$group->getValueTypes()->contains($this)) {
            ...
            $foreignCollection = $group->getValueTypes();
            $foreignCollection[] = $this;
        }
    }

    /**
     * Remove a ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup object to this object
     * through the pac_catalog_attribute_set_group cross reference table.
     *
     * @param ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $pacCatalogGroup The ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeSetGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueType The current object (for fluent API support)
     */
    public function removeGroup(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $pacCatalogGroup)
    {
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTypePeer::DEFAULT_STRING_FORMAT);
    }
