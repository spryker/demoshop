 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogAttribute extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute The current object (for fluent API support)
     */
    public function setIdCatalogAttribute($v)
    {
        ...
        if ($this->id_catalog_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $this->id_catalog_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::NAME)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $this->id_catalog_attribute);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer();
        }
     ...
     * If this ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute is new, it will return
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti objects
     */
    public function getOptionMultisJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionSingle[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionSingle objects
     */
    public function getOptionSinglesJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionSingleQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueInteger[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueInteger objects
     */
    public function getIntegersJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueIntegerQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTimestamp[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTimestamp objects
     */
    public function getTimestampsJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTimestampQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal objects
     */
    public function getDecimalsJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueText[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueText objects
     */
    public function getTextsJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueTextQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueBoolean[] List of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueBoolean objects
     */
    public function getBooleansJoinProductEntity($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueBooleanQuery::create(null, $criteria);
        $query->joinWith('ProductEntity', $join_behavior);
     ...
     *
     * @param  ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $pacCatalogGroup The ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributeGroup object to relate
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttribute The current object (for fluent API support)
     */
    ...
    protected function doAddGroup(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogGroup $group)
    {
        ...
        if (!$group->getAttributes()->contains($this)) {
            ...
            $foreignCollection = $group->getAttributes();
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogAttributePeer::DEFAULT_STRING_FORMAT);
    }
