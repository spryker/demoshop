 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogProductCategory extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory The current object (for fluent API support)
     */
    public function setIdCatalogProductCategory($v)
    {
        ...
        if ($this->id_catalog_product_category !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::ID_CATALOG_PRODUCT_CATEGORY;
        }
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function setFkCategoryName($v)
    {
        ...
        if ($this->fk_category_name !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATEGORY_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::ID_CATALOG_PRODUCT_CATEGORY)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_product_category`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATALOG_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATEGORY_NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::ID_CATALOG_PRODUCT_CATEGORY)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::ID_CATALOG_PRODUCT_CATEGORY, $this->id_catalog_product_category);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATEGORY_NAME)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::FK_CATEGORY_NAME, $this->fk_category_name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::ID_CATALOG_PRODUCT_CATEGORY, $this->id_catalog_product_category);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategory Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer();
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductCategoryPeer::DEFAULT_STRING_FORMAT);
    }
