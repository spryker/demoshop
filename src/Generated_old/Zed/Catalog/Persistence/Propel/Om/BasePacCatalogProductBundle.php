 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogProductBundle extends AbstractPropelSpecificProduct implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle The current object (for fluent API support)
     */
    public function setIdCatalogProduct($v)
    {
        ...
        if ($this->id_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::ID_CATALOG_PRODUCT;
        }
    ...
    public function setBundleType($v)
    {
        ...
        if ($this->bundle_type !== $v) {
            $this->bundle_type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::BUNDLE_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bundle_type = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::ID_CATALOG_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::BUNDLE_TYPE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCatalogProduct(),
            $keys[1] => $this->getBundleType(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBundleType($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::ID_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::ID_CATALOG_PRODUCT, $this->id_catalog_product);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::BUNDLE_TYPE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::BUNDLE_TYPE, $this->bundle_type);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::ID_CATALOG_PRODUCT, $this->id_catalog_product);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer();
        }
    ...
    public function getProductEntity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductEntity === null && ($this->id_catalog_product !== null) && $doQuery) {
            ...
            $this->aProductEntity->setBundle($this);
        }
     ...
     * If this ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle is new, it will return
    ...
    public function initBundleProductProducts()
    {
        ...
        $this->collBundleProductProducts->setModel('ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct');
    }
    ...
    public function getBundleProductProducts($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collBundleProductProducts || null !== $criteria) {
            if ($this->isNew() && null === $this->collBundleProductProducts) {
                ...
                $collBundleProductProducts = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductQuery::create(null, $criteria)
                    ->filterByBundleProductBundle($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setBundleProductProducts(PropelCollection $bundleProductProducts, PropelPDO $con = null)
    {
        ...
        $currentBundleProductProducts = $this->getBundleProductProducts(null, $con);
     ...
     *
     * @param  ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct $pacCatalogProduct The ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct object to relate
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle The current object (for fluent API support)
     */
    public function addBundleProductProduct(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct $pacCatalogProduct)
    {
        ...
        if (!$this->collBundleProductProducts->contains($pacCatalogProduct)) { // only add it if the **same** object is not already associated
            ...
            if ($this->bundleProductProductsScheduledForDeletion and $this->bundleProductProductsScheduledForDeletion->contains($pacCatalogProduct)) {
                $this->bundleProductProductsScheduledForDeletion->remove($this->bundleProductProductsScheduledForDeletion->search($pacCatalogProduct));
            }
        }
     ...
     */
    protected function doAddBundleProductProduct(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct $bundleProductProduct)
    {
        // set the back reference to this object directly as using provided method either results
        // in endless loop or in multiple relations
        if (!$bundleProductProduct->getBundleProductBundles()->contains($this)) {
            ...
            $foreignCollection = $bundleProductProduct->getBundleProductBundles();
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle The current object (for fluent API support)
     */
    public function removeBundleProductProduct(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct $pacCatalogProduct)
    {
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundlePeer::DEFAULT_STRING_FORMAT);
    }
