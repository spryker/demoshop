 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogValueOptionMulti extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti The current object (for fluent API support)
     */
    public function setIdCatalogValueOptionMulti($v)
    {
        ...
        if ($this->id_catalog_value_option_multi !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::ID_CATALOG_VALUE_OPTION_MULTI;
        }
    ...
    public function setFkCatalogValueOption($v)
    {
        ...
        if ($this->fk_catalog_value_option !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_VALUE_OPTION;
        }
    ...
    public function setFkCatalogAttribute($v)
    {
        ...
        if ($this->fk_catalog_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_ATTRIBUTE;
        }
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::ID_CATALOG_VALUE_OPTION_MULTI)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_value_option_multi`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_VALUE_OPTION)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_value_option`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_PRODUCT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::ID_CATALOG_VALUE_OPTION_MULTI)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::ID_CATALOG_VALUE_OPTION_MULTI, $this->id_catalog_value_option_multi);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_VALUE_OPTION)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_VALUE_OPTION, $this->fk_catalog_value_option);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_ATTRIBUTE, $this->fk_catalog_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::ID_CATALOG_VALUE_OPTION_MULTI, $this->id_catalog_value_option_multi);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMulti Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer();
        }
    ...
    public function getProductEntity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductEntity === null && ($this->fk_catalog_product !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductEntity->addOptionMultis($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueOptionMultiPeer::DEFAULT_STRING_FORMAT);
    }
