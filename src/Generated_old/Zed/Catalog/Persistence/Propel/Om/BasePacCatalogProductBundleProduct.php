 ...
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogProductBundleProduct extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer
     */
     ...
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct The current object (for fluent API support)
     */
    public function setIdCatalogProductBundleProduct($v)
    {
        ...
        if ($this->id_catalog_product_bundle_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::ID_CATALOG_PRODUCT_BUNDLE_PRODUCT;
        }
    ...
    public function setFkCatalogProductBundle($v)
    {
        ...
        if ($this->fk_catalog_product_bundle !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT_BUNDLE;
        }
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::ID_CATALOG_PRODUCT_BUNDLE_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_product_bundle_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT_BUNDLE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_product_bundle`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::ID_CATALOG_PRODUCT_BUNDLE_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::ID_CATALOG_PRODUCT_BUNDLE_PRODUCT, $this->id_catalog_product_bundle_product);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT_BUNDLE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT_BUNDLE, $this->fk_catalog_product_bundle);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::ID_CATALOG_PRODUCT_BUNDLE_PRODUCT, $this->id_catalog_product_bundle_product);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer();
        }
    ...
    /**
     * Declares an association between this object and a ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle object.
     *
     * @param                  ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle $v
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProduct The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBundleProductBundle(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle The associated ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundle object.
     * @throws PropelException
     */
    public function getBundleProductBundle(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBundleProductBundle === null && ($this->fk_catalog_product_bundle !== null) && $doQuery) {
            $this->aBundleProductBundle = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleQuery::create()->findPk($this->fk_catalog_product_bundle, $con);
     ...
     * @throws PropelException
     */
    public function setBundleProductProduct(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProduct $v = null)
    {
        if ($v === null) {
    ...
    public function getBundleProductProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBundleProductProduct === null && ($this->fk_catalog_product !== null) && $doQuery) {
            $this->aBundleProductProduct = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductQuery::create()->findPk($this->fk_catalog_product, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogProductBundleProductPeer::DEFAULT_STRING_FORMAT);
    }
