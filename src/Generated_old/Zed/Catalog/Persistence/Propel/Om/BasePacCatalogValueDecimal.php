...
/**
 * Base class that represents a row from the 'pac_catalog_value_decimal' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Catalog/Persistence/Propel.om
 */
abstract class Generated_Zed_Catalog_Persistence_Propel_Om_BasePacCatalogValueDecimal extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer
     */
    ...
    /**
     * The value for the id_catalog_value_decimal field.
     * @var        int
     */
    protected $id_catalog_value_decimal;
    ...
    /**
     * Get the [id_catalog_value_decimal] column value.
     *
     * @return int
     */
    public function getIdCatalogValueDecimal()
    {

        return $this->id_catalog_value_decimal;
    }
    ...
    /**
     * Set the value of [id_catalog_value_decimal] column.
     *
     * @param  int $v new value
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal The current object (for fluent API support)
     */
    public function setIdCatalogValueDecimal($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_catalog_value_decimal !== $v) {
            $this->id_catalog_value_decimal = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL;
        }


        return $this;
    } // setIdCatalogValueDecimal()
    ...
    public function setFkCatalogAttribute($v)
    {
        ...
        if ($this->fk_catalog_attribute !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_ATTRIBUTE;
        }
    ...
    public function setFkCatalogProduct($v)
    {
        ...
        if ($this->fk_catalog_product !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_PRODUCT;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_catalog_value_decimal = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL;
        if (null !== $this->id_catalog_value_decimal) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL)) {
            $modifiedColumns[':p' . $index++]  = '`id_catalog_value_decimal`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_ATTRIBUTE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_attribute`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_PRODUCT)) {
            $modifiedColumns[':p' . $index++]  = '`fk_catalog_product`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_catalog_value_decimal` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_catalog_value_decimal`':
                        $stmt->bindValue($identifier, $this->id_catalog_value_decimal, PDO::PARAM_INT);
                        break;
        ...
        $this->setIdCatalogValueDecimal($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdCatalogValueDecimal();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCatalogValueDecimal(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdCatalogValueDecimal($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdCatalogValueDecimal($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL, $this->id_catalog_value_decimal);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_ATTRIBUTE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_ATTRIBUTE, $this->fk_catalog_attribute);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_PRODUCT)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::FK_CATALOG_PRODUCT, $this->fk_catalog_product);
        if ($this->isColumnModified(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::VALUE)) $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::ID_CATALOG_VALUE_DECIMAL, $this->id_catalog_value_decimal);
    ...
    /**
     * Generic method to set the primary key (id_catalog_value_decimal column).
     *
    ...
    {
        $this->setIdCatalogValueDecimal($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdCatalogValueDecimal();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdCatalogValueDecimal(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimal Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer();
        }
    ...
    public function getAttribute(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAttribute === null && ($this->fk_catalog_attribute !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAttribute->addDecimals($this);
             */
        }
    ...
    public function getProductEntity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductEntity === null && ($this->fk_catalog_product !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductEntity->addDecimals($this);
             */
        }
    ...
    {
        $this->id_catalog_value_decimal = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Catalog_Persistence_Propel_PacCatalogValueDecimalPeer::DEFAULT_STRING_FORMAT);
    }
