 ...
 */
abstract class Generated_Zed_Acl_Persistence_Propel_Om_BasePacAclUser extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState[] Collection to store aggregation of ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState objects.
     */
    protected $collPacKendoGridStates;
    protected $collPacKendoGridStatesPartial;
     ...
     */
    protected $pacKendoGridStatesScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of Generated_Zed_Acl_Persistence_Propel_Om_BasePacAclUser object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     */
    public function setIdAclUser($v)
    {
        ...
        if ($this->id_acl_user !== $v) {
            $this->id_acl_user = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::ID_ACL_USER;
        }
    ...
    public function setFkAclRole($v)
    {
        ...
        if ($this->fk_acl_role !== $v) {
            $this->fk_acl_role = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FK_ACL_ROLE;
        }
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FIRSTNAME;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LASTNAME;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::EMAIL;
        }
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::USERNAME;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::PASSWORD;
        }
    ...
    public function setRestorePasswordKey($v)
    {
        ...
        if ($this->restore_password_key !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::RESTORE_PASSWORD_KEY;
        }
    ...
    public function setLastLogin($v)
    {
        ...
        if ($this->last_login !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LAST_LOGIN;
            }
    ...
    public function setFailedLogins($v)
    {
        ...
        if ($this->failed_logins !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FAILED_LOGINS;
        }
    ...
    public function setIsDeleted($v)
    {
        ...
        if ($this->is_deleted !== $v) {
            $this->is_deleted = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DELETED;
        }
    ...
    public function setIsDefault($v)
    {
        ...
        if ($this->is_default !== $v) {
            $this->is_default = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DEFAULT;
        }
    ...
    public function setIsNew($v)
    {
        ...
        if ($this->is_new !== $v) {
            $this->is_new = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_NEW;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->is_default = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
            ...
            return $startcol + 15; // 15 = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Acl_Persistence_Propel_PacAclUser object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->aAclRole = null;
            $this->collPacKendoGridStates = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->pacKendoGridStatesScheduledForDeletion !== null) {
                if (!$this->pacKendoGridStatesScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridStateQuery::create()
                        ->filterByPrimaryKeys($this->pacKendoGridStatesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->pacKendoGridStatesScheduledForDeletion = null;
                }
            }

            if ($this->collPacKendoGridStates !== null) {
                foreach ($this->collPacKendoGridStates as $referrerFK) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::ID_ACL_USER)) {
            $modifiedColumns[':p' . $index++]  = '`id_acl_user`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FK_ACL_ROLE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_acl_role`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`firstname`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`lastname`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '`username`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = '`password`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::RESTORE_PASSWORD_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`restore_password_key`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LAST_LOGIN)) {
            $modifiedColumns[':p' . $index++]  = '`last_login`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FAILED_LOGINS)) {
            $modifiedColumns[':p' . $index++]  = '`failed_logins`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`is_deleted`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DEFAULT)) {
            $modifiedColumns[':p' . $index++]  = '`is_default`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_NEW)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Acl_Persistence_Propel_PacAclUser'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Acl_Persistence_Propel_PacAclUser'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collPacKendoGridStates) {
                $result['PacKendoGridStates'] = $this->collPacKendoGridStates->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::ID_ACL_USER)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::ID_ACL_USER, $this->id_acl_user);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FK_ACL_ROLE)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FK_ACL_ROLE, $this->fk_acl_role);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FIRSTNAME)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FIRSTNAME, $this->firstname);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LASTNAME)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LASTNAME, $this->lastname);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::EMAIL)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::EMAIL, $this->email);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::USERNAME)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::USERNAME, $this->username);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::PASSWORD)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::PASSWORD, $this->password);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::RESTORE_PASSWORD_KEY)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::RESTORE_PASSWORD_KEY, $this->restore_password_key);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LAST_LOGIN)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::LAST_LOGIN, $this->last_login);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FAILED_LOGINS)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::FAILED_LOGINS, $this->failed_logins);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DELETED)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DELETED, $this->is_deleted);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DEFAULT)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_DEFAULT, $this->is_default);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_NEW)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::IS_NEW, $this->is_new);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::ID_ACL_USER, $this->id_acl_user);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Acl_Persistence_Propel_PacAclUser (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getPacKendoGridStates() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addPacKendoGridState($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer();
        }
    ...
    /**
     * Declares an association between this object and a ProjectA_Zed_Acl_Persistence_Propel_PacAclRole object.
     *
     * @param                  ProjectA_Zed_Acl_Persistence_Propel_PacAclRole $v
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAclRole(ProjectA_Zed_Acl_Persistence_Propel_PacAclRole $v = null)
    {
        if ($v === null) {
        ...
        // If this object has already been added to the ProjectA_Zed_Acl_Persistence_Propel_PacAclRole object, it will not be re-added.
        if ($v !== null) {
            $v->addAclUser($this);
        }
    ...
    /**
     * Get the associated ProjectA_Zed_Acl_Persistence_Propel_PacAclRole object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclRole The associated ProjectA_Zed_Acl_Persistence_Propel_PacAclRole object.
     * @throws PropelException
     */
    public function getAclRole(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAclRole === null && ($this->fk_acl_role !== null) && $doQuery) {
            $this->aAclRole = ProjectA_Zed_Acl_Persistence_Propel_PacAclRoleQuery::create()->findPk($this->fk_acl_role, $con);
    ...
    {
        if ('PacKendoGridState' == $relationName) {
            $this->initPacKendoGridStates();
        }
    ...
    /**
     * Clears out the collPacKendoGridStates collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     * @see        addPacKendoGridStates()
     */
    public function clearPacKendoGridStates()
    {
        $this->collPacKendoGridStates = null; // important to set this to null since that means it is uninitialized
        $this->collPacKendoGridStatesPartial = null;

        return $this;
    }

    /**
     * reset is the collPacKendoGridStates collection loaded partially
     *
     * @return void
     */
    public function resetPartialPacKendoGridStates($v = true)
    {
        $this->collPacKendoGridStatesPartial = $v;
    }

    /**
     * Initializes the collPacKendoGridStates collection.
     *
     * By default this just sets the collPacKendoGridStates collection to an empty array (like clearcollPacKendoGridStates());
     ...
     * @return void
     */
    public function initPacKendoGridStates($overrideExisting = true)
    {
        if (null !== $this->collPacKendoGridStates && !$overrideExisting) {
            return;
        }
        $this->collPacKendoGridStates = new PropelObjectCollection();
        $this->collPacKendoGridStates->setModel('ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState');
    }

    /**
     * Gets an array of ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Acl_Persistence_Propel_PacAclUser is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState[] List of ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState objects
     * @throws PropelException
     */
    public function getPacKendoGridStates($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collPacKendoGridStatesPartial && !$this->isNew();
        if (null === $this->collPacKendoGridStates || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPacKendoGridStates) {
                // return empty collection
                $this->initPacKendoGridStates();
            } else {
                $collPacKendoGridStates = ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridStateQuery::create(null, $criteria)
                    ->filterByAclUser($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collPacKendoGridStatesPartial && count($collPacKendoGridStates)) {
                      $this->initPacKendoGridStates(false);

                      foreach ($collPacKendoGridStates as $obj) {
                        if (false == $this->collPacKendoGridStates->contains($obj)) {
                          $this->collPacKendoGridStates->append($obj);
                        }
                      }

                      $this->collPacKendoGridStatesPartial = true;
                    }

                    $collPacKendoGridStates->getInternalIterator()->rewind();

                    return $collPacKendoGridStates;
                }

                if ($partial && $this->collPacKendoGridStates) {
                    foreach ($this->collPacKendoGridStates as $obj) {
                        if ($obj->isNew()) {
                            $collPacKendoGridStates[] = $obj;
                        }
                    }
                }

                $this->collPacKendoGridStates = $collPacKendoGridStates;
                $this->collPacKendoGridStatesPartial = false;
            }
        }

        return $this->collPacKendoGridStates;
    }

    /**
     * Sets a collection of PacKendoGridState objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $pacKendoGridStates A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     */
    public function setPacKendoGridStates(PropelCollection $pacKendoGridStates, PropelPDO $con = null)
    {
        $pacKendoGridStatesToDelete = $this->getPacKendoGridStates(new Criteria(), $con)->diff($pacKendoGridStates);


        $this->pacKendoGridStatesScheduledForDeletion = $pacKendoGridStatesToDelete;

        foreach ($pacKendoGridStatesToDelete as $pacKendoGridStateRemoved) {
            $pacKendoGridStateRemoved->setAclUser(null);
        }

        $this->collPacKendoGridStates = null;
        foreach ($pacKendoGridStates as $pacKendoGridState) {
            $this->addPacKendoGridState($pacKendoGridState);
        }

        $this->collPacKendoGridStates = $pacKendoGridStates;
        $this->collPacKendoGridStatesPartial = false;
    ...
    /**
     * Returns the number of related ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState objects.
     * @throws PropelException
     */
    public function countPacKendoGridStates(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collPacKendoGridStatesPartial && !$this->isNew();
        if (null === $this->collPacKendoGridStates || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collPacKendoGridStates) {
            ...
            if ($partial && !$criteria) {
                return count($this->getPacKendoGridStates());
            }
            $query = ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridStateQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collPacKendoGridStates);
    }

    /**
     * Method called to associate a ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState object to this object
     * through the ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState foreign key attribute.
     *
     * @param    ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState $l ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     */
    public function addPacKendoGridState(ProjectA_Zed_Kendo_Persistence_Propel_PacKendoGridState $l)
    {
        if ($this->collPacKendoGridStates === null) {
            $this->initPacKendoGridStates();
            $this->collPacKendoGridStatesPartial = true;
        ...
        if (!in_array($l, $this->collPacKendoGridStates->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddPacKendoGridState($l);

            if ($this->pacKendoGridStatesScheduledForDeletion and $this->pacKendoGridStatesScheduledForDeletion->contains($l)) {
                $this->pacKendoGridStatesScheduledForDeletion->remove($this->pacKendoGridStatesScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	PacKendoGridState $pacKendoGridState The pacKendoGridState object to add.
     */
    protected function doAddPacKendoGridState($pacKendoGridState)
    {
        $this->collPacKendoGridStates[]= $pacKendoGridState;
        $pacKendoGridState->setAclUser($this);
    }

    /**
     * @param	PacKendoGridState $pacKendoGridState The pacKendoGridState object to remove.
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     */
    public function removePacKendoGridState($pacKendoGridState)
    {
        if ($this->getPacKendoGridStates()->contains($pacKendoGridState)) {
            $this->collPacKendoGridStates->remove($this->collPacKendoGridStates->search($pacKendoGridState));
            if (null === $this->pacKendoGridStatesScheduledForDeletion) {
                $this->pacKendoGridStatesScheduledForDeletion = clone $this->collPacKendoGridStates;
                $this->pacKendoGridStatesScheduledForDeletion->clear();
            }
            $this->pacKendoGridStatesScheduledForDeletion[]= clone $pacKendoGridState;
            $pacKendoGridState->setAclUser(null);
        }
    ...
    public function initOrderNotes($overrideExisting = true)
    {
        ...
        $this->collOrderNotes->setModel('ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderNote');
    }
    ...
    public function getOrderNotes($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collOrderNotes || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrderNotes) {
                ...
                $collOrderNotes = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderNoteQuery::create(null, $criteria)
                    ->filterByAclUser($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setOrderNotes(PropelCollection $orderNotes, PropelPDO $con = null)
    {
        ...
        $this->orderNotesScheduledForDeletion = $orderNotesToDelete;
     ...
     * @return ProjectA_Zed_Acl_Persistence_Propel_PacAclUser The current object (for fluent API support)
     */
    public function addOrderNote(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderNote $l)
    {
        if ($this->collOrderNotes === null) {
            $this->initOrderNotes();
            $this->collOrderNotesPartial = true;
        ...
        if (!in_array($l, $this->collOrderNotes->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->orderNotesScheduledForDeletion and $this->orderNotesScheduledForDeletion->contains($l)) {
                $this->orderNotesScheduledForDeletion->remove($this->orderNotesScheduledForDeletion->search($l));
            }
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collPacKendoGridStates) {
                foreach ($this->collPacKendoGridStates as $o) {
        ...
        if ($this->collPacKendoGridStates instanceof PropelCollection) {
            $this->collPacKendoGridStates->clearIterator();
        }
        $this->collPacKendoGridStates = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Acl_Persistence_Propel_PacAclUserPeer::DEFAULT_STRING_FORMAT);
    }
