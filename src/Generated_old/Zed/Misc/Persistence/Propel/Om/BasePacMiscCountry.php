 ...
 */
abstract class Generated_Zed_Misc_Persistence_Propel_Om_BasePacMiscCountry extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion[] Collection to store aggregation of ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion objects.
     */
    ...
    /**
     * Initializes internal state of Generated_Zed_Misc_Persistence_Propel_Om_BasePacMiscCountry object.
     * @see        applyDefaults()
     */
     ...
     * @return ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry The current object (for fluent API support)
     */
    public function setIdMiscCountry($v)
    {
        ...
        if ($this->id_misc_country !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ID_MISC_COUNTRY;
        }
    ...
    public function setIso2Code($v)
    {
        ...
        if ($this->iso2_code !== $v) {
            $this->iso2_code = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO2_CODE;
        }
    ...
    public function setIso3Code($v)
    {
        ...
        if ($this->iso3_code !== $v) {
            $this->iso3_code = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO3_CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::NAME;
        }
    ...
    public function setPostalCodeMadatory($v)
    {
        ...
        if ($this->postal_code_madatory !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_MADATORY;
        }
    ...
    public function setPostalCodeRegex($v)
    {
        ...
        if ($this->postal_code_regex !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_REGEX;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->customerAddress2sScheduledForDeletion !== null) {
                if (!$this->customerAddress2sScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2AddressQuery::create()
                        ->filterByPrimaryKeys($this->customerAddress2sScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
            ...
            if ($this->salesOrderAddressesScheduledForDeletion !== null) {
                if (!$this->salesOrderAddressesScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ID_MISC_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`id_misc_country`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO2_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`iso2_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO3_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`iso3_code`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_MADATORY)) {
            $modifiedColumns[':p' . $index++]  = '`postal_code_madatory`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_REGEX)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ID_MISC_COUNTRY)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ID_MISC_COUNTRY, $this->id_misc_country);
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO2_CODE)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO2_CODE, $this->iso2_code);
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO3_CODE)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ISO3_CODE, $this->iso3_code);
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::NAME)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_MADATORY)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_MADATORY, $this->postal_code_madatory);
        if ($this->isColumnModified(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_REGEX)) $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::POSTAL_CODE_REGEX, $this->postal_code_regex);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::ID_MISC_COUNTRY, $this->id_misc_country);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer();
        }
     ...
     * If this ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry is new, it will return
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Customer_Persistence_Propel_PacCustomerAddress[] List of ProjectA_Zed_Customer_Persistence_Propel_PacCustomerAddress objects
     */
    public function getCustomerAddressesJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Customer_Persistence_Propel_PacCustomerAddressQuery::create(null, $criteria);
    ...
    public function setCustomerAddress2s(PropelCollection $customerAddress2s, PropelPDO $con = null)
    {
        ...
        foreach ($customerAddress2sToDelete as $customerAddress2Removed) {
            $customerAddress2Removed->setCountry(null);
        }
    ...
    protected function doAddCustomerAddress2($customerAddress2)
    {
        ...
        $customerAddress2->setCountry($this);
    }
    ...
    public function removeCustomerAddress2($customerAddress2)
    {
        if ($this->getCustomerAddress2s()->contains($customerAddress2)) {
            ...
            $this->customerAddress2sScheduledForDeletion[]= clone $customerAddress2;
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2Address[] List of ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2Address objects
     */
    public function getCustomerAddress2sJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2AddressQuery::create(null, $criteria);
        $query->joinWith('Region', $join_behavior);
    ...
    public function initRegions($overrideExisting = true)
    {
        ...
        $this->collRegions->setModel('ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion');
    }

    /**
     * Gets an array of ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion[] List of ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion objects
     * @throws PropelException
     */
    public function getRegions($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collRegions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collRegions) {
                ...
                $collRegions = ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegionQuery::create(null, $criteria)
                    ->filterByCountry($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion objects.
     * @throws PropelException
     */
    public function countRegions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collRegions || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion object to this object
     * through the ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion foreign key attribute.
     *
     * @param    ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion $l ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion
     * @return ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountry The current object (for fluent API support)
     */
    public function addRegion(ProjectA_Zed_Misc_Persistence_Propel_PacMiscRegion $l)
    {
        if ($this->collRegions === null) {
            $this->initRegions();
            $this->collRegionsPartial = true;
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress[] List of ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddress objects
     */
    public function getSalesOrderAddressesJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderAddressQuery::create(null, $criteria);
        $query->joinWith('Region', $join_behavior);
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Misc_Persistence_Propel_PacMiscCountryPeer::DEFAULT_STRING_FORMAT);
    }
