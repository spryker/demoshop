 ...
 */
abstract class Generated_Zed_Price_Persistence_Propel_Om_BasePacPriceType extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct[] Collection to store aggregation of ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct objects.
     */
     ...
     * @return ProjectA_Zed_Price_Persistence_Propel_PacPriceType The current object (for fluent API support)
     */
    public function setIdPriceType($v)
    {
        ...
        if ($this->id_price_type !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::ID_PRICE_TYPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Price_Persistence_Propel_PacPriceType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->priceProductsScheduledForDeletion !== null) {
                if (!$this->priceProductsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Price_Persistence_Propel_PacPriceProductQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::ID_PRICE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_price_type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_Propel_PacPriceType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Price_Persistence_Propel_PacPriceType'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::ID_PRICE_TYPE)) $criteria->add(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::ID_PRICE_TYPE, $this->id_price_type);
        if ($this->isColumnModified(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::NAME)) $criteria->add(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::ID_PRICE_TYPE, $this->id_price_type);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Price_Persistence_Propel_PacPriceType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Price_Persistence_Propel_PacPriceType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer();
        }
    ...
    public function initPriceProducts($overrideExisting = true)
    {
        ...
        $this->collPriceProducts->setModel('ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct');
    }

    /**
     * Gets an array of ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Price_Persistence_Propel_PacPriceType is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct[] List of ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct objects
     * @throws PropelException
     */
    public function getPriceProducts($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPriceProducts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPriceProducts) {
                ...
                $collPriceProducts = ProjectA_Zed_Price_Persistence_Propel_PacPriceProductQuery::create(null, $criteria)
    ...
    /**
     * Returns the number of related ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct objects.
     * @throws PropelException
     */
    public function countPriceProducts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPriceProducts || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Price_Persistence_Propel_PacPriceProductQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct object to this object
     * through the ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct foreign key attribute.
     *
     * @param    ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct $l ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct
     * @return ProjectA_Zed_Price_Persistence_Propel_PacPriceType The current object (for fluent API support)
     */
    public function addPriceProduct(ProjectA_Zed_Price_Persistence_Propel_PacPriceProduct $l)
    {
        if ($this->collPriceProducts === null) {
            $this->initPriceProducts();
            $this->collPriceProductsPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Price_Persistence_Propel_PacPriceTypePeer::DEFAULT_STRING_FORMAT);
    }
