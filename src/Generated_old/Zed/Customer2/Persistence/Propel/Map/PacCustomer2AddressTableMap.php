...
/**
 * This class defines the structure of the 'pac_customer2_address' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Customer2_Persistence_Propel_Map_PacCustomer2AddressTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Customer2/Persistence/Propel.Map.PacCustomer2AddressTableMap';
    ...
    {
        // attributes
        $this->setName('pac_customer2_address');
        $this->setPhpName('PacCustomer2Address');

        $method = 'loadPacCustomer2Address';
        ...
        $this->addForeignKey('fk_customer', 'FkCustomer', 'INTEGER', 'pac_customer2', 'id_customer', true, null, null);
  ...
  3 => '',
    ...
    {
        $this->addRelation('Customer2', 'ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2', RelationMap::MANY_TO_ONE, array('fk_customer' => 'id_customer', ), null, null);
        ...
        $this->addRelation('CustomerBillingAddress2', 'ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2', RelationMap::ONE_TO_MANY, array('id_customer_address' => 'default_billing_address', ), null, null, 'CustomerBillingAddress2s');
        $this->addRelation('CustomerShippingAddress2', 'ProjectA_Zed_Customer2_Persistence_Propel_PacCustomer2', RelationMap::ONE_TO_MANY, array('id_customer_address' => 'default_shipping_address', ), null, null, 'CustomerShippingAddress2s');
    } // buildRelations()
...
} // Generated_Zed_Customer2_Persistence_Propel_Map_PacCustomer2AddressTableMap
