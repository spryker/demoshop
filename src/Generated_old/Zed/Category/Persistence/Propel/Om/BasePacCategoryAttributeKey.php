 ...
 */
abstract class Generated_Zed_Category_Persistence_Propel_Om_BasePacCategoryAttributeKey extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer
     */
     ...
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey The current object (for fluent API support)
     */
    public function setIdCategoryAttributeKey($v)
    {
        ...
        if ($this->id_category_attribute_key !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::ID_CATEGORY_ATTRIBUTE_KEY;
        }
    ...
    public function setFkCategoryScope($v)
    {
        ...
        if ($this->fk_category_scope !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::FK_CATEGORY_SCOPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::NAME;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::TYPE;
        }
    ...
    public function setConfig($v)
    {
        ...
        if ($this->config !== $v) {
            $this->config = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::CONFIG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::ID_CATEGORY_ATTRIBUTE_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`id_category_attribute_key`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::FK_CATEGORY_SCOPE)) {
            $modifiedColumns[':p' . $index++]  = '`fk_category_scope`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::CONFIG)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::ID_CATEGORY_ATTRIBUTE_KEY)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::ID_CATEGORY_ATTRIBUTE_KEY, $this->id_category_attribute_key);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::FK_CATEGORY_SCOPE)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::FK_CATEGORY_SCOPE, $this->fk_category_scope);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::NAME)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::TYPE)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::TYPE, $this->type);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::CONFIG)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::CONFIG, $this->config);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::ID_CATEGORY_ATTRIBUTE_KEY, $this->id_category_attribute_key);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer();
        }
     ...
     * If this ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey is new, it will return
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyPeer::DEFAULT_STRING_FORMAT);
    }
