 ...
 */
abstract class Generated_Zed_Category_Persistence_Propel_Om_BasePacCategoryScope extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey[] Collection to store aggregation of ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey objects.
     */
    protected $collAttributeKeys;
    protected $collAttributeKeysPartial;

    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Category_Persistence_Propel_PacCategory[] Collection to store aggregation of ProjectA_Zed_Category_Persistence_Propel_PacCategory objects.
     */
     ...
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope The current object (for fluent API support)
     */
    public function setIdCategoryScope($v)
    {
        ...
        if ($this->id_category_scope !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::ID_CATEGORY_SCOPE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->attributeKeysScheduledForDeletion !== null) {
                if (!$this->attributeKeysScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyQuery::create()
            ...
            if ($this->categoriesScheduledForDeletion !== null) {
                if (!$this->categoriesScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Category_Persistence_Propel_PacCategoryQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::ID_CATEGORY_SCOPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_category_scope`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::ID_CATEGORY_SCOPE)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::ID_CATEGORY_SCOPE, $this->id_category_scope);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::NAME)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::ID_CATEGORY_SCOPE, $this->id_category_scope);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer();
        }
    ...
    public function initAttributeKeys($overrideExisting = true)
    {
        ...
        $this->collAttributeKeys->setModel('ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey');
    }

    /**
     * Gets an array of ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey[] List of ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey objects
     * @throws PropelException
     */
    public function getAttributeKeys($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAttributeKeys || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAttributeKeys) {
                ...
                $collAttributeKeys = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyQuery::create(null, $criteria)
                    ->filterByScope($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setAttributeKeys(PropelCollection $attributeKeys, PropelPDO $con = null)
    {
        ...
        $this->attributeKeysScheduledForDeletion = $attributeKeysToDelete;
    ...
    /**
     * Returns the number of related ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey objects.
     * @throws PropelException
     */
    public function countAttributeKeys(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collAttributeKeys || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKeyQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey object to this object
     * through the ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey foreign key attribute.
     *
     * @param    ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey $l ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope The current object (for fluent API support)
     */
    public function addAttributeKey(ProjectA_Zed_Category_Persistence_Propel_PacCategoryAttributeKey $l)
    {
        if ($this->collAttributeKeys === null) {
            $this->initAttributeKeys();
            $this->collAttributeKeysPartial = true;
        ...
        if (!in_array($l, $this->collAttributeKeys->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->attributeKeysScheduledForDeletion and $this->attributeKeysScheduledForDeletion->contains($l)) {
                $this->attributeKeysScheduledForDeletion->remove($this->attributeKeysScheduledForDeletion->search($l));
            }
        }
    ...
    public function initCategories($overrideExisting = true)
    {
        ...
        $this->collCategories->setModel('ProjectA_Zed_Category_Persistence_Propel_PacCategory');
    }

    /**
     * Gets an array of ProjectA_Zed_Category_Persistence_Propel_PacCategory objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Category_Persistence_Propel_PacCategory[] List of ProjectA_Zed_Category_Persistence_Propel_PacCategory objects
     * @throws PropelException
     */
    public function getCategories($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCategories || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCategories) {
                ...
                $collCategories = ProjectA_Zed_Category_Persistence_Propel_PacCategoryQuery::create(null, $criteria)
                    ->filterByScope($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Category_Persistence_Propel_PacCategory objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Category_Persistence_Propel_PacCategory objects.
     * @throws PropelException
     */
    public function countCategories(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCategories || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Category_Persistence_Propel_PacCategoryQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Category_Persistence_Propel_PacCategory object to this object
     * through the ProjectA_Zed_Category_Persistence_Propel_PacCategory foreign key attribute.
     *
     * @param    ProjectA_Zed_Category_Persistence_Propel_PacCategory $l ProjectA_Zed_Category_Persistence_Propel_PacCategory
     * @return ProjectA_Zed_Category_Persistence_Propel_PacCategoryScope The current object (for fluent API support)
     */
    public function addCategory(ProjectA_Zed_Category_Persistence_Propel_PacCategory $l)
    {
        if ($this->collCategories === null) {
            $this->initCategories();
            $this->collCategoriesPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Category_Persistence_Propel_PacCategoryScopePeer::DEFAULT_STRING_FORMAT);
    }
