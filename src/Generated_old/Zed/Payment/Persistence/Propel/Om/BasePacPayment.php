 ...
 */
abstract class Generated_Zed_Payment_Persistence_Propel_Om_BasePacPayment extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction[] Collection to store aggregation of ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction objects.
     */
     ...
     * @return ProjectA_Zed_Payment_Persistence_Propel_PacPayment The current object (for fluent API support)
     */
    public function setIdPayment($v)
    {
        ...
        if ($this->id_payment !== $v) {
            $this->id_payment = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::ID_PAYMENT;
        }
    ...
    public function setTransaction($v)
    {
        ...
        if ($this->transaction !== $v) {
            $this->transaction = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::TRANSACTION;
        }
    ...
    public function setMethod($v)
    {
        ...
        if ($this->method !== $v) {
            $this->method = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::METHOD;
        }
    ...
    public function setProvider($v)
    {
        ...
        if ($this->provider !== $v) {
            $this->provider = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::PROVIDER;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Payment_Persistence_Propel_PacPayment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->paymentAccountsScheduledForDeletion !== null) {
                if (!$this->paymentAccountsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Payment_Persistence_Propel_PacPaymentAccountQuery::create()
            ...
            if ($this->paymentTransactionsScheduledForDeletion !== null) {
                if (!$this->paymentTransactionsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransactionQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::ID_PAYMENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_payment`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::TRANSACTION)) {
            $modifiedColumns[':p' . $index++]  = '`transaction`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::METHOD)) {
            $modifiedColumns[':p' . $index++]  = '`method`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::PROVIDER)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Payment_Persistence_Propel_PacPayment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Payment_Persistence_Propel_PacPayment'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::ID_PAYMENT)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::ID_PAYMENT, $this->id_payment);
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::TRANSACTION)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::TRANSACTION, $this->transaction);
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::METHOD)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::METHOD, $this->method);
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::PROVIDER)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::PROVIDER, $this->provider);
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::ID_PAYMENT, $this->id_payment);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Payment_Persistence_Propel_PacPayment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Payment_Persistence_Propel_PacPayment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer();
        }
    ...
    public function getOrder(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrder === null && ($this->id_payment !== null) && $doQuery) {
            $this->aOrder = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderQuery::create()->findPk($this->id_payment, $con);
     ...
     * If this ProjectA_Zed_Payment_Persistence_Propel_PacPayment is new, it will return
    ...
    public function initPaymentTransactions($overrideExisting = true)
    {
        ...
        $this->collPaymentTransactions->setModel('ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction');
    }

    /**
     * Gets an array of ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction[] List of ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction objects
     * @throws PropelException
     */
    public function getPaymentTransactions($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPaymentTransactions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPaymentTransactions) {
                ...
                $collPaymentTransactions = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransactionQuery::create(null, $criteria)
                    ->filterByPayment($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction objects.
     * @throws PropelException
     */
    public function countPaymentTransactions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collPaymentTransactions || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransactionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction object to this object
     * through the ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction foreign key attribute.
     *
     * @param    ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction $l ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction
     * @return ProjectA_Zed_Payment_Persistence_Propel_PacPayment The current object (for fluent API support)
     */
    public function addPaymentTransaction(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentTransaction $l)
    {
        if ($this->collPaymentTransactions === null) {
            $this->initPaymentTransactions();
            $this->collPaymentTransactionsPartial = true;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Payment_Persistence_Propel_PacPaymentPeer::DEFAULT_STRING_FORMAT);
    }
