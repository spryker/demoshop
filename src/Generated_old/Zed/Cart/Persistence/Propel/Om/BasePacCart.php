 ...
 */
abstract class Generated_Zed_Cart_Persistence_Propel_Om_BasePacCart extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|ProjectA_Zed_Cart_Persistence_Propel_PacCartItem[] Collection to store aggregation of ProjectA_Zed_Cart_Persistence_Propel_PacCartItem objects.
     */
     ...
     * @return ProjectA_Zed_Cart_Persistence_Propel_PacCart The current object (for fluent API support)
     */
    public function setIdCart($v)
    {
        ...
        if ($this->id_cart !== $v) {
            $this->id_cart = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::ID_CART;
        }
    ...
    public function setCartHash($v)
    {
        ...
        if ($this->cart_hash !== $v) {
            $this->cart_hash = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CART_HASH;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Cart_Persistence_Propel_PacCart object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Cart_Persistence_Propel_PacCartQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->cartItemsScheduledForDeletion !== null) {
                if (!$this->cartItemsScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Cart_Persistence_Propel_PacCartItemQuery::create()
            ...
            if ($this->cartUsersScheduledForDeletion !== null) {
                if (!$this->cartUsersScheduledForDeletion->isEmpty()) {
                    ProjectA_Zed_Cart_Persistence_Propel_PacCartUserQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::ID_CART)) {
            $modifiedColumns[':p' . $index++]  = '`id_cart`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CART_HASH)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Cart_Persistence_Propel_PacCart'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Cart_Persistence_Propel_PacCart'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::ID_CART)) $criteria->add(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::ID_CART, $this->id_cart);
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CART_HASH)) $criteria->add(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CART_HASH, $this->cart_hash);
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::ID_CART, $this->id_cart);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Cart_Persistence_Propel_PacCart (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Cart_Persistence_Propel_PacCart Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer();
        }
    ...
    public function initCartItems($overrideExisting = true)
    {
        ...
        $this->collCartItems->setModel('ProjectA_Zed_Cart_Persistence_Propel_PacCartItem');
    }

    /**
     * Gets an array of ProjectA_Zed_Cart_Persistence_Propel_PacCartItem objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ProjectA_Zed_Cart_Persistence_Propel_PacCart is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|ProjectA_Zed_Cart_Persistence_Propel_PacCartItem[] List of ProjectA_Zed_Cart_Persistence_Propel_PacCartItem objects
     * @throws PropelException
     */
    public function getCartItems($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCartItems || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCartItems) {
                ...
                $collCartItems = ProjectA_Zed_Cart_Persistence_Propel_PacCartItemQuery::create(null, $criteria)
                    ->filterByCart($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    /**
     * Returns the number of related ProjectA_Zed_Cart_Persistence_Propel_PacCartItem objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related ProjectA_Zed_Cart_Persistence_Propel_PacCartItem objects.
     * @throws PropelException
     */
    public function countCartItems(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        ...
        if (null === $this->collCartItems || null !== $criteria || $partial) {
            ...
            $query = ProjectA_Zed_Cart_Persistence_Propel_PacCartItemQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ProjectA_Zed_Cart_Persistence_Propel_PacCartItem object to this object
     * through the ProjectA_Zed_Cart_Persistence_Propel_PacCartItem foreign key attribute.
     *
     * @param    ProjectA_Zed_Cart_Persistence_Propel_PacCartItem $l ProjectA_Zed_Cart_Persistence_Propel_PacCartItem
     * @return ProjectA_Zed_Cart_Persistence_Propel_PacCart The current object (for fluent API support)
     */
    public function addCartItem(ProjectA_Zed_Cart_Persistence_Propel_PacCartItem $l)
    {
        if ($this->collCartItems === null) {
            $this->initCartItems();
            $this->collCartItemsPartial = true;
        ...
        if (!in_array($l, $this->collCartItems->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->cartItemsScheduledForDeletion and $this->cartItemsScheduledForDeletion->contains($l)) {
                $this->cartItemsScheduledForDeletion->remove($this->cartItemsScheduledForDeletion->search($l));
            }
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Cart_Persistence_Propel_PacCartPeer::DEFAULT_STRING_FORMAT);
    }
