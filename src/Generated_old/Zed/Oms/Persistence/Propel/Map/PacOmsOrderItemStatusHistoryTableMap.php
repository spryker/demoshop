...
/**
 * This class defines the structure of the 'pac_oms_order_item_status_history' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Oms_Persistence_Propel_Map_PacOmsOrderItemStatusHistoryTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src/Generated/Zed/Oms/Persistence/Propel.Map.PacOmsOrderItemStatusHistoryTableMap';
    ...
    {
        // attributes
        $this->setName('pac_oms_order_item_status_history');
        $this->setPhpName('PacOmsOrderItemStatusHistory');

        $method = 'loadPacOmsOrderItemStatusHistory';
        ...
        // columns
        $this->addPrimaryKey('id_oms_order_item_status_history', 'IdOmsOrderItemStatusHistory', 'INTEGER', true, null, null);
...
} // Generated_Zed_Oms_Persistence_Propel_Map_PacOmsOrderItemStatusHistoryTableMap
