...
/**
 * Base class that represents a row from the 'pac_oms_order_item_status' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Oms/Persistence/Propel.om
 */
abstract class Generated_Zed_Oms_Persistence_Propel_Om_BasePacOmsOrderItemStatus extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer
     */
    ...
    /**
     * The value for the id_oms_order_item_status field.
     * @var        int
     */
    protected $id_oms_order_item_status;
    ...
    /**
     * Get the [id_oms_order_item_status] column value.
     *
     * @return int
     */
    public function getIdOmsOrderItemStatus()
    {
        ...
        return $this->id_oms_order_item_status;
    }
    ...
    /**
     * Set the value of [id_oms_order_item_status] column.
     *
     * @param  int $v new value
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus The current object (for fluent API support)
     */
    public function setIdOmsOrderItemStatus($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_oms_order_item_status !== $v) {
            $this->id_oms_order_item_status = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS;
        }


        return $this;
    } // setIdOmsOrderItemStatus()
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oms_order_item_status = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS;
        if (null !== $this->id_oms_order_item_status) {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`id_oms_order_item_status`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }

        $sql = sprintf(
            'INSERT INTO `pac_oms_order_item_status` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_oms_order_item_status`':
                        $stmt->bindValue($identifier, $this->id_oms_order_item_status, PDO::PARAM_INT);
                        break;
                    case '`name`':
        ...
        $this->setIdOmsOrderItemStatus($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdOmsOrderItemStatus();
                break;
            case 1:
                return $this->getName();
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdOmsOrderItemStatus(),
            $keys[1] => $this->getName(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdOmsOrderItemStatus($value);
                break;
            case 1:
                $this->setName($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOmsOrderItemStatus($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS, $this->id_oms_order_item_status);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::NAME)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DESCRIPTION)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::ID_OMS_ORDER_ITEM_STATUS, $this->id_oms_order_item_status);
    ...
    /**
     * Generic method to set the primary key (id_oms_order_item_status column).
     *
    ...
    {
        $this->setIdOmsOrderItemStatus($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdOmsOrderItemStatus();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdOmsOrderItemStatus(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer();
        }
     ...
     * If this ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus is new, it will return
     ...
     * Otherwise if this PacOmsOrderItemStatus is new, it will return
     * an empty collection; or if this PacOmsOrderItemStatus has previously
     * been saved, it will retrieve related StatusHistories from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacOmsOrderItemStatus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setEventTimeouts(PropelCollection $eventTimeouts, PropelPDO $con = null)
    {
        ...
        foreach ($eventTimeoutsToDelete as $eventTimeoutRemoved) {
            $eventTimeoutRemoved->setStatus(null);
        }
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout[] List of ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout objects
     */
    public function getEventTimeoutsJoinOrderItem($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutQuery::create(null, $criteria);
        $query->joinWith('OrderItem', $join_behavior);
    ...
    public function initOrders($overrideExisting = true)
    {
        ...
        $this->collOrders->setModel('ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItem');
    }
    ...
    public function getOrders($criteria = null, PropelPDO $con = null)
    {
        ...
        if (null === $this->collOrders || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collOrders) {
                ...
                $collOrders = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemQuery::create(null, $criteria)
                    ->filterByStatus($this)
                    ->find($con);
                if (null !== $criteria) {
     ...
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatus The current object (for fluent API support)
     */
    public function addOrder(ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItem $l)
    {
        if ($this->collOrders === null) {
            $this->initOrders();
            $this->collOrdersPartial = true;
     ...
     * @return PropelObjectCollection|ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItem[] List of ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItem objects
     */
    public function getOrdersJoinSalesOrderItemBundle($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectA_Zed_Sales_Persistence_Propel_PacSalesOrderItemQuery::create(null, $criteria);
    ...
    {
        $this->id_oms_order_item_status = null;
        $this->name = null;
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderItemStatusPeer::DEFAULT_STRING_FORMAT);
    }
