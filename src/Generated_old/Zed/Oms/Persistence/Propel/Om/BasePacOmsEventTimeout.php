...
/**
 * Base class that represents a row from the 'pac_oms_event_timeout' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Oms/Persistence/Propel.om
 */
abstract class Generated_Zed_Oms_Persistence_Propel_Om_BasePacOmsEventTimeout extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer
     */
    ...
    public function getTimeout($format = 'Y-m-d H:i:s')
    {
        ...
        if ($this->timeout === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->timeout);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->timeout, true), $x);
        }
     ...
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout The current object (for fluent API support)
     */
    public function setIdOmsEventTimeout($v)
    {
        ...
        if ($this->id_oms_event_timeout !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::ID_OMS_EVENT_TIMEOUT;
        }
    ...
    public function setFkSalesOrderItem($v)
    {
        ...
        if ($this->fk_sales_order_item !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_SALES_ORDER_ITEM;
        }
    ...
    public function setFkOmsOrderItemStatus($v)
    {
        ...
        if ($this->fk_oms_order_item_status !== $v) {
            ...
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_OMS_ORDER_ITEM_STATUS;
        }
    ...
    public function setTimeout($v)
    {
        ...
        if ($this->timeout !== null || $dt !== null) {
            $currentDateAsString = ($this->timeout !== null && $tmpDt = new DateTime($this->timeout)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->timeout = $newDateAsString;
                $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::TIMEOUT;
            }
    ...
    public function setEvent($v)
    {
        ...
        if ($this->event !== $v) {
            $this->event = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::EVENT;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oms_event_timeout = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->timeout = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 7; // 7 = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::ID_OMS_EVENT_TIMEOUT)) {
            $modifiedColumns[':p' . $index++]  = '`id_oms_event_timeout`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_SALES_ORDER_ITEM)) {
            $modifiedColumns[':p' . $index++]  = '`fk_sales_order_item`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_OMS_ORDER_ITEM_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`fk_oms_order_item_status`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::TIMEOUT)) {
            $modifiedColumns[':p' . $index++]  = '`timeout`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::EVENT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_oms_event_timeout` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`fk_oms_order_item_status`':
                        ...
                        break;
                    case '`timeout`':
                        $stmt->bindValue($identifier, $this->timeout, PDO::PARAM_STR);
                        break;
                    case '`event`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOmsEventTimeout($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::ID_OMS_EVENT_TIMEOUT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::ID_OMS_EVENT_TIMEOUT, $this->id_oms_event_timeout);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_SALES_ORDER_ITEM)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_SALES_ORDER_ITEM, $this->fk_sales_order_item);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_OMS_ORDER_ITEM_STATUS)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::FK_OMS_ORDER_ITEM_STATUS, $this->fk_oms_order_item_status);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::TIMEOUT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::TIMEOUT, $this->timeout);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::EVENT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::EVENT, $this->event);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::ID_OMS_EVENT_TIMEOUT, $this->id_oms_event_timeout);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeout Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer();
        }
    ...
    public function getStatus(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStatus === null && ($this->fk_oms_order_item_status !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStatus->addEventTimeouts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Oms_Persistence_Propel_PacOmsEventTimeoutPeer::DEFAULT_STRING_FORMAT);
    }
