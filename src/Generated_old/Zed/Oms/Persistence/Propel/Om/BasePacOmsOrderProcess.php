...
/**
 * Base class that represents a row from the 'pac_oms_order_process' table.
 *
 *
 *
 * @package    propel.generator.vendor/spryker/zed-package/src/ProjectA/Zed/Oms/Persistence/Propel.om
 */
abstract class Generated_Zed_Oms_Persistence_Propel_Om_BasePacOmsOrderProcess extends ProjectA_Zed_Library_Propel_BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer
     */
     ...
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess The current object (for fluent API support)
     */
    public function setIdOmsOrderProcess($v)
    {
        ...
        if ($this->id_oms_order_process !== $v) {
            $this->id_oms_order_process = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::ID_OMS_ORDER_PROCESS;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_oms_order_process = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::ID_OMS_ORDER_PROCESS)) {
            $modifiedColumns[':p' . $index++]  = '`id_oms_order_process`';
        }
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `pac_oms_order_process` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess'][$this->getPrimaryKey()] = true;
        $keys = ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdOmsOrderProcess($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::ID_OMS_ORDER_PROCESS)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::ID_OMS_ORDER_PROCESS, $this->id_oms_order_process);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::NAME)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::NAME, $this->name);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::CREATED_AT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::UPDATED_AT)) $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::DATABASE_NAME);
        $criteria->add(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::ID_OMS_ORDER_PROCESS, $this->id_oms_order_process);
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer();
        }
     ...
     * If this ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcess is new, it will return
     ...
     * Otherwise if this PacOmsOrderProcess is new, it will return
     * an empty collection; or if this PacOmsOrderProcess has previously
     * been saved, it will retrieve related TransitionLogs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in PacOmsOrderProcess.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProjectA_Zed_Oms_Persistence_Propel_PacOmsOrderProcessPeer::DEFAULT_STRING_FORMAT);
    }
