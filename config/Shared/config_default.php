...
$config[AdyenConfigConstants::ADYEN_PAYMENT_PROVIDER] = [
    ...
    AdyenConfigConstants::ADYEN_CONFIGURATION_HPP_PAYMENT_ABORTED_REDIRECT_URI => '/checkout/cart',
    AdyenConfigConstants::ADYEN_CONFIGURATION_HPP_PAYMENT_ERROR_REDIRECT_URI => '',
