...
$refactor = new \ReneFactor\KernelToSpryker($consoleLogger);
$refactor->refactor();

$refactor = new \ReneFactor\CoreToEngine($consoleLogger);
$refactor->refactor();

$refactor = new \ReneFactor\ProjectAToFeature($consoleLogger);
$refactor->refactor();
