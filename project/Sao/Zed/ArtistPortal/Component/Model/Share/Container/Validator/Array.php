 ...
 */
class Sao_Zed_ArtistPortal_Component_Model_Share_Container_Validator_Array extends Sao_Zed_ArtistPortal_Component_Model_Share_Container_Validator_Abstract
{
    /**
    ...
    public function isValid(Sao_Zed_ArtistPortal_Component_Interface_Container $container, array $definitions)
    {
        ...
        foreach ($definitions as $key => $definition) {
            ...
            if (!is_array($data[$key])) {
                $this->messages[] = $key . ': not an array';
                $valid = false;
            }
        }
        return $valid;
