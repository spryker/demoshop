 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_BlockArtist
        ...
        implements ProjectA_Zed_Sales_Component_Interface_OrderItemCommand, ProjectA_Zed_Mail_Component_Dependency_Facade_Interface
{
    ...
    {
        return Sao_Zed_Mail_Component_Model_Constants::BLOCK_ARTIST;
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getBlockArtistMailTransfer($orderItemEntity);
