 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_FirstArtistArtworkAvailabilityReminder
        ...
        implements ProjectA_Zed_Sales_Component_Interface_OrderItemCommand, ProjectA_Zed_Mail_Component_Dependency_Facade_Interface
{
    ...
    {
        return Sao_Zed_Mail_Component_Model_Constants::FIRST_ARTIST_ARTWORK_AVAILABILTY_REMINDER;
    }
    ...
    {
        $mailTransfer = $this->facadeMail->getFirstArtistArtworkAvailabilityMailTransfer($orderItemEntity);
