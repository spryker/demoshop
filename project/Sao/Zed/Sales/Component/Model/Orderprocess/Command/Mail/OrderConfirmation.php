 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Command_Mail_OrderConfirmation
        ...
        implements ProjectA_Zed_Sales_Component_Interface_OrderCommand, ProjectA_Zed_Mail_Component_Dependency_Facade_Interface
{
    ...
    {
        $mailTransfer = $this->facadeMail->getOrderConfirmationMailTransfer($orderEntity);
