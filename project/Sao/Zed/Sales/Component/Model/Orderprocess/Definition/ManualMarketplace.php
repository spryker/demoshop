 ...
 */
class Sao_Zed_Sales_Component_Model_Orderprocess_Definition_ManualMarketplace extends ProjectA_Zed_Sales_Component_Model_Orderprocess_Definition_Abstract implements
    Sao_Zed_Sales_Component_Interface_OrderprocessConstant
{
     ...
     */
    public function __construct($processName = self::ORDER_PROCESS_MANUAL_MARKETPLACE)
    {
    ...
    protected function addDefinitions()
    {
        ...
        $this->setup->addDefinition($this->factory->getModelOrderprocessDefinitionSubProcessOriginalProduct());
