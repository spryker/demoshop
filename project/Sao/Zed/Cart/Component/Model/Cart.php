...
class Sao_Zed_Cart_Component_Model_Cart extends ProjectA_Zed_Cart_Component_Model_Cart
{
     ...
     * @return ProjectA_Shared_Sales_Transfer_Order_Item
     */
     ...
     */
    protected function mergeCartItemIntoOrderItems(
        ProjectA_Shared_Sales_Transfer_Order_Item_Collection $orderItems, ProjectA_Shared_Cart_Transfer_Item $cartItem
    )
    {
     ...
     * @param ProjectA_Shared_Cart_Transfer_Item $cartItem
     */
    public function changeCartItemInOrderItems(
        ProjectA_Shared_Sales_Transfer_Order_Item_Collection $orderItems, ProjectA_Shared_Cart_Transfer_Item $cartItem
    )
    {
        if ($this->isOriginalProduct($cartItem->getSku()) && $this->isItemAlreadyInCart($orderItems, $cartItem)) {
     ...
     * @return bool
     */
    protected function isItemAlreadyInCart(
        ProjectA_Shared_Sales_Transfer_Order_Item_Collection $orderItems, ProjectA_Shared_Cart_Transfer_Item $cartItem
    )
    {
