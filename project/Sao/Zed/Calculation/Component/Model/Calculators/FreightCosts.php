...
class Sao_Zed_Calculation_Component_Model_Calculators_FreightCosts extends ProjectA_Zed_Calculation_Component_Model_Calculators_Abstract implements ProjectA_Zed_Calculation_Component_Interface_Calculator
{
    ...
    public function getAmount($order)
    {
        ...
        foreach ($order->getItems() as $item) {
            foreach ($item->getExpenses() as $expense) {
                if ($expense->getType() === Sao_Shared_Library_Sales_ExpenseConstants::EXPENSE_FREIGHT) {
