...
class Generated_Zed_Sales_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
    ...
    /**
     * @param mixed $config (optional) default: null
     * @return Sao_Zed_Sales_Component_Gui_Grid_OrderItems
     */
    public function getGuiGridOrderItems($config = null)
    {
        $class = $this->transformClassName('Sao_Zed_Sales_Component_Gui_Grid_OrderItems');
        $model = new $class($config);
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
    ...
    /**
     * @param mixed $config (optional) default: null
     * @return Sao_Zed_Sales_Component_Gui_Grid_Orders
     */
    public function getGuiGridOrders($config = null)
    {
        $class = $this->transformClassName('Sao_Zed_Sales_Component_Gui_Grid_Orders');
        $model = new $class($config);
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
