...
abstract class Generated_Zed_Sales_Persistence_Om_BaseSaoSalesOrderAddressPeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Sales_Persistence_SaoSalesOrderAddress';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Sales_Persistence_SaoSalesOrderAddressPeer::OM_CLASS;
    }
