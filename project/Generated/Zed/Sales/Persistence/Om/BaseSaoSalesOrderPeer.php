...
abstract class Generated_Zed_Sales_Persistence_Om_BaseSaoSalesOrderPeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Sales_Persistence_SaoSalesOrder';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Sales_Persistence_SaoSalesOrderPeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Sales_Persistence_SaoSalesOrderPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Sales_Persistence_SaoSalesOrderPeer::OM_CLASS;
    }
