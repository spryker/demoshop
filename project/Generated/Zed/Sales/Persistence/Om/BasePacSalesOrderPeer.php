...
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Sales_Persistence_PacSalesOrder';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Sales_Persistence_PacSalesOrderPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Sales_Persistence_PacSalesOrderPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Sales_Persistence_PacSalesOrderPeer::OM_CLASS;
    }
