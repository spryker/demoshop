...
abstract class Generated_Zed_Sales_Persistence_Om_BasePacSalesOrderItemTransitionLogPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLog';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Sales_Persistence_PacSalesOrderItemTransitionLogPeer::OM_CLASS;
    }
