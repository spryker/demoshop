...
abstract class Generated_Zed_Sales_Persistence_Om_BaseSaoSalesOrderItemPeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Sales_Persistence_SaoSalesOrderItem';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Sales_Persistence_SaoSalesOrderItemPeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Sales_Persistence_SaoSalesOrderItemPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Sales_Persistence_SaoSalesOrderItemPeer::OM_CLASS;
    }
