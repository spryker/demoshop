 ...
 */
class Generated_Zed_Sales_Persistence_Map_PacSalesOrderAddressTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Sales/Persistence.Map.PacSalesOrderAddressTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ProjectA_Zed_Sales_Persistence_PacSalesOrderAddress');
  ...
  2 => 'Dr',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('SalesOrderAddressHistory', 'ProjectA_Zed_Sales_Persistence_PacSalesOrderAddressHistory', RelationMap::ONE_TO_MANY, array('id_sales_order_address' => 'fk_sales_order_address', ), null, null, 'SalesOrderAddressHistories');
        $this->addRelation('PacSalesOrderRelatedByFkSalesOrderAddressBilling', 'ProjectA_Zed_Sales_Persistence_PacSalesOrder', RelationMap::ONE_TO_MANY, array('id_sales_order_address' => 'fk_sales_order_address_billing', ), null, null, 'PacSalesOrdersRelatedByFkSalesOrderAddressBilling');
        $this->addRelation('PacSalesOrderRelatedByFkSalesOrderAddressShipping', 'ProjectA_Zed_Sales_Persistence_PacSalesOrder', RelationMap::ONE_TO_MANY, array('id_sales_order_address' => 'fk_sales_order_address_shipping', ), null, null, 'PacSalesOrdersRelatedByFkSalesOrderAddressShipping');
        $this->addRelation('SaoAddress', 'Sao_Zed_Sales_Persistence_SaoSalesOrderAddress', RelationMap::ONE_TO_ONE, array('id_sales_order_address' => 'id_sales_order_address', ), null, null);
    } // buildRelations()
...
} // Generated_Zed_Sales_Persistence_Map_PacSalesOrderAddressTableMap
