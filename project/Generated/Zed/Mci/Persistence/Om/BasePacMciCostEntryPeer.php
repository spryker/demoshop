...
abstract class Generated_Zed_Mci_Persistence_Om_BasePacMciCostEntryPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Mci_Persistence_PacMciCostEntry';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Mci_Persistence_PacMciCostEntryPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Mci_Persistence_PacMciCostEntryPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Mci_Persistence_PacMciCostEntryPeer::OM_CLASS;
    }
