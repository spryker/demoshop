...
class Generated_Zed_Cart_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
    ...
    /**
     * @return Sao_Zed_Cart_Component_Facade
     */
    public function getFacade()
    {
        $class = $this->transformClassName('Sao_Zed_Cart_Component_Facade');
        $model = new $class();
    ...
    /**
     * @return Sao_Zed_Cart_Component_Model_Cart
     */
    public function getModelCart()
    {
        $class = $this->transformClassName('Sao_Zed_Cart_Component_Model_Cart');
        $model = new $class();
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
    ...
    /**
     * @return Sao_Zed_Cart_Component_Model_CartStorage
     */
    public function getModelCartStorage()
    {
        $class = $this->transformClassName('Sao_Zed_Cart_Component_Model_CartStorage');
        $model = new $class();
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
