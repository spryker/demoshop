 ...
 */
class Generated_Zed_Payment_Persistence_Map_PacPaymentTransactionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Payment/Persistence.Map.PacPaymentTransactionTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ProjectA_Zed_Payment_Persistence_PacPaymentTransaction');
        ...
        $this->addColumn('sequence_nr', 'SequenceNr', 'VARCHAR', false, 32, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('PaymentAccount', 'ProjectA_Zed_Payment_Persistence_PacPaymentAccount', RelationMap::ONE_TO_MANY, array('id_payment_transaction' => 'fk_payment_transaction', ), null, null, 'PaymentAccounts');
    } // buildRelations()
...
} // Generated_Zed_Payment_Persistence_Map_PacPaymentTransactionTableMap
