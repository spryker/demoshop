...
abstract class Generated_Zed_Customer_Persistence_Om_BasePacCustomerPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Customer_Persistence_PacCustomer';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Customer_Persistence_PacCustomerPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Customer_Persistence_PacCustomerPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Customer_Persistence_PacCustomerPeer::OM_CLASS;
    }
