...
class Generated_Zed_Customer_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
     ...
     */
    public function getModelWorkflowDefinitionChangePassword(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
     ...
     */
    public function getModelWorkflowDefinitionCheckCredentials(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
     ...
     */
    public function getModelWorkflowDefinitionForgotPasswordSetNewPassword(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
     ...
     */
    public function getModelWorkflowDefinitionForgotPasswordStart(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
     ...
     */
    public function getModelWorkflowDefinitionRegisterNewCustomer(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
     ...
     */
    public function getModelWorkflowDefinitionUpdateCustomer(Sao_Shared_Customer_Transfer_Customer $customerTransfer, ProjectA_Zed_Customer_Persistence_PacCustomer $customerEntity = null)
    {
