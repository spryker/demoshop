...
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogProductOptionPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Catalog_Persistence_PacCatalogProductOption';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Catalog_Persistence_PacCatalogProductOptionPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Catalog_Persistence_PacCatalogProductOptionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Catalog_Persistence_PacCatalogProductOptionPeer::OM_CLASS;
    }
