 ...
 *
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery orderByIdCatalogAttribute($order = Criteria::ASC) Order by the id_catalog_attribute column
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery groupByIdCatalogAttribute() Group by the id_catalog_attribute column
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery groupByName() Group by the name column
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinValueType($relationAlias = null) Adds a LEFT JOIN clause to the query using the ValueType relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinValueType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ValueType relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinValueType($relationAlias = null) Adds a INNER JOIN clause to the query using the ValueType relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinAttributeGroup($relationAlias = null) Adds a LEFT JOIN clause to the query using the AttributeGroup relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinAttributeGroup($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AttributeGroup relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinAttributeGroup($relationAlias = null) Adds a INNER JOIN clause to the query using the AttributeGroup relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinOptionMulti($relationAlias = null) Adds a LEFT JOIN clause to the query using the OptionMulti relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinOptionMulti($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OptionMulti relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinOptionMulti($relationAlias = null) Adds a INNER JOIN clause to the query using the OptionMulti relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinOptionSingle($relationAlias = null) Adds a LEFT JOIN clause to the query using the OptionSingle relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinOptionSingle($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OptionSingle relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinOptionSingle($relationAlias = null) Adds a INNER JOIN clause to the query using the OptionSingle relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinInteger($relationAlias = null) Adds a LEFT JOIN clause to the query using the Integer relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinInteger($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Integer relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinInteger($relationAlias = null) Adds a INNER JOIN clause to the query using the Integer relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinTimestamp($relationAlias = null) Adds a LEFT JOIN clause to the query using the Timestamp relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinTimestamp($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Timestamp relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinTimestamp($relationAlias = null) Adds a INNER JOIN clause to the query using the Timestamp relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinDecimal($relationAlias = null) Adds a LEFT JOIN clause to the query using the Decimal relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinDecimal($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Decimal relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinDecimal($relationAlias = null) Adds a INNER JOIN clause to the query using the Decimal relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinText($relationAlias = null) Adds a LEFT JOIN clause to the query using the Text relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinText($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Text relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinText($relationAlias = null) Adds a INNER JOIN clause to the query using the Text relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinTextArea($relationAlias = null) Adds a LEFT JOIN clause to the query using the TextArea relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinTextArea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the TextArea relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinTextArea($relationAlias = null) Adds a INNER JOIN clause to the query using the TextArea relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery leftJoinBoolean($relationAlias = null) Adds a LEFT JOIN clause to the query using the Boolean relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery rightJoinBoolean($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Boolean relation
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery innerJoinBoolean($relationAlias = null) Adds a INNER JOIN clause to the query using the Boolean relation
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute findOne(PropelPDO $con = null) Return the first ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute matching the query
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute findOneOrCreate(PropelPDO $con = null) Return the first ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute matching the query, or a new ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute object populated from the query conditions when no match is found
 *
 * @method ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute findOneByName(string $name) Return the first ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute filtered by the name column
 *
 * @method array findByIdCatalogAttribute(int $id_catalog_attribute) Return ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects filtered by the id_catalog_attribute column
 * @method array findByName(string $name) Return ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute objects filtered by the name column
 *
 * @package    propel.generator.vendor/project-a/catalog-package/ProjectA/Zed/Catalog/Persistence.om
 */
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogAttributeQuery extends ModelCriteria
{
    /**
     * Initializes internal state of Generated_Zed_Catalog_Persistence_Om_BasePacCatalogAttributeQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'zed', $modelName = 'ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param   ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery) {
            return $criteria;
        }
        $query = new ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute|ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute();
            $obj->hydrate($row);
            ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute[]|mixed the list of results, formatted by the current formatter
     */
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $keys, Criteria::IN);
    }
    ...
    public function filterByIdCatalogAttribute($idCatalogAttribute = null, $comparison = null)
    {
        if (is_array($idCatalogAttribute)) {
            ...
            if (isset($idCatalogAttribute['min'])) {
                $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $idCatalogAttribute['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idCatalogAttribute['max'])) {
                $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $idCatalogAttribute['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $idCatalogAttribute, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::NAME, $name, $comparison);
    }
    ...
    public function filterByValueType($pacCatalogValueType, $comparison = null)
    {
        if ($pacCatalogValueType instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueType) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueType->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByAttributeGroup($pacCatalogAttributeGroup, $comparison = null)
    {
        if ($pacCatalogAttributeGroup instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeGroup) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogAttributeGroup->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByOptionMulti($pacCatalogValueOptionMulti, $comparison = null)
    {
        if ($pacCatalogValueOptionMulti instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueOptionMulti) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueOptionMulti->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByOptionSingle($pacCatalogValueOptionSingle, $comparison = null)
    {
        if ($pacCatalogValueOptionSingle instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueOptionSingle) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueOptionSingle->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByInteger($pacCatalogValueInteger, $comparison = null)
    {
        if ($pacCatalogValueInteger instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueInteger) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueInteger->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByTimestamp($pacCatalogValueTimestamp, $comparison = null)
    {
        if ($pacCatalogValueTimestamp instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueTimestamp) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueTimestamp->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByDecimal($pacCatalogValueDecimal, $comparison = null)
    {
        if ($pacCatalogValueDecimal instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueDecimal) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueDecimal->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByText($pacCatalogValueText, $comparison = null)
    {
        if ($pacCatalogValueText instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueText) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueText->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByTextArea($pacCatalogValueTextArea, $comparison = null)
    {
        if ($pacCatalogValueTextArea instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueTextArea) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueTextArea->getFkCatalogAttribute(), $comparison);
    ...
    public function filterByBoolean($pacCatalogValueBoolean, $comparison = null)
    {
        if ($pacCatalogValueBoolean instanceof ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean) {
            return $this
                ->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogValueBoolean->getFkCatalogAttribute(), $comparison);
     ...
     *
     * @param   ProjectA_Zed_Catalog_Persistence_PacCatalogAttribute $pacCatalogAttribute Object to remove from the list of results
     *
     * @return ProjectA_Zed_Catalog_Persistence_PacCatalogAttributeQuery The current query, for fluid interface
     */
    public function prune($pacCatalogAttribute = null)
    {
        if ($pacCatalogAttribute) {
            $this->addUsingAlias(ProjectA_Zed_Catalog_Persistence_PacCatalogAttributePeer::ID_CATALOG_ATTRIBUTE, $pacCatalogAttribute->getIdCatalogAttribute(), Criteria::NOT_EQUAL);
        }
