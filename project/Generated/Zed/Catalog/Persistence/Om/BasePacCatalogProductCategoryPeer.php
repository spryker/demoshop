...
abstract class Generated_Zed_Catalog_Persistence_Om_BasePacCatalogProductCategoryPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategory';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategoryPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategoryPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Catalog_Persistence_PacCatalogProductCategoryPeer::OM_CLASS;
    }
