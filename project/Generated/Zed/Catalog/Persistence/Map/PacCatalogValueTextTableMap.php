...
/**
 * This class defines the structure of the 'pac_catalog_value_text' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Catalog_Persistence_Map_PacCatalogValueTextTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Catalog/Persistence.Map.PacCatalogValueTextTableMap';
    ...
    {
        // attributes
        $this->setName('pac_catalog_value_text');
        $this->setPhpName('PacCatalogValueText');
        $this->setClassname('ProjectA_Zed_Catalog_Persistence_PacCatalogValueText');
        $this->setPackage('vendor/project-a/catalog-package/ProjectA/Zed/Catalog/Persistence');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_catalog_value_text', 'IdCatalogValueText', 'INTEGER', true, null, null);
...
} // Generated_Zed_Catalog_Persistence_Map_PacCatalogValueTextTableMap
