...
/**
 * This class defines the structure of the 'pac_catalog_value_boolean' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Catalog_Persistence_Map_PacCatalogValueBooleanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Catalog/Persistence.Map.PacCatalogValueBooleanTableMap';
    ...
    {
        // attributes
        $this->setName('pac_catalog_value_boolean');
        $this->setPhpName('PacCatalogValueBoolean');
        $this->setClassname('ProjectA_Zed_Catalog_Persistence_PacCatalogValueBoolean');
        $this->setPackage('vendor/project-a/catalog-package/ProjectA/Zed/Catalog/Persistence');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_catalog_value_boolean', 'IdCatalogValueBoolean', 'INTEGER', true, null, null);
...
} // Generated_Zed_Catalog_Persistence_Map_PacCatalogValueBooleanTableMap
