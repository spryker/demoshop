...
/**
 * This class defines the structure of the 'pac_catalog_value_decimal' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Catalog_Persistence_Map_PacCatalogValueDecimalTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Catalog/Persistence.Map.PacCatalogValueDecimalTableMap';
    ...
    {
        // attributes
        $this->setName('pac_catalog_value_decimal');
        $this->setPhpName('PacCatalogValueDecimal');
        $this->setClassname('ProjectA_Zed_Catalog_Persistence_PacCatalogValueDecimal');
        $this->setPackage('vendor/project-a/catalog-package/ProjectA/Zed/Catalog/Persistence');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_catalog_value_decimal', 'IdCatalogValueDecimal', 'INTEGER', true, null, null);
...
} // Generated_Zed_Catalog_Persistence_Map_PacCatalogValueDecimalTableMap
