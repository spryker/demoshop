...
/**
 * This class defines the structure of the 'pac_catalog_value_timestamp' table.
 *
 *
 *
 ...
 */
class Generated_Zed_Catalog_Persistence_Map_PacCatalogValueTimestampTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Catalog/Persistence.Map.PacCatalogValueTimestampTableMap';
    ...
    {
        // attributes
        $this->setName('pac_catalog_value_timestamp');
        $this->setPhpName('PacCatalogValueTimestamp');
        $this->setClassname('ProjectA_Zed_Catalog_Persistence_PacCatalogValueTimestamp');
        $this->setPackage('vendor/project-a/catalog-package/ProjectA/Zed/Catalog/Persistence');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id_catalog_value_timestamp', 'IdCatalogValueTimestamp', 'INTEGER', true, null, null);
        $this->addColumn('value', 'Value', 'TIMESTAMP', true, null, null);
...
} // Generated_Zed_Catalog_Persistence_Map_PacCatalogValueTimestampTableMap
