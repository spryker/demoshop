...
abstract class Generated_Zed_Glossary_Persistence_Om_BasePacGlossaryExplanationVersionPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanationVersion';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanationVersionPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanationVersionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Glossary_Persistence_PacGlossaryExplanationVersionPeer::OM_CLASS;
    }
