...
abstract class Generated_Zed_Glossary_Persistence_Om_BasePacGlossaryKeyVersionPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Glossary_Persistence_PacGlossaryKeyVersion';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Glossary_Persistence_PacGlossaryKeyVersionPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Glossary_Persistence_PacGlossaryKeyVersionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Glossary_Persistence_PacGlossaryKeyVersionPeer::OM_CLASS;
    }
