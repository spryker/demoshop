...
abstract class Generated_Zed_Category_Persistence_Om_BasePacCategoryPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Category_Persistence_PacCategory';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Category_Persistence_PacCategoryPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Category_Persistence_PacCategoryPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Category_Persistence_PacCategoryPeer::OM_CLASS;
    }
