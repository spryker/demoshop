...
abstract class Generated_Zed_Dwh_Persistence_Om_BasePacDwhReportPermissionPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Dwh_Persistence_PacDwhReportPermission';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Dwh_Persistence_PacDwhReportPermissionPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Dwh_Persistence_PacDwhReportPermissionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Dwh_Persistence_PacDwhReportPermissionPeer::OM_CLASS;
    }
