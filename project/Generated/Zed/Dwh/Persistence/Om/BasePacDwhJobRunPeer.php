...
abstract class Generated_Zed_Dwh_Persistence_Om_BasePacDwhJobRunPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Dwh_Persistence_PacDwhJobRun';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Dwh_Persistence_PacDwhJobRunPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Dwh_Persistence_PacDwhJobRunPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Dwh_Persistence_PacDwhJobRunPeer::OM_CLASS;
    }
