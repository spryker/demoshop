...
class Generated_Zed_Newsletter_Persistence_Map_PacNewsletterSubscriptionTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ProjectA_Zed_Newsletter_Persistence_PacNewsletterSubscription');
        $this->setPackage('vendor/project-a/crm-package/ProjectA/Zed/Newsletter/Persistence');
