...
abstract class Generated_Zed_Tracking_Persistence_Om_BasePacTrackingPageTypeIsConversionPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Tracking_Persistence_PacTrackingPageTypeIsConversion';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Tracking_Persistence_PacTrackingPageTypeIsConversionPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Tracking_Persistence_PacTrackingPageTypeIsConversionPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Tracking_Persistence_PacTrackingPageTypeIsConversionPeer::OM_CLASS;
    }
