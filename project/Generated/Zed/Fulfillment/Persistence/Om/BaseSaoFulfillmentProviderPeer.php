...
abstract class Generated_Zed_Fulfillment_Persistence_Om_BaseSaoFulfillmentProviderPeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Fulfillment_Persistence_SaoFulfillmentProvider';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Fulfillment_Persistence_SaoFulfillmentProviderPeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Fulfillment_Persistence_SaoFulfillmentProviderPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Fulfillment_Persistence_SaoFulfillmentProviderPeer::OM_CLASS;
    }
