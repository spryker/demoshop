...
abstract class Generated_Zed_Fulfillment_Persistence_Om_BaseSaoFulfillmentQuotePeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Fulfillment_Persistence_SaoFulfillmentQuote';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Fulfillment_Persistence_SaoFulfillmentQuotePeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Fulfillment_Persistence_SaoFulfillmentQuotePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Fulfillment_Persistence_SaoFulfillmentQuotePeer::OM_CLASS;
    }
