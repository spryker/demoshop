 ...
 */
class Generated_Zed_Cms_Persistence_Map_PacCmsPageTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'project/Generated/Zed/Cms/Persistence.Map.PacCmsPageTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('ProjectA_Zed_Cms_Persistence_PacCmsPage');
        ...
        $this->addForeignKey('fk_cms_page_type', 'FkCmsPageType', 'INTEGER', 'pac_cms_page_type', 'id_cms_page_type', true, null, null);
  ...
  2 => 'In progress',
        ...
        // validators
        $this->addValidator('url', 'unique', 'propel.validator.UniqueValidator', '', 'This url already exists!');
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('ElementPage', 'ProjectA_Zed_Cms_Persistence_PacCmsElementPage', RelationMap::ONE_TO_MANY, array('id_cms_page' => 'fk_cms_page', ), null, null, 'ElementPages');
        $this->addRelation('Element', 'ProjectA_Zed_Cms_Persistence_PacCmsElement', RelationMap::MANY_TO_MANY, array(), null, null, 'Elements');
    } // buildRelations()
...
} // Generated_Zed_Cms_Persistence_Map_PacCmsPageTableMap
