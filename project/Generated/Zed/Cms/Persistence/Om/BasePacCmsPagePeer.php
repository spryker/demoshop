...
abstract class Generated_Zed_Cms_Persistence_Om_BasePacCmsPagePeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Cms_Persistence_PacCmsPage';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Cms_Persistence_PacCmsPagePeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Cms_Persistence_PacCmsPagePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Cms_Persistence_PacCmsPagePeer::OM_CLASS;
    }
