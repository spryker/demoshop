...
abstract class Generated_Zed_Cms_Persistence_Om_BasePacElementTypePageTypeConstraintPeer
{
    ...
    const OM_CLASS = 'ProjectA_Zed_Cms_Persistence_PacElementTypePageTypeConstraint';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ProjectA_Zed_Cms_Persistence_PacElementTypePageTypeConstraintPeer::getInstanceFromPool($key))) {
            ...
            $cls = ProjectA_Zed_Cms_Persistence_PacElementTypePageTypeConstraintPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return ProjectA_Zed_Cms_Persistence_PacElementTypePageTypeConstraintPeer::OM_CLASS;
    }
