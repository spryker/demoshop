...
class Generated_Zed_Cms_Component_Factory extends ProjectA_Shared_Library_Architecture_Store implements ProjectA_Zed_Library_Component_Interface_FactoryInterface
{
    ...
    /**
     * @return ProjectA_Zed_Cms_Component_Gui_Crud_CatalogPage
     */
    public function getGuiCrudCatalogPage()
    {
        $class = $this->transformClassName('ProjectA_Zed_Cms_Component_Gui_Crud_CatalogPage');
        $model = new $class();
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
    ...
    /**
     * @param ProjectA_Zed_Cms_Component_Gui_Crud_CatalogPage $crud 
     * @return ProjectA_Zed_Cms_Component_Gui_Form_CatalogPage
     */
    public function getGuiFormCatalogPage(ProjectA_Zed_Cms_Component_Gui_Crud_CatalogPage $crud)
    {
        $class = $this->transformClassName('ProjectA_Zed_Cms_Component_Gui_Form_CatalogPage');
        $model = new $class($crud);
        ProjectA_Zed_Library_Dependency_Injector::injectDependencies($model, $this);
        return $model;
    }
     ...
     * @return ProjectA_Zed_Cms_Component_Gui_Grid_CatalogPage
     */
    public function getGuiGridCatalogPage($config = null)
    {
        $class = $this->transformClassName('ProjectA_Zed_Cms_Component_Gui_Grid_CatalogPage');
