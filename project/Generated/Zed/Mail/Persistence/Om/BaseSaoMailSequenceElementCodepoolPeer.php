...
abstract class Generated_Zed_Mail_Persistence_Om_BaseSaoMailSequenceElementCodepoolPeer
{
    ...
    const OM_CLASS = 'Sao_Zed_Mail_Persistence_SaoMailSequenceElementCodepool';
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = Sao_Zed_Mail_Persistence_SaoMailSequenceElementCodepoolPeer::getInstanceFromPool($key))) {
            ...
            $cls = Sao_Zed_Mail_Persistence_SaoMailSequenceElementCodepoolPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Sao_Zed_Mail_Persistence_SaoMailSequenceElementCodepoolPeer::OM_CLASS;
    }
