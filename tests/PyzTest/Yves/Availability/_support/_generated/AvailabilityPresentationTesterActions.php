<?php  //[STAMP] a02c18a2b0f24ffad92cc0911fcd3dac
namespace PyzTest\Yves\Availability\_generated;
...
use PyzTest\Yves\Checkout\Helper\CheckoutHelper;
...
trait AvailabilityPresentationTesterActions
{
    /**
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processCustomerStep()
     */
    public function processCustomerStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processCustomerStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::clickRegisterButton()
     */
    public function clickRegisterButton() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('clickRegisterButton', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processAddressStep()
     */
    public function processAddressStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processAddressStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processShipmentStep()
     */
    public function processShipmentStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processShipmentStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processOverviewStep()
     */
    public function processOverviewStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processOverviewStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processSuccessStep()
     */
    public function processSuccessStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processSuccessStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processPaymentStep()
     */
    public function processPaymentStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processPaymentStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::nextStep()
     */
    public function nextStep() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('nextStep', func_get_args()));
    }
     ...
     *
     * @return $this
     * @see \PyzTest\Yves\Checkout\Helper\CheckoutHelper::processAllCheckoutSteps()
     */
    public function processAllCheckoutSteps() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('processAllCheckoutSteps', func_get_args()));
    }
