<?php  //[STAMP] 0cc6f56ba074d917fd881a4ef4df8f8b
namespace PyzTest\Yves\Newsletter\_generated;
...
trait NewsletterPresentationTesterActions
{
     ...
     * @see \PyzTest\Yves\Customer\Helper\CustomerHelper::loadCustomerByEmail()
     */
    public function loadCustomerByEmail($email) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('loadCustomerByEmail', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \PyzTest\Yves\Customer\Helper\CustomerHelper::addAddressToCustomer()
     */
    public function addAddressToCustomer($email, $address, $isDefaultShipping = null, $isDefaultBilling = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('addAddressToCustomer', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \PyzTest\Yves\Customer\Helper\CustomerHelper::addNewsletterSubscription()
     */
    public function addNewsletterSubscription($email, $type = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('addNewsletterSubscription', func_get_args()));
    }
