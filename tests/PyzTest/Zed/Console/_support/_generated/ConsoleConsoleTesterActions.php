<?php  //[STAMP] aa112497106fadbd996e0cf4af5c2ea2
namespace PyzTest\Zed\Console\_generated;
...
trait ConsoleConsoleTesterActions
{
    /**
     ...
     *
     * @return void
     * @see \PyzTest\Zed\Console\Helper\ConsoleHelper::runSprykerCommand()
     */
    public function runSprykerCommand($command) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runSprykerCommand', func_get_args()));
    }
}
