...
class ProductAbstractManagerTest extends Test
{
     ...
     * @return void
     */
    public function SKIP_testCreateProductAbstractShouldCreateProductAbstractAndTriggerPlugins()
    {
     ...
     * @return void
     */
    public function SKIP_testSaveProductAbstractShouldUpdateProductAbstractAndTriggerPlugins()
    {
